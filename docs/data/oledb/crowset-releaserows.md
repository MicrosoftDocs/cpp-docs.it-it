---
title: 'CRowset:: ReleaseRows | Documenti Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33096912"
---
# <a name="crowsetreleaserows"></a>CRowset::ReleaseRows
Chiamate [IRowset:: ReleaseRows](https://msdn.microsoft.com/en-us/library/ms719771.aspx) per rilasciare l'handle di riga corrente.  
