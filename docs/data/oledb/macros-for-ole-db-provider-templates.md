...
- [Oggetti origine dei dati](https://docs.microsoft.com/previous-versions/windows/desktop/ms721278(v=vs.85))

- [Oggetti di sessione](https://docs.microsoft.com/previous-versions/windows/desktop/ms711572(v=vs.85))

- [Comandi](https://docs.microsoft.com/previous-versions/windows/desktop/ms724608(v=vs.85))
...
*dwFlags*<br/>
[in] Un valore [DBPROPFLAGS](https://docs.microsoft.com/previous-versions/windows/desktop/ms724342(v=vs.85)) che descrive la voce di proprietà.
...
*flags*<br/>
[in] Specifica come vengono restituiti dati. Vedere le `dwFlags` descrizione nella finestra [strutture DBBINDING](https://docs.microsoft.com/previous-versions/windows/desktop/ms716845(v=vs.85)).
...
Usare questa macro quando i dati della colonna viene considerati [DBTYPE_STR](https://docs.microsoft.com/previous-versions/windows/desktop/ms711251(v=vs.85)).
...
Usare questa macro quando i dati della colonna sono un valore null terminato stringa di caratteri Unicode [DBTYPE_WSTR](https://docs.microsoft.com/previous-versions/windows/desktop/ms711251(v=vs.85)).
...
Visualizzare [IDBSchemaRowset](https://docs.microsoft.com/previous-versions/windows/desktop/ms713686(v=vs.85)) nel SDK di Windows per altre informazioni sui set di righe dello schema.
