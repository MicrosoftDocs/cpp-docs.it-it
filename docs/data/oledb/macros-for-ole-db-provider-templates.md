...
-   [Oggetti origine dei dati](https://msdn.microsoft.com/library/ms721278.aspx)  
  
-   [Oggetti di sessione](https://msdn.microsoft.com/library/ms711572.aspx)  
  
-   [Comandi](https://msdn.microsoft.com/library/ms724608.aspx)  
...
#### <a name="parameters"></a>Parametri  
 *dwPropID*  
 [in] Oggetto [DBPROPID](https://msdn.microsoft.com/library/ms723882.aspx) valore che può essere usato in combinazione con la proprietà GUID per identificare una proprietà del set.  
  
#### <a name="remarks"></a>Note  
 La macro imposta il valore della proprietà di tipo `DWORD` su un valore predefinito definito in ATLDB. H. Per impostare la proprietà su un valore di propria scelta, usare [PROPERTY_INFO_ENTRY_VALUE](../../data/oledb/property-info-entry-value.md). Per impostare il [VARTYPE](http://msdn.microsoft.com/317b911b-1805-402d-a9cb-159546bc88b4) e [DBPROPFLAGS](https://msdn.microsoft.com/library/ms724342.aspx) per la proprietà nello stesso momento, utilizzare [PROPERTY_INFO_ENTRY_EX](../../data/oledb/property-info-entry-ex.md).  
 ...
 *vt*  
 [in] Il [VARTYPE](http://msdn.microsoft.com/317b911b-1805-402d-a9cb-159546bc88b4) di questa voce di proprietà.  
  
 *dwFlags*  
 [in] Oggetto [DBPROPFLAGS](https://msdn.microsoft.com/library/ms724342.aspx) che descrive questa voce di proprietà.  
 ...
 *DbType*  
 [in] Il tipo di dati [DBTYPE](https://msdn.microsoft.com/library/ms711251.aspx).  
 ...
 *flags*  
 [in] Specifica come vengono restituiti dati. Vedere le `dwFlags` descrizione nella finestra [strutture DBBINDING](https://msdn.microsoft.com/library/ms716845.aspx).  
  
 *colSize*  
 [in] La dimensione della colonna.  
  
 *DbType*  
 [in] Indica il tipo di dati del valore. Vedere le `wType` descrizione nella finestra [strutture DBBINDING](https://msdn.microsoft.com/library/ms716845.aspx).  
  
 *precision*  
 [in] Indica la precisione da utilizzare durante il recupero dei dati, se *dbType* è DBTYPE_NUMERIC o DBTYPE_DECIMAL. Vedere le `bPrecision` descrizione nella finestra [strutture DBBINDING](https://msdn.microsoft.com/library/ms716845.aspx).  
  
 *Scalabilità*  
 [in] Indica la scala da usare durante il recupero dei dati se dbType DBTYPE_NUMERIC o DBTYPE_DECIMAL. Vedere le `bScale` descrizione nella finestra [strutture DBBINDING](https://msdn.microsoft.com/library/ms716845.aspx).  
  
 *guid*  
 Un GUID di rowset dello schema. Visualizzare [IDBSchemaRowset](https://msdn.microsoft.com/library/ms713686.aspx) nel *riferimento per programmatori OLE DB* per un elenco di set di righe dello schema e i relativi GUID.  
...
#### <a name="remarks"></a>Note  
 Usare questa macro quando i dati della colonna viene considerati [DBTYPE_STR](https://msdn.microsoft.com/library/ms711251.aspx).  
...
#### <a name="remarks"></a>Note  
 Usare questa macro quando i dati della colonna sono un valore null terminato stringa di caratteri Unicode [DBTYPE_WSTR](https://msdn.microsoft.com/library/ms711251.aspx).  
...
#### <a name="remarks"></a>Note  
 Visualizzare [IDBSchemaRowset](https://msdn.microsoft.com/library/ms713686.aspx) nel SDK di Windows per altre informazioni sui set di righe dello schema.  
...
```  
 ...
 Ciò `Execute` funzione inserisce i dati del set di righe. La creazione guidata progetto ATL crea, come descritto in [IDBSchemaRowset](https://msdn.microsoft.com/library/ms713686.aspx) nel *riferimento per programmatori OLE DB*, tre iniziale i set di righe dello schema nel progetto per ognuno dei tre schemi OLE DB obbligatori:  
