---
title: END_COLUMN_MAP | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Contrassegna la fine delle voci della mappa colonna.  
...
## <a name="remarks"></a>Note  
 Viene usato con una funzione di accesso singolo in un set di righe. La macro `BEGIN_COLUMN_MAP` è completata con la macro `END_COLUMN_MAP` .  
