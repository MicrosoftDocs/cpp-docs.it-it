...
Rappresenta un'associazione nel rowset a una determinata colonna nel rowset.  Simile a [E](../../data/oledb/column-name.md), tranne per il fatto che questa macro accetta inoltre lo stato della colonna.  
