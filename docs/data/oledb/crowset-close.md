---
title: 'CRowset:: Close | Documenti Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33096730"
---
# <a name="crowsetclose"></a>CRowset::Close
Rilascia le righe e corrente [IRowset](https://msdn.microsoft.com/en-us/library/ms720986.aspx) interfaccia.  
