---
title: 'Idbinitializeimpl:: Initialize | Documenti Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
## <a name="remarks"></a>Note  
 Vedere [IDBInitialize:: Initialize](https://msdn.microsoft.com/en-us/library/ms718026.aspx) nel *di riferimento per programmatori OLE DB*.  
