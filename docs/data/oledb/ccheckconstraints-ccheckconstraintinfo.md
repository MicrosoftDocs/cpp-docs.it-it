...
## <a name="remarks"></a>Note  
 ...
 Questa classe identifica i vincoli check, definiti nel catalogo, che appartengono a un determinato utente. Un vincolo check specifica i valori di dati o i formati accettabili in una o più colonne in una tabella.  
