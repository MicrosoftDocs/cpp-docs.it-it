---
title: 'CAccessorRowset:: Bind | Documenti Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
ms.locfileid: "33088329"
---
# <a name="caccessorrowsetbind"></a>CAccessorRowset::Bind
Crea le associazioni se è stato specificato **bBind** come false in [CCommand::](../../data/oledb/ccommand-open.md).  
