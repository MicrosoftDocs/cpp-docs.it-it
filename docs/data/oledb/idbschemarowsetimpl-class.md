---
description: 'Altre informazioni su: classe IDBSchemaRowsetImpl'
...
*ppRowset*<br/>
out `IUnknown` In uscita richiesto da *riid*. Si `IUnknown` tratta di un'interfaccia sull'oggetto set di righe dello schema.
