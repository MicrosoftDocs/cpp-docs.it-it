---
title: 'Icommandpropertiesimpl:: SetProperties | Documenti Microsoft'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
#### <a name="parameters"></a>Parametri  
 Vedere [ICommandProperties:: SetProperties](https://msdn.microsoft.com/en-us/library/ms711497.aspx) nel *di riferimento per programmatori OLE DB*.  
