---
title: Progettazione e creazione di una visualizzazione di Record (accesso ai dati MFC) | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
1.  Vedere [finestra di dialogo Editor](../windows/dialog-editor.md).  
...
-   [Visualizzazioni di record: Utilizzo di una visualizzazione di Record](../data/using-a-record-view-mfc-data-access.md)  
  
-   [Visualizzazioni di record: Inserimento di una casella di riepilogo da un secondo Recordset](../data/filling-a-list-box-from-a-second-recordset-mfc-data-access.md)  
