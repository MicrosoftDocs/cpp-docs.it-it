...
-   [Ruolo del programmatore nell'aggiornamento del recordset](#_core_your_role_in_recordset_updating) ed eseguite dal framework per l'utente.  
  
-   [Il recordset in un buffer di modifica](#_core_the_edit_buffer) e il [differenze tra i dynaset e snapshot](#_core_dynasets_and_snapshots).  
 ...
 [Recordset: Ulteriori su aggiornamenti (ODBC)](../../data/odbc/recordset-more-about-updates-odbc.md) completa la sequenza di aggiornamento di recordset per spiegare in che effetti delle transazioni sugli aggiornamenti, influenza gli aggiornamenti in corso la chiusura di un recordset o lo scorrimento e interazione con gli aggiornamenti di altri utenti.  
