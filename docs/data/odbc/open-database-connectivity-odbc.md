...
-   [Recupero collettivo di record](recordset-fetching-records-in-bulk-odbc.md)  
...
-   [Come funzionano le classi di database con l'architettura documento/visualizzazione MFC?](working-with-documents-and-views.md)  
