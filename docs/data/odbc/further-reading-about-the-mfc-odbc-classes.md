---
title: "Ulteriori informazioni sulle classi ODBC MFC | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Ulteriori informazioni sulle classi ODBC MFC
[!INCLUDE[vs2017banner](../../assembler/inline/includes/vs2017banner.md)]

Negli argomenti elencati di seguito vengono fornite ulteriori spiegazioni sui concetti e sulle tecniche introdotte nel presente argomento.  
...
-   [Serializzazione: Serialization vs. database](../../mfc/serialization-serialization-vs-database-input-output.md)  
...
-   [Transazione \(ODBC\)](../../data/odbc/transaction-odbc.md)  
 ...
 Si consiglia di iniziare la lettura da [Recordset \(ODBC\)](../../data/odbc/recordset-odbc.md).  
  
 In *Riferimenti alla libreria MFC* vedere [CDatabase](../../mfc/reference/cdatabase-class.md), [CRecordset](../../mfc/reference/crecordset-class.md), [CRecordView](../../mfc/reference/crecordview-class.md), [CFieldExchange](../../mfc/reference/cfieldexchange-class.md) e [CDBException](../../mfc/reference/cdbexception-class.md).  
