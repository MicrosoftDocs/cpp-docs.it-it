---
title: 'ODBC: Chiamata diretta delle funzioni API ODBC'
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "62395807"
---
# <a name="odbc-calling-odbc-api-functions-directly"></a>ODBC: Chiamata diretta delle funzioni API ODBC
...
Per altre informazioni su questi passaggi, vedere la [Open Database Connectivity (ODBC)](/sql/odbc/microsoft-open-database-connectivity-odbc) SDK nella documentazione MSDN.
