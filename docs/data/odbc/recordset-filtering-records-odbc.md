...
3.  Impostare le opzioni che necessarie, come ordinamento, la modalità di blocco o parametri. Se si specifica un parametro è particolarmente utile. Per informazioni sull'uso dei parametri di filtro, vedere [Recordset: applicazione di parametri a un Recordset (ODBC)](../../data/odbc/recordset-parameterizing-a-recordset-odbc.md).  
