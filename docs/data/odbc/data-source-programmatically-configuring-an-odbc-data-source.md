---
title: "Origine dati: Configurazione a livello di codice un'origine dati ODBC | Microsoft Docs"
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
2.  Trovare le informazioni di origini dati ODBC usando uno dei seguenti:  
