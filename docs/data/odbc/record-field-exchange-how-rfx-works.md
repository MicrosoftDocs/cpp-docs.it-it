...
### <a name="_core_sequence_of_rfx_operations_during_recordset_open"></a> Sequenza delle operazioni di RFX durante l'apertura di Recordset  
...
### <a name="_core_sequence_of_rfx_operations_during_scrolling"></a> Sequenza delle operazioni di RFX durante lo scorrimento  
...
2.  `AddNew` o **modifica** prepara i campi nel buffer di modifica in modo che RFX possa rilevare i membri di dati campo modificato.  
