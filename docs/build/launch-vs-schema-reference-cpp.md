...
|`projectTarget`|string|Specifica la destinazione facoltativa richiamata durante la compilazione `project` . `projectTarget`Deve esistere già e corrispondere al nome nell'elenco a discesa **destinazione di debug** .|
