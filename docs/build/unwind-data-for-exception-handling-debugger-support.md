---
title: Dati di rimozione per la gestione delle eccezioni, supporto del Debugger | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
-   [Strutture UNWIND_INFO concatenate](../build/chained-unwind-info-structures.md)  
