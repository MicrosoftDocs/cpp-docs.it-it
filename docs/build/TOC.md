...
### [Panoramica delle DLL di estensione](extension-dlls-overview.md)
...
### [Scelta del metodo di collegamento da usare](determining-which-linking-method-to-use.md)
...
## [Percorso di ricerca usato da Windows per l'individuazione di una DLL](search-path-used-by-windows-to-locate-a-dll.md)
...
### [Uso di DLL di estensione per database, OLE e Sockets nelle DLL regolari](using-database-ole-and-sockets-extension-dlls-in-regular-dlls.md)
