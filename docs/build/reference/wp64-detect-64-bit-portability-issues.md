...
Per impostazione predefinita, nelle versioni di Visual Studio precedenti a Visual Studio 2013, il **/Wp64** opzione del compilatore è disattivata nel compilatore MSVC che compila x86 a 32 bit il codice, nel compilatore MSVC che build a 64 bit, x64 e codice.

> [!IMPORTANT]
>  L'opzione del compilatore [/Wp64](wp64-detect-64-bit-portability-issues.md) e la parola chiave [__w64](../../cpp/w64.md) sono deprecate in Visual Studio 2010 e Visual Studio 2012 e non sono supportare a partire da Visual Studio 2013. Se si converte un progetto che usa questa opzione, non verrà eseguita la migrazione dell'opzione durante la conversione. Per usare questa opzione in Visual Studio 2010 o Visual Studio 2012, è necessario digitare l'opzione del compilatore in **Altre opzioni** nella sezione **Riga di comando** delle proprietà del progetto. Se si usa l'opzione del compilatore **/Wp64** nella riga di comando, il compilatore visualizza l'avviso della riga di comando D9002. Invece di usare questa opzione e questa parola chiave per rilevare i problemi di portabilità a 64 bit, usare un compilatore MSVC che ha come destinazione una piattaforma a 64 bit e specificare il [/W4](compiler-option-warning-level.md) opzione. Per altre informazioni, vedere [C++ configurare progetti per 64 bit, x64 destinazioni](../configuring-programs-for-64-bit-visual-cpp.md).
...
[Configurare i progetti C++ a 64 bit x64 destinazioni](../configuring-programs-for-64-bit-visual-cpp.md)
