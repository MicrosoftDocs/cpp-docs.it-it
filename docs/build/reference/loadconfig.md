---
title: -LOADCONFIG | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
## <a name="remarks"></a>Note  
 Questa opzione esegue il dump della struttura IMAGE_LOAD_CONFIG_DIRECTORY, una struttura facoltativa utilizzata dal caricatore di Windows NT e definita in WINNT. H.  
