...
È un modo equivalente per specificare un numero di versione con il [le informazioni sulla versione](version-version-information.md) (/ versione) opzione.
