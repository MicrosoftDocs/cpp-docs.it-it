---
title: -convalidare-charset (convalida per i caratteri compatibili) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp
...
3.  Nelle **opzioni avanzate**, aggiungere il **/Validate/CharSet** opzione e specificare la codifica preferita.  
