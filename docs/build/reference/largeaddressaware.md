---
title: -LARGEADDRESSAWARE | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="remarks"></a>Note  
 Questa opzione Modifica l'immagine per indicare che l'applicazione può gestire indirizzi superiori a 2 gigabyte.  
