...
È possibile aggiungere facilmente gli elementi che sono comuni a progetti di Visual Studio usando il **Aggiungi nuovo elemento** comando. Quando si utilizza il comando **Aggiungi nuovo elemento**, nella finestra di dialogo `Add New Item` viene visualizzato un elenco di modelli di elemento, tramite i quali è possibile aggiungere i file appropriati al progetto.

Nella tabella seguente è un elenco alfabetico dei modelli Aggiungi nuovo elemento di Visual Studio.
