...
Questa opzione limita l'output per informazioni sull'oggetto specificato *sezione*. Usare la [/HEADERS](headers.md) opzione per ottenere un elenco delle sezioni nel file.
