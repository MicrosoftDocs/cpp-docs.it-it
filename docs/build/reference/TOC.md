# [Riferimento per la compilazione in C-C++](c-cpp-building-reference.md)
...
#### [Regole di uniformità per l'uso per singolo file delle intestazioni precompilate](consistency-rules-for-per-file-use-of-precompiled-headers.md)
#### [Regole di uniformità per -Yc e -Yu](consistency-rules-for-yc-and-yu.md)
### [Uso di intestazioni precompilate in un progetto](using-precompiled-headers-in-a-project.md)
