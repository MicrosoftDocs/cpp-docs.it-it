---
title: Compilazione di un programma C/C++ | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Per informazioni su come scegliere l'architettura di host e di destinazione del compilatore, vedere [configurare Visual C++ per x64 a 64 bit, destinazioni](../../build/configuring-programs-for-64-bit-visual-cpp.md).  
