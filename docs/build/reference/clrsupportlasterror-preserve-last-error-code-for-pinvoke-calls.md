---
title: -CLRSUPPORTLASTERROR (mantiene l'ultimo errore codice per le chiamate PInvoke) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
|IDENTITÀ DEL SERVIZIO GESTITO. DLL|MSIMG32. DLL|MSRATING. DLL|MSTASK. DLL|
