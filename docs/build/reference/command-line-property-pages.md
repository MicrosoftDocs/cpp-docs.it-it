...
Per informazioni su come accedere al **riga di comando** pagine delle proprietà, vedere [delle proprietà del compilatore e compilazione impostare C++ in Visual Studio](../working-with-project-properties.md).
