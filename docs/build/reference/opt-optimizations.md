...
Se usato nella riga di comando, il linker per impostazione predefinita **/OPT: REF, Firewall connessione Internet, LBR**. Se **/debug** è specificato, il valore predefinito è **/OPT: NOREF, NOICR, NOLBR**.
