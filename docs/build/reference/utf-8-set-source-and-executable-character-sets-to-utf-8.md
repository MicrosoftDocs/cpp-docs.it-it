---
title: /UTF-8 (eseguibili e imposta origine set di caratteri UTF-8)
ms.date: 11/04/2016
f1_keywords:
- /utf-8
helpviewer_keywords:
...
1. Nelle **opzioni aggiuntive**, aggiungere il **/utf-8** opzione per specificare la codifica preferita.
