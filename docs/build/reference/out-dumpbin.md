---
title: -OUT (DUMPBIN) | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
## <a name="remarks"></a>Note  
 Questa opzione specifica un *filename* per l'output. Per impostazione predefinita, DUMPBIN Visualizza le informazioni di output standard.  
