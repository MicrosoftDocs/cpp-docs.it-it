---
title: -IGNORE (Ignora determinati avvisi) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
Per impostazione predefinita, LINK segnala tutti gli avvisi. Specificare **Ignora:** `warning` per indicare al linker di non visualizzare uno specifico numero di avviso. Per ignorare più avvisi, separare i numeri di avviso con virgole.
...
|[LNK4205](../../error-messages/tool-errors/linker-tools-warning-lnk4205.md)|'`filename`' mancano informazioni di debug correnti per il riferimento modulo; oggetto collegato senza informazioni di debug|
...
1. Nel **Linker** cartella, selezionare la **della riga di comando** pagina delle proprietà.

1. Modificare il **opzioni aggiuntive** proprietà.
