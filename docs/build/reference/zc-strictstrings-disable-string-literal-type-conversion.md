...
Il **/Zc: strictstrings** opzione è disattivata per impostazione predefinita. Il [/ permissiva-](permissive-standards-conformance.md) l'opzione del compilatore imposta in modo implicito questa opzione, ma può essere sottoposto a override utilizzando **/Zc:strictStrings-**.
