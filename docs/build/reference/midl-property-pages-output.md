---
title: 'Pagine delle proprietà MIDL: Output'
ms.date: 11/04/2016
f1_keywords:
...
Per informazioni su come accedere al **Output** pagina delle proprietà di **MIDL** cartella, vedere [le proprietà del compilatore e compilazione impostare C++ in Visual Studio](../working-with-project-properties.md).
