...
Per impostazione predefinita, viene creato un assembly. È anche possibile usare la [/LN (Crea modulo MSIL)](../../build/reference/ln-create-msil-module.md) opzione del compilatore per creare un modulo.
