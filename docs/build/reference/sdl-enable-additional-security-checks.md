 ...
 **/SDL** Abilita un superset dei controlli di sicurezza iniziali forniti da [/GS](../../build/reference/gs-buffer-security-check.md) ed esegue l'override **/GS-**. Per impostazione predefinita, **/sdl** è disattivata. **/SDL-** disabilita i controlli di sicurezza aggiuntive.  
