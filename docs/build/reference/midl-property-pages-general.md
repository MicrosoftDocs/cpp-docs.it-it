---
title: 'Pagine delle proprietà MIDL: Generale'
ms.date: 11/04/2016
f1_keywords:
...
Per informazioni su come accedere al **generali** pagina delle proprietà nel **MIDL** cartella, vedere [le proprietà del compilatore e compilazione impostare C++ in Visual Studio](../working-with-project-properties.md).
