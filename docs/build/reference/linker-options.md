...
|[/FILEALIGN](filealign.md)|Consente di allineare le sezioni all'interno del file di output in multipli di un valore specificato.|
...
|[/MANIFESTDEPENDENCY](manifestdependency-specify-manifest-dependencies.md)|Specifica un \<dependentAssembly > sezione nel file manifesto.|
...
|[/NATVIS](natvis-add-natvis-to-pdb.md)|Aggiunge i visualizzatori di debugger da un file Natvis a PDB.|
...
|[/POGOSAFEMODE](pogosafemode-linker-option.md)|**Obsoleto** crea una build instrumentata PGO thread-safe.|
...
|[/SOURCELINK](sourcelink.md)|Specifica un file SourceLink da aggiungere a PDB.|
...
|[/USEPROFILE](useprofile.md)|Dati di training ottimizzazione PGO viene utilizzato per creare un'immagine ottimizzata.|
...
|[/WHOLEARCHIVE](wholearchive-include-all-library-object-files.md)|Include tutti i file oggetto da librerie statiche specificate.|
