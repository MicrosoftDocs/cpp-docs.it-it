---
title: Il motivo per cui i numeri a virgola mobile possono perdita di precisione | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
Rappresentazione binaria di valori a virgola mobile influisce sulla precisione e accuratezza dei calcoli a virgola mobile. Microsoft Visual C++ vengono usati [formato a virgola mobile IEEE](../../build/reference/ieee-floating-point-representation.md).
