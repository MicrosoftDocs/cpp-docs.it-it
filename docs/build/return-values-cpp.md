...
ms.locfileid: "50463570"
---
# <a name="return-values-c"></a>Valori restituiti (C++)

Viene restituito un valore scalare adattabile in 64 bit con RAX, che include i tipi __m64. Tra cui float, Double e tipi di vettori, ad esempio i tipi non scalari [__m128](../cpp/m128.md), [__m128i](../cpp/m128i.md), [__m128d](../cpp/m128d.md) vengono restituiti in XMM0. Lo stato dei bit non usati nel valore restituito in RAX o XMM0 non è definito.
...
## <a name="example-of-return-value-1---64-bit-result"></a>Esempio di valore restituito 1 e 64 bit risultato
...
## <a name="example-of-return-value-2---128-bit-result"></a>Esempio di risultato 2 a 128 bit di valore restituito
