...
|`environments`|Set di variabili definiti dall'utente che si comportano come variabili di ambiente in un prompt dei comandi e a cui si accede con la macro $ {ENV.\<VARIABLE >}.|
