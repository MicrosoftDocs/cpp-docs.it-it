...
description: Come creare e compilare C++ progetti con cmake in Visual Studio.
ms.date: 01/08/2020
helpviewer_keywords:
- CMake in Visual C++
...
**C++**  **C++ Gli strumenti CMake per Windows** vengono installati come parte dello sviluppo di applicazioni desktop con e **Linux C++ con** i carichi di lavoro. Per altre informazioni, vedere [progetti CMake multipiattaforma](../linux/cmake-linux-project.md).
...
Fare clic sul pulsante **Mostra tutti i file** nella parte superiore di **Esplora soluzioni** per visualizzare l'output generato da CMake nella cartella *out/Build/\<config >* .
...
[Esercitazione: creare C++ progetti multipiattaforma in Visual Studio](get-started-linux-cmake.md)\
