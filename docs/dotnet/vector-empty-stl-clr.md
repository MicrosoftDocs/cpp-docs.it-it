...
## Note  
 La funzione membro restituisce true per una sequenza controllata vuota.  Equivale a [vector::size](../dotnet/vector-size-stl-clr.md)`() == 0`.  È possibile utilizzarlo per verificare se il vettore è vuoto.  
