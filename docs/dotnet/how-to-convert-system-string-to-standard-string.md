---
description: 'Altre informazioni su: procedura: convertire System:: String in stringa standard'
...
ms.locfileid: "97181331"
---
# <a name="how-to-convert-systemstring-to-standard-string"></a>Procedura: convertire System::String in stringhe standard

È possibile convertire un oggetto in <xref:System.String> `std::string` o `std::wstring` , senza usare `PtrToStringChars` in Vcclr. h.
