...
|[priority_queue::value_compare (STL/CLR)](#value_compare)|Il delegato di ordinamento per due elementi.|  
...
|[priority_queue::pop (STL/CLR)](#pop)|Rimuove l'elemento hghest priorità.|  
...
Delegato di ordinamento per i due valori.  
