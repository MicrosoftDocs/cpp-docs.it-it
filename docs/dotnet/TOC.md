...
# [Procedura: utilizzare proprietà in C++/CLI](how-to-use-properties-in-cpp-cli.md)
...
# [Procedura: effettuare il marshalling di puntatori incorporati utilizzando PInvoke](how-to-marshal-embedded-pointers-using-pinvoke.md)
...
# [Procedura: effettuare il marshalling di puntatori a funzione utilizzando PInvoke](how-to-marshal-function-pointers-using-pinvoke.md)
...
# [Procedura: effettuare il marshalling di matrici utilizzando l'interoperabilità C++](how-to-marshal-arrays-using-cpp-interop.md)
...
# [Procedura: effettuare il marshalling di strutture utilizzando l'interoperabilità C++](how-to-marshal-structures-using-cpp-interop.md)
...
# [Procedura: effettuare il marshalling di stringhe utilizzando PInvoke](how-to-marshal-strings-using-pinvoke.md)
...
# [Procedura: conversione da raccolta .NET a contenitore STL/CLR](how-to-convert-from-a-dotnet-collection-to-a-stl-clr-container.md)
...
# [Procedura: utilizzare espressioni regolari per estrarre campi dati (C++/CLI)](how-to-use-regular-expressions-to-extract-data-fields-cpp-cli.md)
...
# [Procedura: effettuare il marshalling di matrici utilizzando PInvoke](how-to-marshal-arrays-using-pinvoke.md)
...
# [Panoramica del marshaling in C++](overview-of-marshaling-in-cpp.md)
...
# [Procedura: eseguire il wrapping di una classe nativa affinché possa essere utilizzata in C#](how-to-wrap-native-class-for-use-by-csharp.md)
# [queue::back (STL/CLR)](queue-back-stl-clr.md)
# [Chiamata a funzioni native da codice gestito](calling-native-functions-from-managed-code.md)
...
# [Procedura: effettuare il marshalling di stringhe Unicode utilizzando l'interoperabilità C++](how-to-marshal-unicode-strings-using-cpp-interop.md)
...
# [Assembly Friend (C++)](friend-assemblies-cpp.md)
...
# [Conversione di progetti da modalità mista a linguaggio intermedio (IL) puro](converting-projects-from-mixed-mode-to-pure-intermediate-language.md)
...
# [Procedura: conversione da contenitore STL/CLR a raccolta .NET](how-to-convert-from-a-stl-clr-container-to-a-dotnet-collection.md)
...
# [Procedura: eseguire il marshalling di VARIANT per ADO.NET (C++/CLI)](how-to-marshal-a-variant-for-adonet-cpp-cli.md)
...
# [Utilizzo di un controllo utente Windows Form in MFC](using-a-windows-form-user-control-in-mfc.md)
...
# [Procedura: utilizzare espressioni regolari per ridisporre i dati (C++/CLI)](how-to-use-regular-expressions-to-rearrange-data-cpp-cli.md)
# [Utilizzo delle funzionalità di interoperabilità C++ (PInvoke implicito)](using-cpp-interop-implicit-pinvoke.md)
...
# [Procedura: effettuare il marshalling di stringhe ANSI utilizzando l'interoperabilità C++](how-to-marshal-ansi-strings-using-cpp-interop.md)
...
# [Procedura: utilizzare un indicizzatore C# (C++/CLI)](how-to-consume-a-csharp-indexer-cpp-cli.md)
...
# [Utilizzo di assembly verificabili con SQL Server (C++/CLI)](using-verifiable-assemblies-with-sql-server-cpp-cli.md)
...
# [Procedura: utilizzare espressioni regolari per la corrispondenza semplice (C++/CLI)](how-to-use-regular-expressions-for-simple-matching-cpp-cli.md)
...
# [Procedura: utilizzare matrici in C++/CLI](how-to-use-arrays-in-cpp-cli.md)
...
# [Procedura: effettuare il marshalling di callback e delegati utilizzando l'interoperabilità C++](how-to-marshal-callbacks-and-delegates-by-using-cpp-interop.md)
# [map::difference_type (STL/CLR)](map-difference-type-stl-clr.md)
# [multiset::end (STL/CLR)](multiset-end-stl-clr.md)
# [Procedura: utilizzare espressioni regolari per convalidare la formattazione dei dati (C++/CLI)](how-to-use-regular-expressions-to-validate-data-formatting-cpp-cli.md)
...
# [Procedura: eseguire il marshalling di stringhe Unicode per ADO.NET (C++/CLI)](how-to-marshal-unicode-strings-for-adonet-cpp-cli.md)
...
# [Procedura: definire e utilizzare delegati (C++/CLI)](how-to-define-and-use-delegates-cpp-cli.md)
# [Procedura: definire e utilizzare classi e struct (C++ /CLI)](how-to-define-and-consume-classes-and-structs-cpp-cli.md)
...
# [Utilizzo esplicito di PInvoke in C++ (attributo DllImport)](using-explicit-pinvoke-in-cpp-dllimport-attribute.md)
...
# [Procedura: utilizzare le espressioni regolari per la ricerca e sostituzione (C++/CLI)](how-to-use-regular-expressions-to-search-and-replace-cpp-cli.md)
...
# [trasformazione (STL/CLR)](transform-stl-clr.md)
...
# [Procedura: effettuare il marshalling di stringhe COM utilizzando l'interoperabilità C++](how-to-marshal-com-strings-using-cpp-interop.md)
...
# [Procedura: effettuare il marshalling di puntatori incorporati utilizzando l'interoperabilità C++](how-to-marshal-embedded-pointers-using-cpp-interop.md)
