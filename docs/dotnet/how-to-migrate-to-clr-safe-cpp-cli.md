...
ms.locfileid: "34704514"
---
# <a name="how-to-migrate-to-clrsafe-ccli"></a>Procedura: migrare a /clr:safe (C++/CLI)

> [!IMPORTANT]
> Il **/clr: pure** e **/CLR: safe** opzioni del compilatore sono deprecate in Visual Studio 2015 e non supportate in Visual Studio 2017. Se è necessario gli assembly CLR safe, si consiglia che convertire il codice in c#.

Se si utilizza una versione precedente del set di strumenti del compilatore Visual C++ dalla prima di Visual Studio 2017, è possibile generare componenti verificabili usando **/CLR: safe**, che indica al compilatore di generare errori per ogni non verificabile costrutto di codice.
...
- [non gestito](../preprocessor/managed-unmanaged.md) e [pack](../preprocessor/pack.md) direttive pragma
