...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "inplace_merge (funzione) [STL/CLR]"
...
## Note  
 Questa funzione si comporta come se fosse la funzione `inplace_merge` STL per ulteriori informazioni, vedere a [inplace\_merge](../Topic/inplace_merge.md).  
