...
Questa funzione si comporta come la C++ funzione della libreria Standard `inplace_merge` per altre informazioni, vedere [inplace_merge](../standard-library/algorithm-functions.md#inplace_merge).
