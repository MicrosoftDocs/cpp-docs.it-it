---
title: 'Procedura: eseguire la conversione tra System:: GUID e GUID | Microsoft Docs'
...
ms.locfileid: "46418411"
---
# <a name="how-to-convert-between-systemguid-and-guid"></a>Procedura: eseguire la conversione tra System::Guid e _GUID

Esempio di codice seguente viene illustrato come eseguire la conversione tra una <xref:System.Guid> e un `_GUID`.
