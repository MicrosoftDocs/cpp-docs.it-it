...
## Note  
 La funzione membro restituisce true per una sequenza controllata vuota.  Equivale a [hash\_multimap::size](../dotnet/hash-multimap-size-stl-clr.md)`() == 0`.  Utilizzarla per verificare se il hash\_multimap è vuoto.  
