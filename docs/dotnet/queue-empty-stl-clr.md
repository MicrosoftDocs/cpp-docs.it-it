...
## Note  
 La funzione membro restituisce true per una sequenza controllata vuota.  Equivale a [queue::size](../dotnet/queue-size-stl-clr.md)`() == 0`.  Utilizzarla per verificare se la coda è vuota.  
