...
## Note  
 La funzione membro restituisce true per una sequenza controllata vuota.  Equivale a [hash\_map::size](../dotnet/hash-map-size-stl-clr.md)`() == 0`.  È possibile utilizzarla per verificare se l'hash\_map è vuoto.  
