...
## Note  
 La funzione membro rimuove l'ultimo elemento della sequenza selezionata, che deve essere non vuota.  È possibile utilizzarlo per abbreviare il vettore da un elemento posteriore.  
