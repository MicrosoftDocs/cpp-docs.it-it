...
## Note  
 Il membro che l'operatore copia `right` all'oggetto, quindi restituisce `*this`.  Utilizzarla per sostituire la coppia archiviata iteratori con una copia della coppia archiviata di iteratore in `right`.  
