...
|Limite enclave|Un'applicazione che viene eseguita all'interno di un enclave sicura (ad esempio, Intel SGX) considerata attendibile ricevono dati dall'esterno di enclave potrebbero essere a rischio.|
...
Questa categoria dei modelli di sviluppo è necessario soddisfare una diramazione condizionale che conduce a confusione tipo speculativo. I modelli di codice in questa sezione farà riferimento al codice di esempio riportato di seguito.
...
|Architettura|Barriera speculation|
|----------------|----------------|
|x86 o x64|_mm_lfence()|
|ARM|attualmente non disponibile|
|ARM64|attualmente non disponibile|
...
[Materiale sussidiario per ridurre le vulnerabilità di esecuzione speculativo canale laterale](https://portal.msrc.microsoft.com/en-US/security-guidance/advisory/ADV180002)

[Vulnerabilità hardware canale lato esecuzione speculativo fattori](https://blogs.technet.microsoft.com/srd/2018/03/15/mitigating-speculative-execution-side-channel-hardware-vulnerabilities/)
