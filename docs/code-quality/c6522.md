---
description: 'Altre informazioni su: C6522'
title: C6522
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
Per correggere il problema, utilizzare `size_t` per il `ValidBytesParam` tipo di dati del parametro, come illustrato nel codice di esempio seguente:
