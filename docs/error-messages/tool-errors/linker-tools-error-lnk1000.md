...
Errore sconosciuto. consultare la documentazione per le opzioni di supporto tecnico  
 ...
 Questo errore può verificarsi se si combinano i propri file e file di intestazione standard (ad esempio, DOS). `#include`le intestazioni standard prima, seguita dai file di intestazione.