...
2.  **BEGIN previsto nella tabella di tasti di scelta rapida**  
...
8.  **Controllare il carattere compreso nell'intervallo [^ A - ^ Z]**  
...
19. **Previste dimensioni con punti numerici**  
...
24. **Prevista stringa tra virgolette nella classe finestra di dialogo**  
...
27. **I nomi del tipo di carattere devono essere numeri ordinali**  
