---
title: Errore irreversibile del compilatore di risorse RC1018 | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
'#elif' imprevisto  
 ...
 Il `#elif` direttiva non è presente all'interno di un `#if`, **#ifdef**, o **#ifndef** costruire.  
