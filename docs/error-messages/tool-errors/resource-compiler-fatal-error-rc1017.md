---
title: Errore irreversibile del compilatore di risorse RC1017 | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
espressione costante integer non valida  
 ...
 L'espressione in un `#if` direttiva non esiste o non restituire una costante.