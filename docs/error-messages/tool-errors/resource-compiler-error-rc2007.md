---
title: Errore del compilatore di risorse RC2007 | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
ms.locfileid: "33319338"
---
# <a name="resource-compiler-error-rc2007"></a>Errore del compilatore di risorse RC2007
\#definire la sintassi  
  
 Era previsto un identificatore dopo `#define` in una direttiva di pre-elaborazione.