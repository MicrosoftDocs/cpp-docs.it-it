---
title: Errori della riga di comando D8000 a D9999 | Documenti Microsoft
ms.custom: 
ms.date: 11/17/2017
ms.reviewer: 
ms.suite: 
...
---
# <a name="command-line-errors-d8000-through-d9999"></a>Errori della riga di comando da D8000 a D9999

Gli articoli in questa sezione forniscono un riferimento a errori della riga di comando generati dagli strumenti di compilazione.

[!INCLUDE[error-boilerplate](../../error-messages/includes/error-boilerplate.md)]

## <a name="error-and-warning-messages"></a>Messaggi di errore e avviso
