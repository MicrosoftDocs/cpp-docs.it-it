---
title: Errori e avvisi degli strumenti del linker | Documenti Microsoft
ms.custom: 
ms.date: 11/17/2017
ms.reviewer: 
ms.suite: 
...
COLLEGAMENTO, LIB, DUMPBIN ed EDITBIN generare questi errori e avvisi.

[!INCLUDE[error-boilerplate](../../error-messages/includes/error-boilerplate.md)]

## <a name="linker-errors"></a>Errori del linker
...
## <a name="linker-warnings"></a>Avvisi del linker
