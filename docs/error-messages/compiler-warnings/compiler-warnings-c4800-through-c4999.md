...
|Avviso|Messaggio|
|-------------|-------------|
|[Avviso del compilatore (livello 3) C4800](compiler-warning-level-3-c4800.md)|'type': imposto valore booleano 'true' o 'false' (avviso di prestazioni)|
|[Avviso del compilatore (livello 1) C4803](compiler-warning-level-1-c4803.md)|'method': il metodo raise ha una classe di archiviazione diverso da quello dell'evento 'event'|
|[Avviso del compilatore (livello 1) C4804](compiler-warning-level-1-c4804.md)|'operation': utilizzo non affidabile del tipo 'bool' nell'operazione|
|[Avviso del compilatore (livello 1) C4805](compiler-warning-level-1-c4805.md)|'operation': combinazione non affidabile del tipo 'type' e il tipo 'type' nell'operazione|
...
|[Avviso del compilatore (livello 4) C4820](compiler-warning-level-4-c4820.md)|'byte' byte di riempimento aggiunti dopo costrutto 'nome_membro'|
...
|[Avviso del compilatore (livello 3) C4823](compiler-warning-level-3-c4823.md)|'function': utilizza puntatori di blocco ma rimozione semantica non è abilitata. È consigliabile utilizzare /EHa|
...
|[Avviso (errore) del compilatore C4867](compiler-warning-c4867.md)|'function': chiamata di funzione senza elenco di argomenti; Utilizzare 'chiamata' per creare un puntatore a membro|
...
|[Avviso del compilatore (livello 1) C4945](compiler-warning-level-1-c4945.md)|'symbol': Impossibile importare il simbolo da 'assembly1': come 'simbolo' è già stato importato da un altro assembly 'assembly2'|
|[Avviso del compilatore (livello 1) C4946](compiler-warning-level-1-c4946.md)|reinterpret_cast utilizzato tra le classi correlate 'classe1' e 'classe2'|
|Avviso del compilatore (livello 1) C4947|'type_or_member': contrassegnato come obsoleto|
|[Avviso del compilatore (livello 2) C4948](compiler-warning-level-2-c4948.md)|tipo restituito di 'accessor' non corrisponde al tipo dell'ultimo parametro della funzione set corrispondente|
...
|Avviso del compilatore (livello 1) C4951|'function' è stato modificato dopo la raccolta dei dati di profilo, dati di profilo della funzione non utilizzati|
|Avviso del compilatore (livello 1) C4952|'function': dati di profilo non trovato nel database 'pgd_file 'del programma|
|Avviso del compilatore (livello 1) C4953|'function' inline modificata dopo la raccolta dei dati di profilo. Dati di profilo non utilizzati|
...
|Avviso del compilatore (livello 1, errore) C4956|'type': tipo non verificabile|
|Avviso del compilatore (livello 1, errore) C4957|'cast': cast esplicito da 'cast da' a 'cast_to' non è verificabile|
|Avviso del compilatore (livello 1, errore) C4958|'operation': aritmetica dei puntatori non verificabile|
|Avviso del compilatore (livello 1, errore) C4959|Impossibile definire 'type' di tipo non gestito in /CLR: safe perché l'accesso ai membri produce codice non verificabile|
|Avviso del compilatore (livello 4) C4960|'function' è troppo grande per il profiling|
...
|Avviso del compilatore (livello 4) C4962|'function': ottimizzazioni PGO disabilitate perché le ottimizzazioni provocano l'incoerenza i dati di profilo|
...
|[Avviso del compilatore (livello 3) C4995](compiler-warning-level-3-c4995.md)|'function': nome contrassegnato come obsoleto #pragma|
