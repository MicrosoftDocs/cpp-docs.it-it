...
Questo avviso viene generato anche per declspec ([dllexport](../../cpp/dllexport-dllimport.md)) le funzioni contrassegnate come extern "C", anche se sono C++ funzioni.
