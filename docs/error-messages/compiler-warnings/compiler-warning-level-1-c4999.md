---
title: Compilatore (livello 1) Avviso C4999 | Documenti di Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
AVVISO SCONOSCIUTO Per altre informazioni, scegliere Supporto tecnico dal menu ? o aprire il file della Guida relativo al supporto tecnico  
 ...
 Prendere nota delle circostanze dell'errore, provare a isolare il problema e creare un test case riproducibile, quindi contattare [il servizio supporto tecnico clienti Microsoft](/visualstudio/ide/talk-to-us).
