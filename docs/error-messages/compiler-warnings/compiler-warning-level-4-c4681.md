---
title: Avviso del compilatore (livello 4) C4681
ms.date: 11/04/2016
f1_keywords:
- C4681
helpviewer_keywords:
...
Un'interfaccia [di origine](../../windows/attributes/source-cpp.md) non è stata specificata per una classe.
