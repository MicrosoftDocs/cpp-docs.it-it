---
title: "Avviso del compilatore (livello 1) C4628 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
---
# Avviso del compilatore (livello 1) C4628
...
digraph non supportati con \-Ze.La sequenza di caratteri 'digraph' non è stata interpretata come token alternativo per 'char'  
 ...
 I digraph non sono supportati in [\/Ze](../../build/reference/za-ze-disable-language-extensions.md).  Questo avviso è seguito da un errore.  
 ...
 Il seguente codice di esempio genera l'errore C4628:  
