---
title: Compilatore avviso (livello 4) C4324 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
Spaziatura interna è stata aggiunta alla fine di una struttura, poiché è stata specificata una [__declspec(align)](../../cpp/align-cpp.md) valore.
