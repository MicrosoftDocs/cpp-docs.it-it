---
title: Compilatore avviso (livello 1) C4264 | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
'funzione_virtuale': override non disponibile per la funzione membro virtuale dalla base 'class'; la funzione è nascosta  
