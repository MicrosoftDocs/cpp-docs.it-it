...
ms.locfileid: "74810702"
---
# <a name="compiler-warning-level-1-c4473"></a>Avviso del compilatore (livello 1) C4473

> '*Function*': non sono stati passati argomenti sufficienti per i segnaposto di stringa di formato e i relativi parametri prevedono argomenti di *numero* Variadic, ma è stato specificato un *numero* che indica che l' *Indice* dell'argomento Variadic mancante è richiesto dalla stringa di formato '*FORMAT_STRING*'. questo argomento viene usato da un identificatore di conversione. questo argomento viene usato come larghezza di campo.
