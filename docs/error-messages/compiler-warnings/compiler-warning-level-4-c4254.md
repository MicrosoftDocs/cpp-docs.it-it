---
title: Compilatore avviso (livello 4) C4254 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
Un campo di bit più grande è stato assegnato a un campo di bit inferiore. Potrebbe esserci una perdita di dati.
