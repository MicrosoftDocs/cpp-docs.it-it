...
|Avviso|Messaggio|
|-------------|-------------|
|Avviso C4000 del compilatore|AVVISO SCONOSCIUTO<br /><br /> Scegliere il comando di supporto tecnico di Visual c++<br /><br /> Dal menu o aprire il file della Guida di supporto tecnico per ulteriori informazioni|
|[Avviso del compilatore (livello 4) C4001](../../error-messages/compiler-warnings/compiler-warning-level-4-c4001.md)|utilizzata estensione non standard 'commento a riga singola' è stata utilizzata|
...
|[Avviso del compilatore (livello 3) C4013](../../error-messages/compiler-warnings/compiler-warning-level-3-c4013.md)|'function' non definita. Supponendo che restituisce un int extern|
...
|[Avviso del compilatore (livello 3) C4018](../../error-messages/compiler-warnings/compiler-warning-level-3-c4018.md)|'expression': mancata corrispondenza signed e unsigned|
...
|[Avviso del compilatore (livello 1) C4022](../../error-messages/compiler-warnings/compiler-warning-level-1-c4022.md)|'function': errata corrispondenza del puntatore per il parametro effettivo 'numero parametro'|
...
|[Avviso del compilatore (livello 1) C4024](../../error-messages/compiler-warnings/compiler-warning-level-1-c4024.md)|'function': tipi diversi per il parametro formale e quello effettivo 'numero_parametro'|
...
|[Avviso del compilatore (livello 1) C4028](../../error-messages/compiler-warnings/compiler-warning-level-1-c4028.md)|parametro formale 'numero_parametro' differente dalla dichiarazione|
...
|[Avviso del compilatore (livello 4) C4032](../../error-messages/compiler-warnings/compiler-warning-level-4-c4032.md)|il parametro formale 'numero_parametro' ha un tipo diverso quando promosso|
...
|Avviso del compilatore (livello 3) C4191|' operatore/operazione': conversione non affidabile da 'type_of_expression' a 'type_required' \nCalling questa funzione tramite il puntatore risultante può causare del programma|
