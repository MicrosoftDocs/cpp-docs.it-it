...
Questo errore può essere causato da un'istruzione `#include "filename"` in un blocco di compilazione condizionale che non viene compilato nel file di origine PCH.
