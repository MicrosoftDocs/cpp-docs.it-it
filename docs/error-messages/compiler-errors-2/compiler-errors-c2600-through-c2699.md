...
|[Errore del compilatore C2635](compiler-error-c2635.md)|non è possibile convertire un '*type1*\*' per un '*type2*\*'; è implicita la conversione da una classe base virtuale|
...
|[Errore del compilatore C2649](compiler-error-c2649.md)|«*identificatore*': non è un 'classe/struct/union'|
...
|[Errore del compilatore C2652](compiler-error-c2652.md)|'*identifier*': costruttore di copia non valida: primo parametro non deve essere un '*tipo*'|
|[Errore del compilatore C2653](compiler-error-c2653.md)|«*identificatore*': non è un nome di classe o dello spazio dei nomi|
...
|[Errore del compilatore C2657](compiler-error-c2657.md)|«*classe*:: *' trovata all'inizio di un'istruzione (si è omesso di specificare un tipo di?)|
...
|[Errore del compilatore C2665](compiler-error-c2665.md)|'*funzione*': nessuno delle *numero* overload potrebbe convertire tutti i tipi di argomento|
|[Errore del compilatore C2666](compiler-error-c2666.md)|«*funzione*': *numero* overload presentano conversioni simili|
|[Errore del compilatore C2667](compiler-error-c2667.md)|«*funzione*': nessuno dei *numero* overload presenta una conversione ottimale|
...
|[Errore del compilatore C2672](compiler-error-c2672.md)|«*funzione*': non corrisponde ad alcuna funzione in overload trovata|
...
|[Errore del compilatore C2675](compiler-error-c2675.md)|unario '*operator*': '*tipo*' non definisce questo operatore né una conversione in un tipo accettabile dall'operatore predefinito|
|[Errore del compilatore C2676](compiler-error-c2676.md)|binario '*operator*': '*tipo*' non definisce questo operatore né una conversione in un tipo accettabile dall'operatore predefinito|
|[Errore del compilatore C2677](compiler-error-c2677.md)|binario '*operator*': è stato trovato alcun operatore globale che accetti il tipo '*tipo*' (o nessuna conversione accettabili)|
|[Errore del compilatore C2678](compiler-error-c2678.md)|binario '*operator*': è stato trovato alcun operatore che accetti un operando sinistro di tipo '*tipo*' (o nessuna conversione accettabili)|
|[Errore del compilatore C2679](compiler-error-c2679.md)|binario '*operator*': è stato trovato alcun operatore che accetti un operando a destra del tipo '*tipo*' (o nessuna conversione accettabili)|
|[Errore del compilatore C2680](compiler-error-c2680.md)|«*tipo*': tipo di destinazione non è valido per *cast*|
...
|[Errore del compilatore C2690](compiler-error-c2690.md)|«*operatore*': Impossibile eseguire aritmetica puntatore su una matrice gestita o WinRT|
...
|[Errore del compilatore C2692](compiler-error-c2692.md)|'*funzione*': le funzioni con prototipo completo richiesti nel compilatore C con il ' o clr' opzione|
...
|[Errore del compilatore C2694](compiler-error-c2694.md)|«*funzione_override*': funzione virtual in override ha eccezioni meno restrittive rispetto a funzione membro virtuale della classe base '*funzione_base*»|
