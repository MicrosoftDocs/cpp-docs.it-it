...
|Error|Messaggio|
|-----------|-------------|
|[Errore del compilatore C2600](compiler-error-c2600.md)|'*funzione*': Impossibile definire una funzione membro speciale generata dal compilatore (deve essere dichiarata nella classe prima)|
|[Errore del compilatore C2601](compiler-error-c2601.md)|'*funzione*': non sono valide le definizioni di funzione locale|
|[Errore del compilatore C2602](compiler-error-c2602.md)|'*classe*::*identificatore*'non è un membro di una classe di base'*classe*'|
|[Errore del compilatore C2603](compiler-error-c2603.md)|'*funzione*': troppi oggetti statici in ambito blocco aventi costruttore e/distruttori nella funzione|
|C2604 errore del compilatore|'*identificatore*': non può implementare più di un metodo di interfaccia|
...
|C2607 errore del compilatore|asserzione statica non riuscita|
...
|[Errore del compilatore C2614](compiler-error-c2614.md)|'*classe*': inizializzazione membro non valida: '*identificatore*' non è una base o un membro|
|C2615 errore del compilatore|Obsoleta.|
|[Errore del compilatore C2616](compiler-error-c2616.md)|'*conversione*': non è possibile convertire in modo implicito un valore non l-value '*type1*' a un '*type2*' che non sia const|
...
|[Errore del compilatore C2619](compiler-error-c2619.md)|'*identificatore*': un membro dati statici non è consentito in struct/union anonima|
...
|[Errore del compilatore C2624](compiler-error-c2624.md)|'*ambito*::*tipo*': le classi locali non possono essere utilizzate per dichiarare variabili 'extern'|
|C2625 errore del compilatore|'*identificatore*': membro di union non valido; di tipo '*tipo*' è di tipo riferimento|
|[Errore del compilatore C2626](compiler-error-c2626.md)|'*identificatore*': un membro dati privato o protetto non è consentito in struct/union anonima|
|[Errore del compilatore C2627](compiler-error-c2627.md)|'*funzione*': funzione membro non consentite nelle unioni anonime|
|[Errore del compilatore C2628](compiler-error-c2628.md)|'*type1*'seguita da'*type2*' non è valido (è stato omesso un ';'?)|
|C2629 errore del compilatore|'*identificatore*': struct/union anonima non è possibile dichiarare un tipo annidato|
...
|C2631 errore del compilatore|'*identificatore*': Impossibile definire una classe o enum in un modello di alias|
|[Errore del compilatore C2632](compiler-error-c2632.md)|'*type1*'seguita da'*type2*' non è valido|
|[Errore del compilatore C2633](compiler-error-c2633.md)|'*identificatore*': la classe di archiviazione ammessa solo per i costruttori è 'inline'|
|[Errore del compilatore C2634](compiler-error-c2634.md)|'*classe*::*membro*': puntatore a membro riferimento non valido|
|[Errore del compilatore C2635](compiler-error-c2635.md)|non è possibile convertire un '*type1*\*' a un '*type2*\*'; la conversione da una classe base virtuale è implicita|
...
|[C2672 errore del compilatore](compiler-error-c2672.md)|'*funzione*': non corrisponde ad alcuna funzione in overload trovata|
