...
|C3512 errore del compilatore|la sequenza caratteri di delimitazione per un valore letterale stringa non elaborata non può contenere più di 16 caratteri|  
...
|C3515 errore del compilatore|l'argomento di una specializzazione parziale di un modello di classe specificato come espansione di pacchetto deve essere l'ultimo argomento|  
...
|C3526 errore del compilatore|'...' non è possibile applicare a 'this'|  
...
|[Errore del compilatore C3869](compiler-error-c3869.md)|nel vincolo gcnew manca l'elenco parametri vuoto '()' |  
