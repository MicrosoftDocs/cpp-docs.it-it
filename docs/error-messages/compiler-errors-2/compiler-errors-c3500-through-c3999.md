...
|[Errore del compilatore C3507](compiler-error-c3507.md)|un ProgID può avere non più di 39 caratteri*progid*'; né contenere punteggiatura oltre a '.'; né iniziare con una cifra|
|[Errore del compilatore C3508](compiler-error-c3508.md)|'*tipo*': non è un tipo di automazione valido|
|[Errore del compilatore C3509](compiler-error-c3509.md)|'*tipo*': non valido nel tipo restituito di automazione; quando un parametro è contrassegnato 'retval', il tipo restituito deve essere 'void', 'HRESULT' o 'SCODE'|
|[Errore del compilatore C3510](compiler-error-c3510.md)|non è possibile individuare la libreria dei tipi dipendente *libreria*|
...
|C3516 errore del compilatore|fine-di-file imprevista durante l'elaborazione del valore letterale; di stringa non elaborata sequenza delimitatore '*stringa*' non corrisponde|
|C3517 errore del compilatore|'*identificatore*' una dichiarazione di alias non può avere un tipo che contiene 'auto'|
|C3518 errore del compilatore|'*identificatore*': in un contesto direct-list-initialization il tipo per '*tipo*' può essere dedotto solo da una singola espressione dell'inizializzatore|
|[Errore del compilatore C3519](compiler-error-c3519.md)|'*parametro*': parametro non valido per l'attributo embedded_idl|
|C3520 errore del compilatore|'*identificatore*': il pacchetto di parametro deve essere espanso in questo contesto|
|C3521 errore del compilatore|'*identificatore*' non è un pacchetto parametri|
|C3522 errore del compilatore|'*tipo*': il pacchetto di parametro non può essere espanso in questo contesto|
...
|C3525 errore del compilatore|'*parametro*': se un modello di classe dispone di un pacchetto di parametri di modello deve essere visualizzato alla fine dell'elenco dei parametri di modello|
...
|[Errore del compilatore C3531](compiler-error-c3531.md)|'*identificatore*': un simbolo il cui tipo contiene '*tipo*' deve avere un inizializzatore|
|[Errore del compilatore C3532](compiler-error-c3532.md)|tipo di elemento di matrice non può essere un tipo che contiene '*tipo*'|
...
|[Errore del compilatore C3536](compiler-error-c3536.md)|'*identificatore*': non può essere utilizzato prima di essere inizializzata|
...
|C3598 errore del compilatore|istruzione Label non supportato in codice con restrizioni amp|
...
|[Errore del compilatore C3610](compiler-error-c3610.md)|'*identificatore*': tipo di valore deve essere 'boxed' prima di metodo '*metodo*' può essere chiamato|
...
|C3613 errore del compilatore|tipo restituito mancante dopo '->' ('' presupposto int)|
...
|[C3615 errore del compilatore](compiler-error-c3615.md)|funzione constexpr '*funzione*' non può restituire un'espressione costante|
...
|[Errore del compilatore C3627](compiler-error-c3627.md)|Solo un tipo di valore può essere boxed|
...
|[Errore del compilatore C3661](compiler-error-c3661.md)|override esplicito elenco non ha trovato alcun metodo per eseguire l'override|
...
|[Errore del compilatore C3672](compiler-error-c3672.md)|espressione pseudo-distruttore può essere utilizzato solo come parte di una chiamata di funzione|
...
|C3680 errore del compilatore|non è possibile concatenare valori letterali stringa definita dall'utente con identificatori di suffisso letterali senza corrispondenza|
...
|C3683 errore del compilatore|non è possibile definire l'operatore di valori letterali non elaborati sia il modello di operatore del valore letterale con lo stesso identificatore di suffisso letterale|
|C3684 errore del compilatore|' operatore *identificatore*': dichiarazione di operatore del valore letterale è un elenco di parametri non validi|
...
|[Errore del compilatore C3739](compiler-error-c3739.md)|'*classe*': la sintassi è solo supportata quando il ' layout\_dipendente ' di event_receiver è true|
...
|[Errore del compilatore C3743](compiler-error-c3743.md)|può solo eseguire un hook/unhook un'intera interfaccia quando il parametro 'layout_dependent' di event_receiver è true|
...
|C3758 errore del compilatore|'*membro*': funzione virtuale non può essere dichiarati come 'constexpr'|
...
|[Errore del compilatore C3832](compiler-error-c3832.md)|'*typelib*': libreria dei tipi sembra come se è stata compilata per puntatori a 32 bit; modifica il qualificatore 'ptrsize'|
|[Errore del compilatore C3833](compiler-error-c3833.md)|'*tipo*': tipo di destinazione non valido per *identificatore*|
|[Errore del compilatore C3834](compiler-error-c3834.md)|cast non valido esplicita di un puntatore di blocco. In alternativa, usare una variabile locale bloccata|
|C3835 errore del compilatore|Obsoleta.|
|[Errore del compilatore C3836](compiler-error-c3836.md)|un costruttore statico non è possibile avere un elenco di inizializzatori di membro|
...
|[Errore del compilatore C3853](compiler-error-c3853.md)|'=': reinizializzare un riferimento o un'assegnazione mediante un riferimento a funzione non è valido|
...
|C3875 errore del compilatore|chiamata di funzione membro non statico manca l'elenco di argomenti|
...
|C3927 errore del compilatore|'->': tipo restituito finale non è consentito dopo un dichiaratore di funzione non|
...
|C3934 errore del compilatore|una funzione che in qualsiasi formato di 'main' non può avere identificatori di restrizione diversi da Restrict (CPU)|
...
|C3937 errore del compilatore|indicatore di restrizione vuote non è consentito.|
...
|C3962 errore del compilatore|classe generica non è supportata.|
|C3963 errore del compilatore|matrice multidimensionale non è supportata.|
|C3964 errore del compilatore|Matrice di matrici non è supportata.|
|C3965 errore del compilatore|Matrice di parametri non è supportata.|
...
|C3980 errore del compilatore|'*tipo*' non può essere generato nei metadati|
