...
Un distruttore o un finalizzatore non può restituire un valore di `void` o di un altro tipo. Rimuovere l'istruzione `return` dalla definizione del distruttore.
