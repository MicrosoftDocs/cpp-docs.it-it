...
```  
 ...
 Questo errore può anche essere generato come risultato delle operazioni di conformità del compilatore eseguite per Visual Studio .NET 2003. `bool` è ora un tipo appropriato. Nelle versioni precedenti, `bool` era un typedef ed è possibile creare gli identificatori con lo stesso nome.  
