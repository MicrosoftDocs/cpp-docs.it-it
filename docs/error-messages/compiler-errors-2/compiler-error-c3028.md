...
ms.locfileid: "46067194"
---
# <a name="compiler-error-c3028"></a>Errore del compilatore C3028

'member': solo un membro dati statici o variabili possa essere usato in una clausola di condivisione dei dati

È stato passato un simbolo diverso da un membro dati statici o variabili per le clausole reduction.
