---
title: Errori del compilatore compilatore da C2700 a C2799
ms.date: 11/17/2017
f1_keywords:
- C2716
- C2717
...
ms.locfileid: "50677851"
---
# <a name="compiler-errors-c2700-through-c2799"></a>Errori del compilatore compilatore da C2700 a C2799
...
|[Errore del compilatore C2701](compiler-error-c2701.md)|«*funzione*': un funzione modello o generico non può essere un elemento friend di una classe locale|
|[Errore del compilatore C2702](compiler-error-c2702.md)| except non vengano visualizzate in un blocco di terminazione|
|[Errore del compilatore C2703](compiler-error-c2703.md)|istruzione leave non valida|
|[Errore del compilatore C2704](compiler-error-c2704.md)|«*funzione*': va_start intrinseco ammesso solo in varargs|
|[Errore del compilatore C2705](compiler-error-c2705.md)|«*label*': salto non valido in '*exception_block*' ambito|
|[Errore del compilatore C2706](compiler-error-c2706.md)|except non valido senza try corrispondente (non presente '}' nel blocco try?)|
|[Errore del compilatore C2707](compiler-error-c2707.md)|«*identificatore*': contesto non valido per la funzione intrinseca|
|[Errore del compilatore C2708](compiler-error-c2708.md)|«*identificatore*': lunghezza in byte dei parametri effettivi differisce dalla precedente chiamata o di riferimento|
...
|[Errore del compilatore C2710](compiler-error-c2710.md)|«*identifier*': ' declspec (*modificatore*)' può essere applicato solo a una funzione che restituisce un puntatore|
|[Errore del compilatore C2711](compiler-error-c2711.md)|'*funzione*': questa funzione non possa essere compilate come gestite, prendere in considerazione utilizzando #pragma non gestiti|
|[Errore del compilatore C2712](compiler-error-c2712.md)|Non è possibile utilizzare try in funzioni che richiedono la rimozione di oggetti|
|[Errore del compilatore C2713](compiler-error-c2713.md)|per ogni funzione è consentito un solo metodo di gestione delle eccezioni|
|[Errore del compilatore C2714](compiler-error-c2714.md)|alignof (void) non è consentita|
...
|[Errore del compilatore C2718](compiler-error-c2718.md)|«*tipo*': parametro effettivo con allineamento richiesto pari *numero* non verrà allineato|
|[Errore del compilatore C2719](compiler-error-c2719.md)|«*parametro*': parametro formale con allineamento richiesto pari *numero* non verrà allineato|
|[Errore del compilatore C2720](compiler-error-c2720.md)|'*identifier*': '*identificatore*' identificatore classe di archiviazione non valido per i membri|
...
|[Errore del compilatore C2722](compiler-error-c2722.md)|'::*operator*': non valido dopo il comando operator; utilizzare ' operator *operatore*'|
...
|[Errore del compilatore C2724](compiler-error-c2724.md)|«*funzione*': non utilizzare 'static' le funzioni membro definite in ambito file|
|[Errore del compilatore C2725](compiler-error-c2725.md)|«*tipo*': Impossibile generare o intercettare un oggetto gestito o WinRT per valore o per riferimento|
...
|C2740 errore del compilatore|valore dell'operando '*numero*'non è compreso nell'intervallo'*lower_bound* - *upper_bound*'|
...
|C2759 errore del compilatore|rapporto assembler inline: *error_message*|
...
|C2799 errore del compilatore|«*identificatore*': deve essere inizializzato un oggetto di tipo di classe qualificato da const senza un costruttore predefinito fornito dall'utente|
