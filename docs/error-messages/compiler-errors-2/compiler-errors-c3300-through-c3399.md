---
title: Compilatore errori C3300 a C3399
ms.date: 11/17/2017
f1_keywords:
- C3300
- C3301
...
ms.locfileid: "50652699"
---
# <a name="compiler-errors-c3300-through-c3399"></a>Compilatore errori C3300 a C3399
...
|C3302 errore del compilatore|'*identifier*': identificatore è costituito da più di *numero* caratteri|
...
|C3306 errore del compilatore|«*modello*': classe senza nome modello/generici non è consentito|
|C3307 errore del compilatore|«*modulo*': Impossibile creare il modulo IDL|
|C3308 errore del compilatore|« *funzione*': indirizzare chiamata tramite la classe importata non è supportato|
...
|C3311 errore del compilatore|attributo module deve essere definita nell'ambito globale|
|C3312 errore del compilatore|non richiamabile '*identifier*'per il tipo di trovare la funzione'*tipo*'|
|C3313 errore del compilatore|«*identifier*': tipo di variabile non può essere '*tipo*»|
|C3314 errore del compilatore|«*simbolo*': non un tipo supportato modulo IDL|
|C3315 errore del compilatore|« *funzione*': deve essere una funzione membro|
|C3316 errore del compilatore|«*tipo*': una matrice di dimensioni sconosciute non può essere utilizzata in un intervallo basato su per istruzione|
|C3317 errore del compilatore|«*identificatore*': una funzione in overload non può essere utilizzata come espressione in un intervallo basato su per istruzione|
...
|C3327 errore del compilatore|«*proprietà*': specificare il valore di proprietà dell'attributo '*attributo*»|
|C3328 errore del compilatore|«*attributo*': attributo non dispone di argomenti sufficienti|
...
|C3331 errore del compilatore|«*identificatore*': gli attributi dei parametri sono consentiti solo per le interfacce COM e coclassi|
|C3332 errore del compilatore|«*proprietà*': proprietà incoerenti, grammatica '*proprietà*' è sia obbligatoria e ha un valore predefinito|
...
|C3335 errore del compilatore|«*identifier*': può essere presente al massimo una sola interfaccia predefinita per di una coclasse*classe*»|
|C3336 errore del compilatore|Questa operazione deve essere eseguita nell'ambito della classe|
|C3337 errore del compilatore|«*identifier*': defaultvtable deve essere un'origine evento per di una coclasse*classe*»|
|C3338 errore del compilatore|«*identifier*': può essere presente al massimo una sola interfaccia predefinita che è anche un'origine evento per di una coclasse*classe*»|
|C3339 errore del compilatore|il parametro di modello richiede 'class' o 'typename' dopo l'elenco dei parametri|
...
|C3346 errore del compilatore|dichiarazione esportata in ambito non dello spazio dei nomi|
...
|C3348 errore del compilatore|modelli esportati non fanno parte degli standard C++ correnti|
...
|C3355 errore del compilatore|«*classe*::*membro*': attributo multicast è in ascolto al provider '*provider1*', ma viene implementato dal provider '*provider2*»|
...
|C3357 errore del compilatore|«*attributo*': attributo ambiguo, è necessario usare il nome completo|
...
|Errore C3378 errore del compilatore|è possibile esportare una dichiarazione solo da un'unità dell'interfaccia del modulo|
