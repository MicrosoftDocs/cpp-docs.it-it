...
|C2832 errore del compilatore|«*identificatore*': un tipo di riferimento non può essere sottoposto a inizializzazione valore|
...
|C2851 errore del compilatore|«*enum*': un'enumerazione WinRT pubblica può usare solo 'int' o 'unsigned int' come tipo di base|
|C2852 errore del compilatore|«*identificatore*': solo i membri dati possono essere inizializzati all'interno di una classe|
|C2853 errore del compilatore|«*identificatore*': un membro dati non statico non può avere un tipo che contiene 'auto'|
...
|C2887 errore del compilatore|SWI o HVC non può contenere più di cinque argomenti (numero SWI, r0 - r3)|
...
|C2895 errore del compilatore|«*dichiarazione*': non è possibile creare in modo esplicito un'istanza di un modello di funzione che è stato dichiarato con dllimport|
