...
|[Errore del compilatore C3104](compiler-error-c3104.md)|argomento non valido per l'attributo|  
...
|C3108 errore del compilatore|non è possibile dedurre un tipo perché un elenco di inizializzatori non è un'espressione|  
...
|C3111 errore del compilatore|Non è possibile usare un elenco di inizializzatori come argomento predefinito per un parametro di modello|  
...
|C3119 errore del compilatore|alignas(void) non è consentito|  
...
|C3123 errore del compilatore|Un'interfaccia generica WinRT non può avere vincoli|  
...
|[Errore del compilatore C3130](compiler-error-c3130.md)|Errore interno del compilatore: non è possibile scrivere nel PDB il blocco di codice inserito|  
...
|[Errore del compilatore C3140](compiler-error-c3140.md)|impossibile avere più attributi 'module' nella stessa unità di compilazione|  
...
|[Errore del compilatore C3167](compiler-error-c3167.md)|Impossibile inizializzare .NET Framework: accertarsi che sia installato|  
...
|[Errore del compilatore C3170](compiler-error-c3170.md)|impossibile avere identificatori di moduli diversi nello stesso progetto|  
...
|[Errore del compilatore C3173](compiler-error-c3173.md)|conflitto di versioni nel merge idl|  
|[Errore del compilatore C3174](compiler-error-c3174.md)|attributo module non specificato|  
...
|[Errore del compilatore C3192](compiler-error-c3192.md)|errore di sintassi: '^' non è la forma prefissa di un operatore (si intendeva '*'?)|  
...
|[Errore del compilatore C3198](compiler-error-c3198.md)|uso non valido di pragma a virgola mobile: il pragma fenv_access funziona solo in modalità precise|  
|[Errore del compilatore C3199](compiler-error-c3199.md)|uso non valido di pragma a virgola mobile: le eccezioni non sono supportate in modalità non precise|  
