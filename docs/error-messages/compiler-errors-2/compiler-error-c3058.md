...
'symbol': simbolo non dichiarato 'threadprivate' prima dell'utilizzo nella clausola 'copyin'  
 ...
 Un simbolo deve essere dichiarato [threadprivate](../../parallel/openmp/reference/threadprivate.md) prima di poter essere utilizzato un [copyin](../../parallel/openmp/reference/copyin.md) clausola.  
