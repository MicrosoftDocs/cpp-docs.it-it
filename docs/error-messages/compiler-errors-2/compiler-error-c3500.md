...
ms.locfileid: "80200838"
---
# <a name="compiler-error-c3500"></a>Errore del compilatore C3500

ProgID ' ProgID ' non valido

ProgID non valido specificato con l'istruzione `#import`. Controllare il registro di sistema di Windows per assicurarsi di specificare un ProgID valido.
