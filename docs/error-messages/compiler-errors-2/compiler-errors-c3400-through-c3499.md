---
title: Del compilatore errori C3400 a C3499
ms.date: 11/17/2017
f1_keywords:
- C3401
- C3402
...
ms.locfileid: "50576722"
---
# <a name="compiler-errors-c3400-through-c3499"></a>Del compilatore errori C3400 a C3499
...
|C3401 errore del compilatore|«*identificatore*': identificatore di accesso assembly non valido - solo 'privata' è consentito nei modelli di classe|
|C3402 errore del compilatore|«*funzione*': non è possibile risolvere l'overload tranne che nell'ambito corrente|
|C3403 errore del compilatore|non è possibile usare thread_local con /clr: pure o /CLR: safe|
|C3404 errore del compilatore|«*costruire*': errore di sintassi imprevisto|
|C3405 errore del compilatore|«*funzione*': Impossibile risolvere l'overload senza un descrittore completo|
|C3406 errore del compilatore|«*parola chiave*': non è possibile usare in un identificatore di tipo elaborato|
|C3407 errore del compilatore|«*tipo*' non può essere utilizzato in questo contesto|
...
|C3410 errore del compilatore|«*identifier*': il tipo di istanza esplicita '*tipo*'non corrisponde al tipo del modello di variabile'*tipo*»|
|C3411 errore del compilatore|«*tipo*' non è valido come dimensioni di matrice perché non è un tipo integer|
...
|C3419 errore del compilatore|Obsoleta.|
...
|C3422 errore del compilatore|«*dichiarazione*': tipi non corrispondenti*tipo*"e"*tipo*»|
|C3423 errore del compilatore|Obsoleta.|
|C3424 errore del compilatore|«*tipo*': non è consentito un cast di tipo funzione a un tipo di matrice|
|C3425 errore del compilatore|non è possibile generare il puntatore all'oggetto di tipo incompleto '*tipo*'|
|C3426 errore del compilatore|non è possibile generare l'oggetto di tipo incompleto '*tipo*'|
|C3427 errore del compilatore|«*contesto*': '*parola chiave*' non può essere usato con layout_version (*numero*)|
|C3428 errore del compilatore|«*contesto*': '*parola chiave*' può essere applicato solo a definizioni o dichiarazioni di classe|
|C3429 errore del compilatore|«*contesto*': '*parola chiave*' non può essere applicato a un'unione|
|C3430 errore del compilatore|un'enumerazione con ambito deve avere un nome|
|C3431 errore del compilatore|«*identifier*': *type1* non può essere dichiarata come *type2*|
|C3432 errore del compilatore|«*identificatore*': una dichiarazione con prototipo di un'enumerazione senza ambita deve presentare un tipo sottostante|
|C3433 errore del compilatore|«*identifier*': tutte le dichiarazioni di enumerazione deve avere lo stesso tipo sottostante, è stato '*type1*"adesso"*type2*»|
|C3434 errore del compilatore|«*contesto*': valore dell'enumeratore '*numero*'non può essere rappresentato come'*tipo*', il valore è'*numero*»|
|C3435 errore del compilatore|set di caratteri '*nome*' non è supportato|
...
|C3439 errore del compilatore|layout_version (*numero*): numero di versione non valido|
|C3440 errore del compilatore|«*dichiarazione*': layout_version (*numero*) compatibile con una dichiarazione precedente|
|C3441 errore del compilatore|«*dichiarazione*': '*parola chiave*' non può essere applicato dopo che è stata definita la classe|
|C3442 errore del compilatore|Inizializzazione di più membri dell'unione: '*membro1*'e'*membro2*'|
|C3443 errore del compilatore|L'inizializzatore di membro predefinito per '*classe*' è ricorsivo|
|C3444 errore del compilatore|Classe aggregata vuota*classe*'deve essere inizializzata con'{}'|
...
|C3471 errore del compilatore|nuovo nome del modulo *name* (set nella riga di comando) è in conflitto con quello precedente *nome*|
|C3472 errore del compilatore|nuovo nome di file di output *nomefile* (set nella riga di comando) è in conflitto con il nome file precedente *nomefile*|
...
|C3478 errore del compilatore|«*identificatore*': una matrice non può essere acquisita per copia|
...
|C3494 errore del compilatore|'this' non è possibile acquisire in modo esplicito perché una modalità di acquisizione di inclusione non lo consente|
...
|Compilatore errore C3497|Impossibile costruire un'istanza di un'espressione lambda|
