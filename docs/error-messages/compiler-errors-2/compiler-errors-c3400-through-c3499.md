...
|Errore del compilatore C3405|'*Function*': Impossibile risolvere l'overload senza un descrittore completo|
...
|Errore del compilatore C3427|'*context*': non è possibile usare '*keyword*' con layout_version (*Number*)|
|Errore del compilatore C3428|'*context*':'*keyword*' può essere applicato solo a definizioni o dichiarazioni di classe|
...
|Errore del compilatore C3431|'*Identifier*': *tipo1* non può essere ridichiarato come *tipo2*|
|Errore del compilatore C3432|'*Identifier*': una dichiarazione con server di un'enumerazione senza ambito deve avere un tipo sottostante|
|Errore del compilatore C3433|'*Identifier*': tutte le dichiarazioni di un'enumerazione devono avere lo stesso tipo sottostante, is '*tipo1*' Now '*tipo2*'|
...
|Errore del compilatore C3471|il *nome del nuovo modulo (impostato* sulla riga di comando) è in conflitto con il nome *del nome precedente*|
