...
|Errore|Messaggio|  
|-----------|-------------|  
|[Errore del compilatore C3400](compiler-error-c3400.md)|dipendenza di vincolo circolare che comprende '*constraint1*'e'*vincolo2*'|  
...
|C3402 errore del compilatore|'*funzione*': Impossibile risolvere l'overload tranne nell'ambito corrente|  
...
|C3406 errore del compilatore|'*parola chiave*': non può essere utilizzato in un identificatore di tipo elaborato|  
...
|C3410 errore del compilatore|'*identificatore*': il tipo di creazione di istanza esplicita '*tipo*'non corrisponde al tipo del modello di variabile'*tipo*'|  
|C3411 errore del compilatore|'*tipo*' non è valido come le dimensioni di una matrice perché non è un tipo integer|  
...
|[Errore del compilatore C3415](compiler-error-c3415.md)|più '*sezione*' trovate sezioni con attributi differenti ('0 x*valore*')|  
...
|[Errore del compilatore C3418](compiler-error-c3418.md)|Identificatore di accesso '*identificatore*' non è supportata|  
...
|C3422 errore del compilatore|'*dichiarazione*': mancata corrispondenza tra tipi*tipo*'e'*tipo*'|  
|C3423 errore del compilatore|Obsoleta.|  
|C3424 errore del compilatore|'*tipo*': non è consentito un cast di un tipo di matrice di tipo funzione|  
|C3425 errore del compilatore|Impossibile generare il puntatore all'oggetto di tipo incompleto '*tipo*'|  
|C3426 errore del compilatore|Impossibile generare l'oggetto di tipo incompleto '*tipo*'|  
|C3427 errore del compilatore|'*contesto*': '*(parola chiave)*' non può essere utilizzato con layout_version (*numero*)|  
...
|C3442 errore del compilatore|Inizializzazione di più membri dell'unione: '*membro1*'e'*member2*'|  
...
|C3446 errore del compilatore|'*classe*': non è consentito un inizializzatore di membro predefinito per un membro di una classe di valore|  
...
|C3477 errore del compilatore|impossibile utilizzare un'espressione lambda in un contesto non valutato|  
...
|C3494 errore del compilatore|non è possibile acquisire 'this' in modo esplicito perché una modalità di acquisizione di inclusione non lo consente|  
...
|C3497 errore del compilatore|impossibile costruire un'istanza di un'espressione lambda|  
