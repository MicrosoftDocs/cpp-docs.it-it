...
Non è possibile usare la gestione delle eccezioni strutturata (`__try`C++ /`__except`) e la gestione delle eccezioni (`try`/`catch`) nella stessa funzione.
