...
È stato usato un valore non valido per dichiarare un attributo.  Visualizzare [attributo](../../windows/attributes/attribute.md) per altre informazioni.
