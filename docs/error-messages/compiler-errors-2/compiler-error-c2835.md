---
description: 'Altre informazioni su: errore del compilatore C2835'
...
Le conversioni di tipi definite dall'utente non possono assumere parametri formali.

L'esempio seguente genera l'C2835:
