...
Un blocco strutturato in un'area 'sections' OpenMP deve essere preceduto da '#pragma omp section'  
 ...
 Qualsiasi codice in un blocco di codice introdotto da una [sezioni](../../parallel/openmp/reference/sections-openmp.md) direttiva deve essere in un blocco di codice introdotto da una `section` direttiva.  
