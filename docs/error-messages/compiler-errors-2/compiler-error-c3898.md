...
Un membro dati [initonly](../../dotnet/initonly-cpp-cli.md) è stato dichiarato in una classe nativa.  Un membro dati `initonly` può essere dichiarato solo in una classe CLR.
