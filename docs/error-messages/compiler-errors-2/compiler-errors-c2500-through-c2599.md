...
|Errore del compilatore C2501|«*identifier*': ' declspec (*identificatore*)' può essere applicato solo a struct, unioni, classi o membri di campo di bit senza segno|
...
|Errore del compilatore C2508|«*identifier*': ' declspec (*specifier1*)' non può essere combinato con ' declspec (*specifier2*)»|
...
|Errore del compilatore C2515|«*identificatore*': 'vtguard' può essere applicato solo a definizioni o dichiarazioni di classe|
...
|Errore del compilatore C2520|«*classe*': nessun costruttore non esplicito disponibile per la conversione implicita|
|[Errore del compilatore C2521](compiler-error-C2521.md)|un distruttore/finalizzatore non accetta alcun argomento|
|Errore del compilatore C2522|'*identifier*': Identificatore di overload non può essere utilizzato in '*identifier1*"così com'è già specificato in'*identifier2*'|
...
|Errore del compilatore C2525|'*identifier*': Il parametro '*identifier1*'denominata'*identifier2*' sulla base di funzione e deve essere associata in un'implementazione pubblicata|
|[Errore del compilatore C2526](compiler-error-C2526.md)|'*identifier1*': Funzione con collegamento C non può restituire C++ della classe*identifier2*'|
|Errore del compilatore C2527|'*identifier*': Non è possibile specificare defaultOverload in entrambi '*function1*'e'*function2*'. Rimuovere una specifica o rinominare la funzione durante l'implementazione|
...
|Errore del compilatore C2546|«*identificatore*': quando un tipo viene definito in un assembly di interoperabilità primario e un assembly di interoperabilità primario è necessario fare riferimento innanzitutto no-PIA|
...
|Errore del compilatore C2559|«*identificatore*': non è possibile eseguire l'overload di una funzione membro senza qualificatore di riferimento con una funzione membro con qualificatore di riferimento|
|Errore del compilatore C2560|«*identificatore*': non è possibile eseguire l'overload di una funzione membro con qualificatore di riferimento con una funzione membro senza qualificatore di riferimento|
...
|Errore del compilatore C2565|«*identificatore*': qualificatore di riferimento non è valido per costruttori e distruttori|
...
|Errore del compilatore C2576|«*identificatore*': non è possibile introdurre un nuovo metodo virtuale come 'public'. Prendere in considerazione il metodo non virtuale o modificare l'accessibilità impostandolo su 'internal' o 'protected private'|
...
|Errore del compilatore C2578|«*classe*': tipo non può avere un 'protected' o il costruttore 'protected public'|
|[Errore del compilatore C2579](compiler-error-C2579.md)|Impossibile risolvere il tipo *tipo* (*offset*). È previsto *nomefile*|
|Errore del compilatore C2580|«*identificatore*': più versioni di un funzioni membro speciali impostate come predefinite non sono consentite|
...
|Errore del compilatore C2590|«*identificatore*': solo un costruttore può avere un elenco di inizializzatori di basi/membri|
|Errore del compilatore C2591|ExclusiveTo non è possibile usare '*tipo*' come argomento. Solo 'ref class' è un argomento valido|
...
|Errore del compilatore C2595|«*identificatore*' tipo di attributo oggetto WinRT deve essere sealed|
|Errore del compilatore C2596|«*identificatore*' campo attributo WinRT oggetto può essere solo un 'public enum class', 'int', 'unsigned int', 'bool', 'Platform:: Type', 'Platform:: String' o 'Windows:: Foundation:: HResult'|
