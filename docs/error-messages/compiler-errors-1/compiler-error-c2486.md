---
title: Errore del compilatore C2486 | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-diagnostics
...
LOCAL_SIZE' consentito solo nella funzione con l'attributo 'naked'  
 ...
 Nelle funzioni assembly inline, il nome `__LOCAL_SIZE` è riservato per le funzioni dichiarate con la [naked](../../cpp/naked-cpp.md) attributo.  
