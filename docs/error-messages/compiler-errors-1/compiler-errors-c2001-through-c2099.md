---
title: Compilatore errori C2000 a C2099
ms.date: 11/17/2017
f1_keywords:
- C2000
- C2016
...
ms.locfileid: "50548148"
---
# <a name="compiler-errors-c2000-through-c2099"></a>Compilatore errori C2000 a C2099
...
|Error|Messaggio|
|-----------|-------------|
|C2000 errore del compilatore|SCONOSCIUTO errore, scegliere supporto tecnico dal menu di Visual C++ o aprire il file della Guida di supporto tecnico per altre informazioni|
...
|C2016 errore del compilatore|C richiede che uno struct o unione includa almeno un membro|
...
|C2023 errore del compilatore|'*identifier*': allineamento (*number1*) diverso dalla dichiarazione precedente (*numero2*)|
|C2024 errore del compilatore|attributo 'alignas' si applica a variabili, membri dati e solo i tipi di tag|
...
|C2037 errore del compilatore|a sinistra di '*identifier*'specifica struct/union non definito'*tipo*'|
|C2038 errore del compilatore|spazio dei nomi std non può essere inline|
...
|C2049 errore del compilatore|«*identificatore*': Impossibile riaprire lo spazio dei nomi non inline come inline|
...
|C2068 errore del compilatore|utilizzo non valido di funzione in overload. Elenco di argomenti mancante?|
...
|C2076 errore del compilatore|un elenco di inizializzatori tra parentesi non può essere utilizzato in una nuova espressione il cui tipo contiene '*tipo*'|
...
|C2080 errore del compilatore|«*identifier*': il tipo per '*tipo*' può essere dedotto solo da una singola espressione dell'inizializzatore|
