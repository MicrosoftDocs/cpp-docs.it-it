---
title: Errori del compilatore da C2400 a C2499 | Microsoft Docs
ms.custom: ''
ms.date: 11/17/2017
ms.technology:
- cpp-diagnostics
...
|[Errore del compilatore C2401](compiler-error-c2401.md)|«*identifier*': registro deve essere base in '*contesto*»|
|[Errore del compilatore C2402](compiler-error-c2402.md)|«*identifier*': registro deve essere indice in '*contesto*»|
|[Errore del compilatore C2403](compiler-error-c2403.md)|«*identifier*': registro deve essere base/indice in '*contesto*»|
|[Errore del compilatore C2404](compiler-error-c2404.md)|«*identifier*': registro non valido in '*contesto*»|
|[Errore del compilatore C2405](compiler-error-c2405.md)|non valido riferimento short in avanti con offset|
|[Errore del compilatore C2406](compiler-error-c2406.md)|«*identifier*': nome non definito in '*contesto*»|
|[Errore del compilatore C2407](compiler-error-c2407.md)|registro 'float' non valido '*contesto*'|
|[Errore del compilatore C2408](compiler-error-c2408.md)|tipo non valido sull'operatore PTR in '*contesto*'|
|[Errore del compilatore C2409](compiler-error-c2409.md)|tipo non valido usato come operatore in '*contesto*'|
|[Errore del compilatore C2410](compiler-error-c2410.md)|«*identifier*': nome membro ambiguo in '*contesto*»|
|[Errore del compilatore C2411](compiler-error-c2411.md)|'*identifier*': membro di struct/union non valido in '*contesto*'|
...
|[Errore del compilatore C2420](compiler-error-c2420.md)|«*identifier*': simbolo non valido in *contesto*|
|[Errore del compilatore C2421](compiler-error-c2421.md)|Operatore PTR utilizzato con registro in '*contesto*'|
|[Errore del compilatore C2422](compiler-error-c2422.md)|override di segmento non valido in '*contesto*'|
|[Errore del compilatore C2423](compiler-error-c2423.md)|«*numero*': scala non valida|
...
|[Errore del compilatore C2429](compiler-error-c2429.md)|«*funzionalità del linguaggio*'richiede l'impostazione del flag del compilatore'*l'opzione del compilatore*»|
...
|[Errore del compilatore C2432](compiler-error-c2432.md)|riferimento non valido per i dati a 16 bit in '*contesto*'|
|[Errore del compilatore C2433](compiler-error-c2433.md)|«*identifier*': '*modificatore*' non è consentito nelle dichiarazioni di dati|
|[Errore del compilatore C2434](compiler-error-c2434.md)|'*simbolo*': un simbolo dichiarato con declspec (Process) non può essere inizializzato in modo dinamico in /clr: pure modalità|
...
|[Errore del compilatore C2436](compiler-error-c2436.md)|«*identificatore*': funzione membro o classe annidata nell'elenco di inizializzatori del costruttore|
|[Errore del compilatore C2437](compiler-error-c2437.md)|«*identificatore*': è già stato inizializzato|
|[Errore del compilatore C2438](compiler-error-c2438.md)|«*identificatore*': non è possibile inizializzare i dati di classe statica tramite il costruttore|
...
|[Errore del compilatore C2447](compiler-error-c2447.md)|' {': intestazione di funzione mancante (elenco formale di tipo obsoleto)?|
...
|[Errore del compilatore C2460](compiler-error-c2460.md)|«*identificatore_1*': Usa*identifier_2*', che viene definito|
...
|[Errore del compilatore C2486](compiler-error-c2486.md)|LOCAL_SIZE' consentito solo nella funzione con l'attributo 'naked'|
...
|[Errore del compilatore C2488](compiler-error-c2488.md)|«*identificatore*': 'naked' può essere applicato solo a definizioni di funzione non membro|
|[Errore del compilatore C2489](compiler-error-c2489.md)|«*identificatore*': variabile auto o register non consentita nell'ambito della funzione nella funzione 'naked' inizializzata|
|[Errore del compilatore C2490](compiler-error-c2490.md)|«*parola chiave*' non consentito nella funzione con attributo 'naked'|
|[Errore del compilatore C2491](compiler-error-c2491.md)|'*identifier*': definizione di dllimport *funzione* non consentito|
|[Errore del compilatore C2492](compiler-error-c2492.md)|«*variabile*': i dati con durata di archiviazione del thread potrebbero non avere un'interfaccia dll|
