...
|[Errore del compilatore C2443](compiler-error-c2443.md)|conflitto di dimensione operando|
...
|[Errore del compilatore C2449](compiler-error-c2449.md)|trovato ' {' in ambito file (intestazione di funzione mancante)?|
