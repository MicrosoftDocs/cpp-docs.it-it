...
## <a name="example-movable-deletes-implicit-copy"></a>Esempio: Copia implicita eliminazioni spostata
...
## <a name="example-variant-and-volatile-members"></a>Esempio: Membri di tipo varianti e volatili
