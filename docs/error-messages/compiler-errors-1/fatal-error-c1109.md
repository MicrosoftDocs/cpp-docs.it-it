...
Impossibile trovare 'entry point' nella DLL 'dll'  
 ...
 Un punto di ingresso in un [DLL a caricamento ritardato](../../build/reference/linker-support-for-delay-loaded-dlls.md) richiesto dal compilatore non è stato trovato.
