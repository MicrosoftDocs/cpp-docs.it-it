...
È anche possibile ottenere C2059 se si definisce una classe di modello di membro o una funzione all'esterno della classe. Per informazioni, vedere [articolo della Knowledge Base 241949](http://support.microsoft.com/kb/241949).
