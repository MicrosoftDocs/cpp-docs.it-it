---
title: Errore irreversibile C1077 | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
limite del compilatore: impossibile avere più di numero opzioni nella riga di comando  
 ...
 Potrebbero essere presenti troppi simboli definiti con [/D](../../build/reference/d-preprocessor-definitions.md). Inserire le definizioni in un file di intestazione.
