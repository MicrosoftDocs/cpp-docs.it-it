...
|[Errore del compilatore C2244](compiler-error-c2244.md)|'*identificatore*': Impossibile trovare la corrispondenza definizione di funzione e una dichiarazione esistente|
