...
|[Errore irreversibile C1001](../../error-messages/compiler-errors-1/fatal-error-c1001.md)|Errore interno del compilatore<br /><br /> (file del compilatore '*file*', riga *numero*)<br /><br /> Per evitare il problema, provare a semplificare o modificare le parti del programma indicate sopra. Per altre informazioni, scegliere Supporto tecnico dal menu ? di Visual C++ o aprire il file della Guida relativo al supporto tecnico|  
...
|[Errore irreversibile C1003](../../error-messages/compiler-errors-1/fatal-error-c1003.md)|conteggio degli errori supera *numero*; interruzione della compilazione|  
...
|Errore irreversibile C1451|Non è riuscito a generare informazioni di debug durante la compilazione del grafico chiamate per il Concurrency:: parallel_for_each in: '*callsite*'|  
