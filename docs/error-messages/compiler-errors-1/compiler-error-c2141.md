---
description: 'Altre informazioni su: errore del compilatore C2141'
...
ms.locfileid: "97270940"
---
# <a name="compiler-error-c2141"></a>Errore del compilatore C2141

overflow della dimensione della matrice

Una matrice supera il limite di 2 GB. Ridurre le dimensioni della matrice.

## <a name="example"></a>Esempio

L'esempio seguente genera l'C2141.
