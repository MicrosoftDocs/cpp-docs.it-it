...
Le implementazioni di funzioni in contosodata. cpp devono usare il nome completo, anche se si inserisce una direttiva **using** all'inizio del file:
...
## <a id="namespace_aliases"></a>Alias degli spazi dei nomi
