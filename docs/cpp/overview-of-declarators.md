...
```  
 ...
 potrebbe essere simile alla dichiarazione di un **int** puntatore e una funzione che restituisce `int*`, ma non ancora.  Ciò accade perché * fa parte del dichiaratore per `i`, ma non fa parte del dichiaratore per `f`.  
