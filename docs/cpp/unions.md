---
title: Le unioni | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
![Archiviazione dei dati in un'unione di tipo numerico](../cpp/media/vc38ul1.png "vc38UL1") archiviazione dei dati in unione NumericType
