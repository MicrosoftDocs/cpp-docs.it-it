---
title: 'Operatori puntatore a membro: .&gt;*'
ms.date: 11/04/2016
f1_keywords:
- .*
- ->*
...
ms.locfileid: "81320330"
---
# <a name="pointer-to-member-operators--and--gt"></a>Operatori puntatore a membro: .&gt;*
...
Gli operatori puntatore a membro, >\*.  Nella parte destra deve essere specificato un membro della classe.  Nell'esempio seguente viene illustrato come utilizzare tali operatori.
...
L'operatore binario -> è combinato il primo operando, che deve essere un puntatore a un oggetto di tipo classe, con il secondo operando, che deve essere un tipo puntatore a membro.
