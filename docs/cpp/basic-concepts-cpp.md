...
- [Regole di definizione e un collegamento di programma](../cpp/program-and-linkage-cpp.md)

- [Avvio e terminazione](../cpp/startup-and-termination-cpp.md)

- [Espressioni L-Value e r-value](../cpp/lvalues-and-rvalues-visual-cpp.md)

- [Oggetti temporanei](../cpp/temporary-objects.md)
