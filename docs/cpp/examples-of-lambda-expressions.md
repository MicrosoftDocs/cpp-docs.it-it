---
description: 'Altre informazioni su: esempi di espressioni lambda'
...
## <a name="higher-order-lambda-functions"></a><a name="higherOrderLambdaExpressions"></a> Funzioni lambda Higher-Order
