---
title: Convenzioni lessicali
description: Vengono descritti gli elementi C++ di base di programmi quali parole chiave, identificatori, valori letterali e set di caratteri.
...
- [Token e set di caratteri](../cpp/character-sets.md)
- [Commenti](../cpp/comments-cpp.md)
...
Per ulteriori informazioni sull'analisi C++ dei file di origine, vedere [fasi di conversione](../preprocessor/phases-of-translation.md).
