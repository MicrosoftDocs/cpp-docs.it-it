---
title: Funzioni con elenchi di argomenti variabiliC++()
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "80178444"
---
# <a name="functions-with-variable-argument-lists--c"></a>Funzioni con elenchi di argomenti variabiliC++()
