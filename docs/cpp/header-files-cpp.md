...
In genere, i file di intestazione sono un *includono guard* o una **#pragma una volta** direttiva per garantire che non vengono inseriti più volte in un file con estensione cpp singolo. 
...
spazio dei nomi N {classe my_class {public: void do_something();};
