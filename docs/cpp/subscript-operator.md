...
```  
 ...
 L'operatore di indice è commutativo. Di conseguenza, le espressioni *matrice*[*indice*] e *matrice*[*matrice*] sono garantite essere equivalenti fino a quando l'indice operatore non è sottoposto a overload (vedere [operatori di overload](../cpp/operator-overloading.md)). Il primo form è la procedura di codifica più comune, ma entrambi funzionano.  
