...
-   **operatore = (** `bSrc` **)** assegna un `bool` valore a un `_variant_t` oggetto.    
...
-   **operatore = (***decSrc***)** assegna un **decimale** valore a un `_variant_t` oggetto.      
  
-   **operatore = (** `bSrc` **)** assegna un **BYTE** valore a un `_variant_t` oggetto.    
