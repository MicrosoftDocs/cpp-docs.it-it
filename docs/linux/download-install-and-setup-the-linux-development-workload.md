...
- **Un compilatore** -Visual Studio 2019 include il supporto predefinito per GCC e [Clang](https://docs.microsoft.com/en-us/cpp/build/clang-support-cmake?view=vs-2019). 
