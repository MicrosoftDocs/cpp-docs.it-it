---
title: Aggiunta guidata classe da controllo ActiveX
ms.date: 11/04/2016
f1_keywords:
...
[Aggiunta di una classe da un controllo ActiveX](../ide/adding-a-class-from-an-activex-control-visual-cpp.md)<br>
