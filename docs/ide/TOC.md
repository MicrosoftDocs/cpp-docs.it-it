...
#### [Procedura guidata personalizzata](custom-wizard.md)
##### [Impostazioni applicazione, procedura guidata personalizzata](application-settings-custom-wizard.md)
### [Progettazione di una procedura guidata](designing-a-wizard.md)
#### [Passaggi per la progettazione di una procedura guidata](steps-to-designing-a-wizard.md)
...
###### [Direttive dei modelli](template-directives.md)
...
##### [Gestione degli errori nei file HTML della procedura guidata](error-handling-in-wizard-html-files.md)
##### [Gestione degli errori nei file JScript della procedura guidata](error-handling-in-wizard-jscript-files.md)
...
## [Working with Project Properties](working-with-project-properties.md) (Utilizzo di Proprietà del progetto)
...
##### [Generale, Strumento Manifesto, Proprietà di configurazione, Finestra di dialogo Pagine delle proprietà di <Projectname>](general-manifest-tool-configuration-properties.md)
##### [Input e output, Strumento Manifesto, Proprietà di configurazione, finestra di dialogo Pagine delle proprietà di <Projectname>](input-and-output-manifest-tool.md)
...
##### [Avanzate, Strumento Manifesto, Proprietà di configurazione, finestra di dialogo Pagine delle proprietà di <Projectname>](advanced-manifest-tool.md)
