---
title: Implementazione di un'interfaccia (Visual C++)
ms.date: 11/04/2016
helpviewer_keywords:
...
1. Fare clic su **Aggiungi** dal menu di scelta rapida e quindi fare clic su **Implementa interfaccia** per visualizzare l'[Implementazione guidata interfaccia](../ide/implement-interface-wizard.md).

1. Selezionare le interfacce da implementare dalle librerie di tipi appropriate e fare clic su **Fine**.

1. In Visualizzazione classi espandere il nodo relativo a basi e interfacce dell'oggetto per visualizzare l'interfaccia implementata e quindi espandere il nodo dell'interfaccia per visualizzarne le proprietà, i metodi e gli eventi disponibili.
