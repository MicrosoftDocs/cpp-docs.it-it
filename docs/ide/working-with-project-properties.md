...
- Creare un file con estensione props che specifica le proprietà da ignorare. 
- Al prompt dei comandi: impostare ForceImportBeforeCppTargets="C:\sources\my_props.props"
...
## <a name="see-also"></a>Vedere anche  
 [Creazione e gestione di progetti Visual C++](../ide/creating-and-managing-visual-cpp-projects.md) [Struttura di file con estensione vcxproj e props](vcxproj-file-structure.md) [File XML delle pagine delle proprietà](property-page-xml-files.md)