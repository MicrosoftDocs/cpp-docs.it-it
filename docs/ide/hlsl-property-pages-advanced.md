 ...
 **Sì (o nologo)** per visualizzare il messaggio banner e informazioni di avvio; in caso contrario, **n**. Per impostazione predefinita, il valore è **Sì (o nologo)**.  
  
 **Considera gli avvisi come errori**  
 **Sì (/WX)** da considerare tutti gli avvisi come errori; in caso contrario, **n**.  
