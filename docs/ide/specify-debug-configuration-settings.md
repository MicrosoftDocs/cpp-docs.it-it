---
title: Nuovo progetto da codice esistente - Impostazioni di debug (Visual C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-ide
...
Usare questa pagina della procedura guidata Creazione guidata nuovo progetto da file di codice esistenti per specificare impostazioni di progetto per la configurazione di debug.  
 ...
 **Riga di comando di compilazione**  
 Specifica la riga di comando che esegue la compilazione del nuovo progetto. Ad esempio immettere il nome del compilatore (e le eventuali opzioni e argomenti) o gli script di compilazione da usare per compilare il nuovo progetto. Questa opzione è abilitata quando l'opzione **Utilizza sistema di compilazione esterno** è selezionata nella pagina **Specifica le impostazioni del progetto**. Negli altri casi non è disponibile.  
  
 **Riga di comando per Ricompila**  
 Specifica la riga di comando che consente di ricompilare il nuovo progetto. Questa opzione è abilitata quando l'opzione **Utilizza sistema di compilazione esterno** è selezionata nella pagina **Specifica le impostazioni del progetto**. Negli altri casi non è disponibile.  
  
 **Riga di comando per Pulisci**  
 Specifica la riga di comando che elimina i file di supporto generati dagli strumenti di compilazione per il nuovo progetto. Questa opzione è abilitata quando l'opzione **Utilizza sistema di compilazione esterno** è selezionata nella pagina **Specifica le impostazioni del progetto**. Negli altri casi non è disponibile.  
  
 **Output (per il debug)**  
 Specifica il percorso della directory dei file di output per la configurazione di debug del nuovo progetto. Questa opzione è abilitata quando l'opzione **Utilizza sistema di compilazione esterno** è selezionata nella pagina **Specifica le impostazioni del progetto**. Negli altri casi non è disponibile.  
