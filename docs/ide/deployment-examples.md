...
## <a name="examples"></a>Esempi  
 ...
 [Procedura dettagliata: distribuzione di un'applicazione Visual C++ a una cartella locale di un'applicazione](../ide/walkthrough-deploying-a-visual-cpp-application-to-an-application-local-folder.md)  
  
 [Procedura dettagliata: distribuzione di un'applicazione Visual C++ tramite Visual C++ Redistributable Package](../ide/deploying-visual-cpp-application-by-using-the-vcpp-redistributable-package.md)  
  
 [Preparazione di un computer di test per l'esecuzione di un file eseguibile di debug](../ide/preparing-a-test-machine-to-run-a-debug-executable.md)  
