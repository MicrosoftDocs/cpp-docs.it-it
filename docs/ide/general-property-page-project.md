 ...
 **Supporto App di Windows Store**  
 Specifica se il progetto supporta le applicazioni Windows Store. Per ulteriori informazioni, vedere [/ZW (compilazione di Windows Runtime)](../build/reference/zw-windows-runtime-compilation.md)e il centro per sviluppatori Windows.  
