---
title: Tabella di conformità della libreria standard e del linguaggio Microsoft C++
...
| &nbsp;&nbsp;[`P0355R7 <chrono> Calendars And Time Zones`](https://wg21.link/p0355r7) | Parziale in VS 2019 16,9 <sup> [20](#note_20)</sup> |
...
| &nbsp;&nbsp;[`P1502R1 Standard Library Header Units`](https://wg21.link/P1502R1) | Parziale in VS 2019 16,9 <sup> [20](#note_20)</sup> |
...
__VS 2019 16,9__ indica le funzionalità supportate in Visual Studio 2019 versione 16,9.
...
<a name="note_D"></a>__D__ supportato [`/std:c++14`](../build/reference/std-specify-language-standard-version.md) con con un avviso suppressible, [`C4984`](../error-messages/compiler-warnings/compiler-warning-c4984.md) .
...
<a name="note_DR"></a>__Ripristino__ di emergenza Queste funzionalità sono abilitate in tutte le [`/std`](../build/reference/std-specify-language-standard-version.md) modalità delle opzioni del compilatore. Il Comitato standard C++ ha adottato questa modifica come report di difetti retroattivi per C++ 11 e tutte le versioni successive.
