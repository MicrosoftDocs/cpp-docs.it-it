...
![Usare vcremote per generare un PIN sicuro](../cross-platform/media/cppmdd-vcremote-generateclientcert.png "Uso di vcremote per la generazione di un PIN sicuro")
...
1. Scegliere **Associa** per abilitare l'associazione.
   ...
   ![Configurare la connessione vcremote per le compilazioni iOS](../cross-platform/media/cppmdd-options-ios.png "Configurazione della connessione vcremote per compilazioni iOS")
