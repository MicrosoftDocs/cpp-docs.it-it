---
title: Allineamento al centro dei controlli in una finestra di dialogo (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "46391293"
---
# <a name="centering-controls-in-a-dialog-box-c"></a>Allineamento al centro dei controlli in una finestra di dialogo (C++)
...
2. Dal **formato** menu, scegliere **Centra nella finestra**, quindi scegliere una delle modalità seguenti:
   ...
   - `Horizontal`: Centra orizzontalmente i controlli nella finestra di dialogo.
