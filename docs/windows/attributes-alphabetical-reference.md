...
|[db_param](../windows/db-param.md)|Associa un parametro di input o output la variabile membro specificato.|  
...
|[helpstring](../windows/helpstring.md)|Specifica l'ID di un argomento della Guida in un file hlp o chm.|  
