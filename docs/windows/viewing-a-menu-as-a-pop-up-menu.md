---
title: Visualizzazione di un Menu come Menu a comparsa (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1. Il menu di scelta rapida e scegliere **Visualizza come Popup** dal menu di scelta rapida.
