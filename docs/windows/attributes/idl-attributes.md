...
|[maiuscole e minuscole](case-cpp.md)|Utilizzato con il [switch_type](switch-type.md) attributo in un'unione.|
...
|[importazione](import.md)|Specifica un altro file con estensione idl o ODL intestazione che contiene le definizioni che si desidera fare riferimento dal file con estensione idl principale.|
...
|[origine](source-cpp.md)|Indica che un membro di una classe, proprietà o metodo è un'origine di eventi.|
