---
title: attributo (attributo COM C++) | Microsoft Docs
ms.custom: ''
ms.date: 10/03/2018
ms.technology:
- cpp-windows
...
> [!NOTE]
> Il **attributo** attributo è deprecato.  Usare l'attributo di runtime del linguaggio comune `System.Attribute` a direttamente a creare attirbutes definite dall'utente. Per altre informazioni, vedere [User-Defined Attributes](../user-defined-attributes-cpp-component-extensions.md).

Si definisce una [attributi personalizzati](custom-attributes-cpp.md) inserendo il **attributo** attributo in una definizione di classe o struct gestita. Il nome della classe è l'attributo personalizzato. Ad esempio:
...
Per un elenco dei tipi di parametro possibili dell'attributo, vedere [Custom Attributes](custom-attributes-cpp.md).

Visualizzare [User-Defined Attributes](../user-defined-attributes-cpp-component-extensions.md) per una discussione sulle destinazioni degli attributi.
