---
description: 'Altre informazioni su: aggregabile'
...
- `allowed` L'oggetto COM può essere creato direttamente oppure può essere aggregato. Questo è il valore predefinito.
