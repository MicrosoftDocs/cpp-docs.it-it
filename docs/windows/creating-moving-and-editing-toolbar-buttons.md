---
title: Creazione, lo spostamento e modifica dei pulsanti della barra degli strumenti | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
-   [Creare un nuovo pulsante della barra degli strumenti](creating-a-new-toolbar-button.md)  
  
-   [Spostare un pulsante della barra degli strumenti](moving-a-toolbar-button.md)  
  
-   [Pulsanti di copia da una risorsa barra degli strumenti](../windows/copying-buttons-from-a-toolbar.md)  
...
-   [Rimozione di uno spazio tra i pulsanti di una barra degli strumenti](../windows/removing-space-between-buttons-on-a-toolbar.md)  
