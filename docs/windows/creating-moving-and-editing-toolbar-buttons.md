...
-   [Eliminare un pulsante della barra degli strumenti](deleting-a-toolbar-button.md)  
...
-   [Modificare la pagina delle proprietà di una barra degli strumenti](../windows/changing-the-properties-of-a-toolbar-button.md)  
