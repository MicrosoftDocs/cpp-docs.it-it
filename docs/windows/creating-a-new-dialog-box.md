...
1. In [visualizzazione di risorse](/windows/how-to-create-a-resource-script-file#create-resources), fare doppio clic sui *RC* del file e selezionare **Aggiungi risorsa**.
