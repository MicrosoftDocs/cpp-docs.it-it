---
title: Aggiunta di controlli a una finestra di dialogo fa sì che la finestra di dialogo funzionamento non corretto (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
