---
title: Membro dati SyncLockWithStatusT::status_ | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="remarks"></a>Note  
 Contiene il risultato dell'oggetto sottostante attendere l'operazione dopo un'operazione di blocco su un oggetto basato sull'oggetto SyncLockWithStatusT corrente.  
