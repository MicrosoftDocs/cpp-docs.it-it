---
title: Predefined tasti di scelta rapida (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "46430605"
---
# <a name="predefined-accelerator-keys-c"></a>Tasti di scelta rapida predefiniti (C++)
