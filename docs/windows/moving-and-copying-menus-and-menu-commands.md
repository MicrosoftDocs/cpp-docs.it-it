...
### Per spostare o copiare menu o comandi di menu usando il metodo di trascinamento e rilascio  
...
### Per spostare o copiare menu o comandi di menu usando i comandi di menu di scelta rapida  
...
3.  Se si spostano gli elementi in un altro menu risorse o file script di risorsa [aprirli in un'altra finestra](../Topic/Customizing%20window%20layouts%20in%20Visual%20Studio.md).  
