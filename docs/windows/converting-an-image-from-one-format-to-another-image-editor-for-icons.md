...
2.  Dal **File** menu, scegliere **salvare *filename* come**.  
  
3.  Nel **Salva File con nome** della finestra di dialogo di **nome File** , digitare il nome del file e l'estensione che indica il formato desiderato.  
