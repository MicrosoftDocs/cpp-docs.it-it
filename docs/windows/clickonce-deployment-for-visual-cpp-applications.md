---
description: 'Altre informazioni su: distribuzione ClickOnce per applicazioni Visual C++'
...
L'ambiente di sviluppo Visual C++ non supporta direttamente la distribuzione dei progetti C++ di Visual Studio con ClickOnce, ma gli strumenti sono disponibili per l'uso.

> [!NOTE]
> Visual Studio non supporta ClickOnce negli ambienti di sviluppo Visual C# e Visual Basic. Se il progetto Visual Studio C++ è una dipendenza di un progetto Visual C#, è possibile pubblicare l'applicazione (incluse le relative dipendenze) usando la distribuzione ClickOnce dall'ambiente di sviluppo di Visual C#.
