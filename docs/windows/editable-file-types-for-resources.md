...
|EXE|File eseguibili.  Può essere modificato solo in Windows 2000 e sistemi operativi successivi.|  
|DLL|File DLL.  Può essere modificato solo in Windows 2000 e sistemi operativi successivi.|  
