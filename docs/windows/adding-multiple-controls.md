---
title: Aggiunta di più controlli | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2. Versione di **Ctrl** della chiave e fare clic su finestra di dialogo come tutte le volte che si desidera aggiungere un controllo particolare.

3. Premere **Esc** per arrestare l'inserimento di controlli.
