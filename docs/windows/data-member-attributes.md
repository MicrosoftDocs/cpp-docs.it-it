...
I seguenti attributi vengono applicati ai membri dati nella classe, in coclasse, o in un'interfaccia.  
  
|Attributo|Descrizione|  
|---------------|-----------------|  
|[db\_accessor](../windows/db-accessor.md)|gruppi **db\_column** attributi che partecipano a l  `IAccessor`associazione basata.|  
...
|[rdx](../windows/rdx.md)|Crea una chiave del Registro di sistema o modificare una chiave del Registro di sistema esistente.|  
