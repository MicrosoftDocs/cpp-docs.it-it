---
title: Attributi del membro dati | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33871705"
---
# <a name="data-member-attributes"></a>Attributi del membro dati
Gli attributi seguenti si applicano ai membri dati in una classe, una coclasse o interfaccia.  
  
|Attributo|Descrizione|  
|---------------|-----------------|  
|[db_accessor](../windows/db-accessor.md)|Gruppi **db_column** gli attributi che fanno parte di `IAccessor`-associazione di base.|  
