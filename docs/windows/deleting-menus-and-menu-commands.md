---
title: Eliminazione di menu e comandi di Menu (C++)
ms.date: 11/04/2016
helpviewer_keywords:
- menu items, deleting
...
ms.locfileid: "50476336"
---
# <a name="deleting-menus-and-menu-commands-c"></a>Eliminazione di menu e comandi di Menu (C++)
