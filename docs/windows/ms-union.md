...
Il **ms_union** attributi di C++ ha la stessa funzionalità come la [ms_union](http://msdn.microsoft.com/library/windows/desktop/aa367100) attributo MIDL.
