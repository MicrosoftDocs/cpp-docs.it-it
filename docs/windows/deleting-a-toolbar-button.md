---
title: Eliminazione di un pulsante della barra degli strumenti (C++) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "46397539"
---
# <a name="deleting-a-toolbar-button-c"></a>Eliminazione di un pulsante della barra degli strumenti (C++)
