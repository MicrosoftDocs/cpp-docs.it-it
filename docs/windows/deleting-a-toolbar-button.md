---
title: Eliminazione di un pulsante della barra degli strumenti | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="deleting-a-toolbar-button"></a>Eliminazione di un pulsante di una barra degli strumenti
### <a name="to-delete-a-toolbar-button"></a>Eliminazione di un pulsante della barra degli strumenti  
  
1.  Selezionare il pulsante della barra degli strumenti e trascinarla sulla barra degli strumenti.  
