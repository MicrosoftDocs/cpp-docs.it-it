...
### Per disporre i pulsanti di comando lungo il bordo destro o inferiore di una finestra di dialogo  
  
1.  Selezionare uno o più pulsanti di comando.  
  
2.  Scegliere **Disponi pulsanti** dal menu **Formato**, quindi scegliere una delle disposizioni riportate di seguito.  
    ...
    -   **In basso**: consente di allineare i pulsanti di comando lungo il bordo inferiore della finestra di dialogo.  
         ...
         Se si seleziona un controllo diverso da un pulsante di comando, la posizione di tale controllo non viene modificata.  
