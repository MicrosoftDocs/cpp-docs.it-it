---
title: Modifica delle proprietà di una stringa | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2.  Selezionare la stringa di cui si desidera modificare e fare doppio clic su di **ID**, **valore**, o **didascalia** colonna. Ora è possibile:  
  
    -   Selezionare un **ID** dal **ID elenco a discesa** elenco o digitare direttamente un ID.  
  
    -   Digitare un numero diverso di **valore** colonna.  
  
    -   Digitare modifiche nella **didascalia** colonna.  
