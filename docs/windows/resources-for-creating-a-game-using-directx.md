...
## <a name="resources"></a>Risorse  
 Visual C++ è incluso in tutte le edizioni di Visual Studio. Per informazioni su Visual Studio, vedere il [Visual Studio](http://www.visualstudio.com/) sito Web.  
  
 Per [!INCLUDE[win81](../misc/includes/win81_md.md)], DirectX è incluso in Windows SDK. Non è necessario scaricare altro materiale. Per ulteriori informazioni, vedere [in DirectX SDK?](http://msdn.microsoft.com/library/windows/desktop/ee663275.aspx).  
