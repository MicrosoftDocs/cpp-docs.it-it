...
Per Windows 8.1 e versioni successive, DirectX SDK è incluso in Windows SDK. Non è necessario scaricare altro materiale. Per ulteriori informazioni, vedere [in DirectX SDK?](http://msdn.microsoft.com/library/windows/desktop/ee663275.aspx).  
