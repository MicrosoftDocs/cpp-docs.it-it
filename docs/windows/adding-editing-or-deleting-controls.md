---
title: 'Procedura: Aggiungere, modificare o eliminare i controlli'
ms.date: 02/15/2019
f1_keywords:
...
ms.locfileid: "56336566"
---
# <a name="how-to-add-edit-or-delete-controls"></a>Procedura: Aggiungere, modificare o eliminare i controlli
...
Nella finestra di dialogo, selezionare il controllo, quindi premere il **eliminare** importanti o passare al **modificare** menu e selezionare **Elimina**.
...
1. Aprire una finestra di dialogo **dialogo** editor.

1. Fare doppio clic su un punto qualsiasi all'interno della finestra di dialogo e menu di scelta rapida, selezionare **Inserisci controllo ActiveX**.
