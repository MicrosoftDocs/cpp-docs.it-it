...
- Per aprire l' **editor binario** in un nuovo file, passare a **file** di menu **New** > nuovo **file** > , selezionare il tipo di file da modificare, quindi selezionare la freccia accanto al pulsante **Apri** e scegliere **Apri con** > **editor binario**.

- Per aprire l' **editor binario** in un file esistente, passare a **file** di menu > **aprire** > **file**, selezionare il file che si desidera modificare, quindi selezionare la freccia accanto al pulsante **Apri** e scegliere **Apri con** > **editor binario**.
...
1. Vai a menu **modifica** > [trova](/visualstudio/ide/reference/find-command).
...
1. Nella casella **direttive in fase di compilazione** Digitare un'istruzione `#include` che fornisca il nome del file che contiene la risorsa personalizzata, ad esempio:
