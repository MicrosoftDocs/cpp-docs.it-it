---
title: Modifica di un'immagine all'esterno di un progetto (Editor di immagini per le icone) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1. Dal **File** menu, fare clic su **Open**.

2. Nel **file di tipo** fare clic su **tutti i file**.
