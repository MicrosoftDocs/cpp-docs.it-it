---
title: Tasti di scelta rapida per l'Editor finestre (C++)
ms.date: 11/04/2016
f1_keywords:
- vc.editors.dialog
helpviewer_keywords:
...
ms.locfileid: "50483603"
---
# <a name="accelerator-keys-for-the-dialog-editor-c"></a>Tasti di scelta rapida per l'Editor finestre (C++)
