...
1.  Nella [finestra di dialogo Simboli risorsa](../windows/resource-symbols-dialog-box.md), selezionare il simbolo che si vuole eliminare e fare clic su **Elimina**.  
