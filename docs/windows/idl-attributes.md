---
title: Attributi IDL | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
Se non è stato usato con [attributi COM](../windows/com-attributes.md), attributi IDL consentono di definire le interfacce. Quando viene compilato il codice sorgente, gli attributi vengono usati per definire il file con estensione IDL generato. Se usato con gli attributi COM in un progetto ATL, alcuni IDL attributi, ad esempio `coclass`, che il codice venga inserito nel progetto.

Si noti che [idl_quote](../windows/idl-quote.md) consente di usare costrutti MIDL che non sono supportati nella versione corrente di Visual C++. Questo e altri attributi, ad esempio [importlib](../windows/importlib.md) e [includelib](../windows/includelib-cpp.md) sarà possibile utilizzare i file con estensione idl esistenti nel progetto Visual C++ corrente.
...
|[coclass](../windows/coclass.md)|Definizione in un file con estensione idl come (coclasse) della classe posizioni.|
...
[Limitazioni degli attributi](https://msdn.microsoft.com/6e6c4329-f667-4869-b991-cbe9cb7a8f61)