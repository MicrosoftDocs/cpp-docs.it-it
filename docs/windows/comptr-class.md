...
Nome                                                                                           | Descrizione
---------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------
[Operatore comptr:: &](#operator-ampersand)                                                       | Recupera l'indirizzo dell'oggetto corrente `ComPtr`.
...
## <a name="operator-ampersand"></a>Operatore comptr::&amp;
