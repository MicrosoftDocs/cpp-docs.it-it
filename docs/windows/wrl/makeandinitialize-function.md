...
Vedere [Procedura: Creare un'istanza direttamente componenti WRL](how-to-instantiate-wrl-components-directly.md) per informazioni sulle differenze tra questa funzione e [makeandinitialize](make-function.md)e per un esempio.
