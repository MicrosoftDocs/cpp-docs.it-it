...
### Per modificare le proprietà di un pulsante di una barra degli strumenti  
  
1.  Selezionare il pulsante della barra degli strumenti.  
  
2.  Digitare il nuovo ID nella proprietà **ID** nella [finestra Proprietà](../Topic/Properties%20Window.md) oppure utilizzare la casella di riepilogo a discesa per selezionare un nuovo **ID**.  
