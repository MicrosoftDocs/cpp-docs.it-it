---
title: Modifica delle proprietà di un pulsante della barra degli strumenti | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
---
# <a name="changing-the-properties-of-a-toolbar-button"></a>Modifica delle proprietà di un pulsante di una barra degli strumenti
...
2.  Digitare il nuovo ID nella **ID** proprietà il [finestra proprietà](/visualstudio/ide/reference/properties-window), oppure utilizzare l'elenco a discesa per selezionare un nuovo **ID**.  
