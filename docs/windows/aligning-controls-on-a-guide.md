---
title: Allineamento di controlli su una guida
ms.date: 11/04/2016
helpviewer_keywords:
- DLUs (dialog units)
- controls [C++], aligning
...
[Stati dell'editor finestre (guide e griglie)](../windows/dialog-editor-states-guides-and-grids.md)<br/>
