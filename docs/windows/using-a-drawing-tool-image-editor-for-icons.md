...
> [!TIP]
>  Le descrizioni comandi vengono visualizzate quando si passa il cursore sui pulsanti della [barra degli strumenti dell'editor di immagini](../windows/toolbar-image-editor-for-icons.md). Questi suggerimenti consentono di identificare i pulsanti specifici indicati qui.
...
1. Se necessario, selezionare colori e un pennello:
   ...
   - Nel [selettore di opzioni](../windows/toolbar-image-editor-for-icons.md)selezionare una forma che rappresenta il pennello che si desidera utilizzare.
...
1. Utilizzare la [barra degli strumenti Editor di immagini](../windows/toolbar-image-editor-for-icons.md) o passare a **immagine** menu> **strumenti** e scegliere lo strumento **linea** .
...
1. Usare la barra degli strumenti dell' **editor di immagini** o passare a **immagine** del menu > **strumenti** e selezionare uno strumento di **disegno di figure chiuse** .
...
1. Tenere premuto il tasto **MAIUSC** , scegliere nella selezione e trascinarlo nell'immagine oppure passare a **immagine** del menu > **Usa selezione come pennello**.
...
Premere il tasto **segno più** ( **+** ) per raddoppiare le dimensioni del pennello oppure il **segno meno** ( **-** ) per dimezzarlo.
