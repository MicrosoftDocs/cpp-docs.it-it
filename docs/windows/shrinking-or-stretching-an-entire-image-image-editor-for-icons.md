---
title: Riduzione o allungamento di un'intera immagine (Editor di immagini per le icone) | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1.  Selezionare l'intera immagine.  
     ...
     Se una parte dell'immagine è attualmente selezionata e si desidera selezionare l'intera immagine, fare clic sull'immagine all'esterno del bordo di selezione corrente.  
  
2.  Tenere premuto il **MAIUSC** chiave e trascinare un quadratino di ridimensionamento fino a ottenere le dimensioni desiderate per l'immagine.  
