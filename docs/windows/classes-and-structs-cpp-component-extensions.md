...
Visualizzare [le classi e struct](../cppcx/ref-classes-and-structs-c-cx.md) e [classi e struct di valore](http://msdn.microsoft.com/library/windows/apps/hh699861.aspx).
