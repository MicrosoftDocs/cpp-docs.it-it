...
2.  Se l'errore si ripete, salvare il lavoro e riavviare [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
  
3.  Se l'errore persiste, reinstallare [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)].  
