...
Per caricare e scaricare file con [My.Computer.Network Object](../Topic/My.Computer.Network%20Object.md), è necessario specificare un oggetto `connectionTimeout` maggiore di `0`.  
