...
Il contenuto di questo argomento è stato rimosso. Per informazioni su come creare una finestra degli strumenti, vedere [Aggiunta di una finestra degli strumenti](../Topic/Adding%20a%20Tool%20Window.md). Per informazioni su come dare visibilità dinamica a un comando di menu, vedere [Aggiunta dinamica di voci di Menu](../Topic/Dynamically%20Adding%20Menu%20Items.md).