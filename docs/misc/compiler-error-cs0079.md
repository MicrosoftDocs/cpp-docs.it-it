...
L'evento 'event' può essere usato solo sul lato sinistro di \+\= o \-\=  
 ...
 Un [evento](../Topic/event%20\(C%23%20Reference\).md) è stato chiamato in modo non corretto. Per altre informazioni, vedere [Eventi](../Topic/Events%20\(C%23%20Programming%20Guide\).md) e [Delegati](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md).  
