...
---
# piecewise_linear_distribution::intervals
Restituisce gli intervalli archiviati per la distribuzione.  
...
## Note  
 La funzione membro restituisce i valori di intervallo archiviati.  
...
## Vedere anche  
 ...
 [Classe piecewise\_linear\_distribution](../standard-library/piecewise-linear-distribution-class.md)