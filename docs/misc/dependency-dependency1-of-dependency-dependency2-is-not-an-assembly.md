...
-   Reinstallare [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] \(se l'assembly è stato fornito con [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] o .NET Framework\).  
