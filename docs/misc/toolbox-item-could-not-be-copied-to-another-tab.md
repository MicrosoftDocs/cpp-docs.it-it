...
Generalmente questo errore si verifica quando l'elemento è danneggiato oppure la memoria è insufficiente.  
  
### Per correggere l'errore  
  
1.  Chiudere le altre applicazioni aperte, quindi tentare nuovamente di spostare l'elemento.  
  
     \-oppure\-  
  
2.  Selezionare un diverso elemento da spostare.  
