...
La tabella codici predefinita non è valida  
 ...
 La tabella codici specificata dalla variabile di ambiente **RCCODEPAGE** non è valida. Per altre informazioni, vedere [Tabelle codici](../c-runtime-library/code-pages.md) in *Riferimenti alla libreria di runtime*.