...
---
# exponential_distribution::lambda
Restituisce il parametro di distribuzione Lambda.  
...
## Note  
 La funzione membro restituisce il valore `lambda` archiviato.  
...
## Vedere anche  
 ...
 [Classe exponential\_distribution](../standard-library/exponential-distribution-class.md)