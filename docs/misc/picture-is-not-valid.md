...
1.  Verificare che il file che si sta tentando di caricare nella proprietà `Picture` sia un file di grafica valido supportato da [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)].  
