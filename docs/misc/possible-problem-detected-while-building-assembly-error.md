...
Lo strumento ALink, chiamato dal compilatore [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)], segnala un errore durante la compilazione dell'assembly. Una possibile causa è un assembly firmato che fa riferimento a un assembly non firmato.  
