...
Questo errore in genere è dovuto a un file danneggiato. Potrebbe essere necessario reinstallare [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
  
### Per correggere l'errore  
  
-   Reinstallare [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
