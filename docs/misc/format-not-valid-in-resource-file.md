...
Un file di risorse nel progetto non segue il formato standard per un file di risorse di Windows oppure il file di risorse e il progetto [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] non corrispondono.  
