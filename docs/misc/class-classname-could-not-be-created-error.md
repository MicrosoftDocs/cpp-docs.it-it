...
Si è verificato un errore nell'inizializzazione di una classe. L'installazione di [!INCLUDE[dnprdnshort](../error-messages/tool-errors/includes/dnprdnshort_md.md)] potrebbe essere danneggiata.  
...
2.  Reinstallare [!INCLUDE[dnprdnshort](../error-messages/tool-errors/includes/dnprdnshort_md.md)] e ricompilare il programma.  
