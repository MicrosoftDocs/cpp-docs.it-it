 ...
 **Estensione nome del file**  
 Definire l'estensione di file associata con l'editor. È possibile specificare più estensioni digitando un elenco delimitato da virgole. L'editor sarà l'editor [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] predefinito per i file con l'estensione di file definita.  
