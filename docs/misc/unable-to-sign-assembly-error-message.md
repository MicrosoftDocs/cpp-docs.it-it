...
Il compilatore [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] chiama Assembly Linker \(Al.exe, definito anche Alink\) per generare un assembly con un manifesto. Il linker ha rilevato un errore durante la firma dell'assembly dopo la creazione. Forse la chiave non è valida.  
