...
Sono state specificate opzioni in conflitto: file di risorse Win32; icona Win32  
 ...
 Non è consentito specificare le opzioni del compilatore [\/win32res](../Topic/-win32res%20\(C%23%20Compiler%20Options\).md) e [\/win32ico](../Topic/-win32icon%20\(C%23%20Compiler%20Options\).md) nella stessa compilazione.