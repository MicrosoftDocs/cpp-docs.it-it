---
title: "Regole e limitazioni per TLS | Microsoft Docs"
ms.custom: ""
ms.date: "11/16/2016"
...
Questo contenuto è stato spostato in [Archiviazione locale di thread \(TLS\)](../parallel/thread-local-storage-tls.md).