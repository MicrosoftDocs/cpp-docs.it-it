...
## Note  
 È possibile aggiornare il file di database mediante [!INCLUDE[vs_orcas_long](../atl/reference/includes/vs_orcas_long_md.md)] o l'API `System.Data.SqlServerCe.SqlCeEngine.Upgrade`.  
