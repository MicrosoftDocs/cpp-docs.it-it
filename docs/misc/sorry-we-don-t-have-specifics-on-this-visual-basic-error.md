...
Siamo spiacenti, ma non abbiamo informazioni specifiche sull'errore.  È possibile cercare il numero dell'errore e il testo del messaggio per trovare informazioni sul Web.  In alternativa, è possibile chiedere ad altri sviluppatori che usano uno di questi forum:  
 ...
 [Linguaggio Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145963)  
 Forum dedicato a domande e discussioni di carattere generale relative al linguaggio e alla sintassi di [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)].  
  
 [Interoperabilità e aggiornamento di Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145966)  
 Forum dedicato a domande e problemi relativi all'aggiornamento di [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] e all'uso delle funzionalità di interoperabilità.  
  
 [IDE di Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145971)  
 Forum dedicato a domande relative all'uso dell'ambiente [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
  
 [Forum generale su Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145973)  
 Forum dedicato a domande e problemi relativi a [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] non trattati in altri forum.  
  
 [StackOverflow](http://stackoverflow.com/questions/tagged/vb.net)  
 Forum dedicato a domande e problemi relativi a [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)].  
