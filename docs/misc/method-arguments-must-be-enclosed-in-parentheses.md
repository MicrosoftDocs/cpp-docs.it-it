...
Nelle versioni più recenti di [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] le regole relative alle chiamate di routine sono più semplici. Tutti gli argomenti devono essere racchiusi tra parentesi.  
