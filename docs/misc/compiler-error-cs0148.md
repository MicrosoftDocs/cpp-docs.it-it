...
Il delegato 'delegato' non presenta un costruttore valido  
 ...
 È stato importato e usato un programma \(che usa Common Language Runtime di .NET Framework\) creato con un altro compilatore. Il compilatore ha consentito un costruttore [delegate](../Topic/delegate%20\(C%23%20Reference\).md) il cui formato non è corretto. Per altre informazioni, vedere [Delegati](../Topic/Delegates%20\(C%23%20Programming%20Guide\).md).