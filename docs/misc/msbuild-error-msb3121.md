...
**MSB3121: nell'elemento dell'associazione di file incluso nel manifesto dell'applicazione manca uno o più dei seguenti attributi richiesti: estensione, descrizione, ProgId o icona predefinita.**  
 ...
 L'[ClickOnce Deployment Manifest](../Topic/ClickOnce%20Deployment%20Manifest.md) deve contenere i valori per i quattro gli attributi.  
  
### Per correggere l'errore  
  
-   Impostare ogni attributo [ClickOnce Deployment Manifest](../Topic/ClickOnce%20Deployment%20Manifest.md) su un valore valido.  
