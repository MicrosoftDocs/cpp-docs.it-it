...
---
# checked_uninitialized_copy
`checked_uninitialized_copy` è stato deprecato. Per informazioni sugli iteratori verificati, vedere [Iteratori verificati](../standard-library/checked-iterators.md).  
