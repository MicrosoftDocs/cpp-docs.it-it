...
## In questa sezione  
 ...
 Fornisce una panoramica del modo in cui un VSPackage può usare il modello di automazione di [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)] per gestire lo stato delle pagine **Opzioni del menu Strumenti**.  
