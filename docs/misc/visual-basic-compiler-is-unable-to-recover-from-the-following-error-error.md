...
Il compilatore [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] non è in grado di correggere il seguente errore: \<`error`\>.  
  
 Alcune funzionalità IDE sono state disabilitate.  
  
 Nel compilatore [!INCLUDE[vbprvb](../dotnet/includes/vbprvb_md.md)] si è verificato un errore interno.  
  
 **ID errore:** BC31021  
  
### Per correggere l'errore  
  
1.  Salvare il lavoro e riavviare [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
  
2.  Se l'errore si ripete, reinstallare [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)].  
