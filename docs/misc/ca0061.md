...
## Proprietà CodeAnalysisRules di MSBuild  
 In analisi codice [!INCLUDE[vsprvs](../assembler/masm/includes/vsprvs_md.md)], le regole possono essere specificate tramite la proprietà CodeAnalysisRules di MSBuild con il formato seguente:  
