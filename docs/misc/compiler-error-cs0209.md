...
Il tipo di variabile locale dichiarato in un'istruzione fixed deve essere un tipo di puntatore  
 ...
 La variabile dichiarata in un'[istruzione fixed](../Topic/fixed%20Statement%20\(C%23%20Reference\).md) deve essere un puntatore. Per altre informazioni, vedere [Codice unsafe e puntatori](../Topic/Unsafe%20Code%20and%20Pointers%20\(C%23%20Programming%20Guide\).md).  
