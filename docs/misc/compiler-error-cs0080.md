...
Vincoli non consentiti su dichiarazioni non generiche  
 ...
 La sintassi trovata può essere usata solo in una dichiarazione generica per assegnare vincoli al parametro di tipo. Per altre informazioni, vedere [Generics](../Topic/Generics%20\(C%23%20Programming%20Guide\).md).  
