...
L'etichetta 'label' è già presente in questa istruzione switch  
 ...
 In un'istruzione [switch](../Topic/switch%20\(C%23%20Reference\).md) è stata ripetuta un'etichetta. Per altre informazioni, vedere [switch](../Topic/switch%20\(C%23%20Reference\).md).  
