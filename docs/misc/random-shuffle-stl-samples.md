...
La funzione std::random\_shuffle\(\) è deprecata ed è stata sostituita da [std::shuffle\(\)](../Topic/std::shuffle.md). Per un esempio di codice e altre informazioni, vedere [\< random \>](../standard-library/random.md) e la registrazione di Stackoverflow [perché sono metodi std:: random\_shuffle deprecati in C\+\+ 14?](http://go.microsoft.com/fwlink/?LinkId=397954).  
