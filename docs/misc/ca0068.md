...
## Vedere anche  
 ...
 [Specifica di file di simboli \(con estensione pdb\) e di origine](../Topic/Specify%20Symbol%20\(.pdb\)%20and%20Source%20Files%20in%20the%20Visual%20Studio%20Debugger.md)   
