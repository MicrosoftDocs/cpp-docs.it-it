---
description: 'Altre informazioni su: classe CAtlFile'
...
Il costruttore di copia trasferisce la proprietà dell'handle di file dall' `CAtlFile` oggetto originale all'oggetto appena costruito.
