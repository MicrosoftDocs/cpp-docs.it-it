...
1. Nella finestra di dialogo [Aggiungi classe](../../ide/add-class-dialog-box.md), nel riquadro **Modelli**, fare clic su **Componente ATL COM+ 1.0** e quindi su **Apri** per visualizzare la [Creazione guidata componente ATL COM+ 1.0](../../atl/reference/atl-com-plus-1-0-component-wizard.md).
