...
Chiamare questo metodo per troncare un percorso di file per adattarlo a una larghezza di pixel specificata sostituendo i componenti del percorso con i puntini di sospensione.
