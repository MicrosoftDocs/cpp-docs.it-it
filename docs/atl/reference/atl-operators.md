...
##  <a name="a-nameoperatorlta--operator-"></a><a name="operator_lt"></a>(operatore)  
...
##  <a name="a-nameoperatorgta--operator-"></a><a name="operator_gt"></a>operatore >  
...
##  <a name="a-nameoperatorlteqa--operator-"></a><a name="operator_lt__eq"></a>(operatore)<=></=>  
...
##  <a name="a-nameoperatorgteqa--operator-"></a><a name="operator_gt__eq"></a>operatore > =  
