...
## <a name="aggregation-and-class-factory-macrosaggregation-and-class-factory-macrosmd"></a>[Aggregazione e macro di Class Factory](aggregation-and-class-factory-macros.md)
## <a name="category-macroscategory-macrosmd"></a>[Macro di categoria](category-macros.md)
## <a name="com-map-macroscom-map-macrosmd"></a>[Macro della mappa COM](com-map-macros.md)
## <a name="compiler-options-macroscompiler-options-macrosmd"></a>[Macro di opzioni del compilatore](compiler-options-macros.md)
## <a name="composite-control-macroscomposite-control-macrosmd"></a>[Macro di controllo composito](composite-control-macros.md)
## <a name="connection-point-macrosconnection-point-macrosmd"></a>[Macro di punto di connessione](connection-point-macros.md)
## <a name="debugging-and-error-reporting-macrosdebugging-and-error-reporting-macrosmd"></a>[Macro di debug e la segnalazione errori](debugging-and-error-reporting-macros.md)
...
## <a name="object-map-macrosobject-map-macrosmd"></a>[Macro di mapping degli oggetti](object-map-macros.md)
## <a name="object-status-macrosobject-status-macrosmd"></a>[Oggetto stato macro](object-status-macros.md)
## <a name="property-map-macrosproperty-map-macrosmd"></a>[Macro di mapping di proprietà](property-map-macros.md)
## <a name="registry-data-exchange-macrosregistry-data-exchange-macrosmd"></a>[Macro per lo scambio dei dati del Registro di sistema](registry-data-exchange-macros.md)
## <a name="registry-macrosregistry-macrosmd"></a>[Macro del Registro di sistema](registry-macros.md)
## <a name="service-map-macrosservice-map-macrosmd"></a>[Macro della mappa del servizio](service-map-macros.md)
## <a name="snap-in-object-macrossnap-in-object-macrosmd"></a>[Oggetto macro snap-In](snap-in-object-macros.md)
## <a name="string-conversion-macrosstring-conversion-macrosmd"></a>[Macro di conversione di stringhe](string-conversion-macros.md)
## <a name="window-class-macroswindow-class-macrosmd"></a>[Macro di classe di finestra](window-class-macros.md)
## <a name="windows-messages-macroswindows-messages-macrosmd"></a>[Macro di messaggi di Windows](windows-messages-macros.md)
...
## <a name="catlmodule-classcatlmodule-classmd"></a>[Classe da CAtlModule](catlmodule-class.md)
...
## <a name="cautoptr-classcautoptr-classmd"></a>[Classe su CAutoPtr](cautoptr-class.md)
...
## <a name="ccomheapptr-classccomheapptr-classmd"></a>[Classe template CComHeapPtr](ccomheapptr-class.md)
## <a name="ccommodule-classccommodule-classmd"></a>[CComModule (classi)](ccommodule-class.md)
...
## <a name="csid-classcsid-classmd"></a>[IDSR (classe)](csid-class.md)
...
## <a name="iaxwinhostwindowlic-interfaceiaxwinhostwindowlic-interfacemd"></a>[IAxWinHostWindowLic (interfaccia)](iaxwinhostwindowlic-interface.md)
...
## <a name="atl-http-utility-functionsatl-http-utility-functionsmd"></a>[Funzioni di utilità HTTP di ATL](atl-http-utility-functions.md)
...
## <a name="com-map-global-functionscom-map-global-functionsmd"></a>[Funzioni globali della mappa COM](com-map-global-functions.md)
...
## <a name="debugging-and-error-reporting-global-functionsdebugging-and-error-reporting-global-functionsmd"></a>[Debug e funzioni globali di segnalazione](debugging-and-error-reporting-global-functions.md)
...
## <a name="pixel-himetric-conversion-global-functionspixel-himetric-conversion-global-functionsmd"></a>[Funzioni globali di conversione HIMETRIC pixel](pixel-himetric-conversion-global-functions.md)
## <a name="registry-and-typelib-global-functionsregistry-and-typelib-global-functionsmd"></a>[Funzioni globali del Registro di sistema e della libreria dei tipi](registry-and-typelib-global-functions.md)
## <a name="security-global-functionssecurity-global-functionsmd"></a>[Funzioni globali di protezione](security-global-functions.md)
...
## <a name="atlfuncinfo-structureatl-func-info-structuremd"></a>[Le strutture ATL_FUNC_INFO struttura](atl-func-info-structure.md)
...
# <a name="atl-archetypesatl-archetypesmd"></a>[ATL archetipi](atl-archetypes.md)
## <a name="worker-archetypeworker-archetypemd"></a>[Archetipo di lavoro](worker-archetype.md)
...
#### <a name="application-settings-atl-project-wizardapplication-settings-atl-project-wizardmd"></a>[Impostazioni dell'applicazione, creazione guidata progetto ATL](application-settings-atl-project-wizard.md)
### <a name="default-atl-project-configurationsdefault-atl-project-configurationsmd"></a>[Configurazioni predefinite progetto ATL](default-atl-project-configurations.md)
### <a name="mfc-support-in-atl-projectsmfc-support-in-atl-projectsmd"></a>[Supporto di MFC in ATL (progetti)](mfc-support-in-atl-projects.md)
### <a name="com-10-support-in-atl-projectscom-plus-1-0-support-in-atl-projectsmd"></a>[COM+ 1.0 supporta in ATL (progetti)](com-plus-1-0-support-in-atl-projects.md)
### <a name="adding-objects-and-controls-to-an-atl-projectadding-objects-and-controls-to-an-atl-projectmd"></a>[Aggiunta di controlli e oggetti a un progetto ATL](adding-objects-and-controls-to-an-atl-project.md)
...
### <a name="making-an-atl-object-noncreatablemaking-an-atl-object-noncreatablemd"></a>[Rendendo Noncreatable un oggetto ATL](making-an-atl-object-noncreatable.md)
...
### <a name="atl-dialog-wizardatl-dialog-wizardmd"></a>[Creazione guidata finestra ATL](atl-dialog-wizard.md)
...
## <a name="adding-an-atl-com-10-componentadding-an-atl-com-plus-1-0-componentmd"></a>[Aggiunta di un componente ATL COM+ 1.0](adding-an-atl-com-plus-1-0-component.md)
### <a name="atl-com-10-component-wizardatl-com-plus-1-0-component-wizardmd"></a>[Creazione guidata 1.0 componente ATL COM+](atl-com-plus-1-0-component-wizard.md)
