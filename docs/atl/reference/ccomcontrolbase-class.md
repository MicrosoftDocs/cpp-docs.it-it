...
### <a name="remarks"></a>Note  
 Se il controllo è a, finestre `~CComControlBase` lo elimina chiamando [DestroyWindow](https://msdn.microsoft.com/library/windows/desktop/ms632682).  
