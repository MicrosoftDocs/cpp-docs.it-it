...
*lpRect*<br/>
Punta a un `CRect` oggetto oppure [RECT](../../mfc/reference/rect-structure.md) struttura che riceverà le coordinate del client dell'aggiornamento che racchiude l'area di aggiornamento.
