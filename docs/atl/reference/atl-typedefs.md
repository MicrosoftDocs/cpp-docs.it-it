...
|[_ATL_WIN_MODULE](#_atl_win_module)|Definito come un typedef basato su [_ATL_WIN_MODULE70](../../atl/reference/atl-win-module70-structure.md)|  
...
> [!NOTE]
> `CComGlobalsThreadModel`classe di riferimento non [CComMultiThreadModelNoCS](../../atl/reference/ccommultithreadmodelnocs-class.md).  
...
> [!NOTE]
> `CComObjectThreadModel`classe di riferimento non [CComMultiThreadModelNoCS](../../atl/reference/ccommultithreadmodelnocs-class.md).  
...
### <a name="remarks"></a>Note  
 `CContainedWindow`è una specializzazione di [CContainedWindowT](../../atl/reference/ccontainedwindowt-class.md). Se si desidera modificare la classe base o tratti, utilizzare `CContainedWindowT` direttamente.  
