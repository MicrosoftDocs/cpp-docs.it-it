...
|[IPropertyPageImpl:: seobjects](#setobjects)|Fornisce una matrice di puntatori `IUnknown` per gli oggetti associati alla pagina delle proprietà. Questi oggetti ricevono i valori correnti della pagina delle proprietà tramite una chiamata a `Apply`.|
|[IPropertyPageImpl:: SetPageSite](#setpagesite)|Fornisce la pagina delle proprietà con un puntatore `IPropertyPageSite`, tramite il quale la pagina delle proprietà comunica con il frame della proprietà.|
...
|[IPropertyPageImpl:: m_pPageSite](#m_ppagesite)|Punta all'interfaccia `IPropertyPageSite` attraverso la quale la pagina delle proprietà comunica con il frame della proprietà.|
|[IPropertyPageImpl:: m_ppUnk](#m_ppunk)|Punta a una matrice di puntatori `IUnknown` agli oggetti associati alla pagina delle proprietà.|
...
##  <a name="deactivate"></a>IPropertyPageImpl::D ttiva
...
Punta a una matrice di puntatori `IUnknown` agli oggetti associati alla pagina delle proprietà.
...
##  <a name="setdirty"></a>IPropertyPageImpl:: IsDirty
...
##  <a name="setobjects"></a>IPropertyPageImpl:: seobjects

Fornisce una matrice di puntatori `IUnknown` per gli oggetti associati alla pagina delle proprietà.
