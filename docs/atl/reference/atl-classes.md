...
|[CAtlBaseModule](../../atl/reference/catlbasemodule-class.md)|Questa classe viene creata un'istanza in tutti i progetti ATL.|atlcore.h|
...
|[CComFakeCriticalSection](../../atl/reference/ccomfakecriticalsection-class.md)|Questa classe fornisce gli stessi metodi come [CComCriticalSection](../../atl/reference/ccomcriticalsection-class.md) ma non fornisce una sezione critica.|atlcore.h|
...
|[CCRTAllocator](../../atl/reference/ccrtallocator-class.md)|Questa classe fornisce metodi per la gestione della memoria mediante routine di memoria CRT.|atlcore.h|
|[CCRTHeap](../../atl/reference/ccrtheap-class.md)|Questa classe implementa [IAtlMemMgr](../../atl/reference/iatlmemmgr-class.md) usando le funzioni di heap CRT.|atlmem.h|
