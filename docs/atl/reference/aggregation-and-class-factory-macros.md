...
### <a name="remarks"></a>Note  
 [CComCoClass](../../atl/reference/ccomcoclass-class.md) questa macro viene utilizzata per dichiarare la factory di classe predefinito per l'oggetto.  
...
- [Macro DECLARE_CLASSFACTORY2](#declare_classfactory2) Usa [CComClassFactory2](../../atl/reference/ccomclassfactory2-class.md), che controlla la creazione tramite una licenza.  
...
- [DECLARE_CLASSFACTORY_SINGLETON](#declare_classfactory_singleton) Usa [CComClassFactorySingleton](../../atl/reference/ccomclassfactorysingleton-class.md), che costruisce una singola [CComObjectGlobal](../../atl/reference/ccomobjectglobal-class.md) oggetto.  
...
### <a name="remarks"></a>Note  
 `DECLARE_ONLY_AGGREGATABLE`viene generato un errore ( **E_FAIL**) se si è tentato di **CoCreate** l'oggetto come oggetto aggregata.  
