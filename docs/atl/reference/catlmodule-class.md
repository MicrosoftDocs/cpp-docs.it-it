...
### <a name="remarks"></a>Note  
 ...
 Visualizzare [IGlobalInterfaceTable](http://msdn.microsoft.com/library/windows/desktop/ms678517) per informazioni sulla tabella di interfaccia globale.  
