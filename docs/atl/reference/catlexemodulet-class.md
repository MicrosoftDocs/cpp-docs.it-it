...
## <a name="remarks"></a>Note  
 `CAtlExeModuleT` rappresenta il modulo per un'applicazione (EXE) e contiene codice che supporta la creazione di un file EXE, la riga di comando di elaborazione, registra gli oggetti di classe, che esegue il ciclo di messaggi e pulizia in uscita.  
