...
`CComMultiThreadModelNoCS`fornisce metodi di thread-safe per l'incremento e decremento il valore di una variabile, senza una sezione critica blocco o sblocco funzionalità.  
