...
*pUnkCP*<br/>
in Puntatore al `IUnknown` dell'oggetto al quale il client desidera connettersi.

*pUnk*<br/>
in Puntatore al `IUnknown`del client.
...
*pUnkCP*<br/>
in Puntatore al `IUnknown` dell'oggetto a cui è connesso il client.
