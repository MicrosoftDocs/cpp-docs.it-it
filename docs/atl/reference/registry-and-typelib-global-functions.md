...
|||
|-|-|
|[AfxRegCreateKey](#afxregcreatekey)|Crea la chiave del Registro di sistema.|
|[AfxRegDeleteKey](#afxregdeletekey)|Elimina la chiave del Registro di sistema.|
...
Questa funzione helper usata da [CAtlComModule::UnRegisterTypeLib](../../atl/reference/catlcommodule-class.md#unregistertypelib) e [AtlComModuleUnregisterServer](server-registration-global-functions.md#atlcommoduleunregisterserver).
