...
## <a name="remarks"></a>Note  
 `CComCoClass` fornisce metodi per il recupero CLSID di un oggetto, l'impostazione di informazioni sugli errori e la creazione di istanze della classe. Qualsiasi classe registrata nella mappa oggetto deve essere derivato da `CComCoClass`.  
