---
title: Strutture ATL | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="in-this-section"></a>In questa sezione  
 ...
 Contiene i dati di istanza di classe nel codice di windowing in ATL.  
 ...
 [STRUTTURE ATL_FUNC_INFO](../../atl/reference/atl-func-info-structure.md)  
...
## <a name="related-sections"></a>Sezioni correlate  
 [Riferimenti per ATL](../../atl/atl-com-desktop-components.md)  
