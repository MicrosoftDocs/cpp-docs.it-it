...
|[SINK_ENTRY_INFO](#sink_entry_info)|Voce alla mappa eventi sink con informazioni sul tipo manualmente fornito per l'utilizzo con [IDispEventSimpleImpl](../../atl/reference/idispeventsimpleimpl-class.md).|  
