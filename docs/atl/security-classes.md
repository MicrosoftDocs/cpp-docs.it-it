---
title: Classi di sicurezza (ATL) | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
ms.locfileid: "46086538"
---
# <a name="security-classes"></a>Classi di sicurezza

Queste classi sono wrapper per oggetti e classi di sicurezza Win32 comuni.
...
- [CPrivateObjectSecurityDesc](../atl/reference/cprivateobjectsecuritydesc-class.md) questa classe rappresenta un oggetto descrittore di sicurezza oggetto privato.
...
- [Ci CSecurityDesc](../atl/reference/csecuritydesc-class.md) questa classe è un wrapper per il `SECURITY_DESCRIPTOR` struttura.

- [IDSR](../atl/reference/csid-class.md) questa classe è un wrapper per un `SID` struttura (ID di sicurezza).
