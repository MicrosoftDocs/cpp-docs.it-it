---
title: Uso di IDispEventImpl (ATL)
ms.date: 11/04/2016
helpviewer_keywords:
...
L'esempio è tratto dal [esempio ATLEventHandling](../overview/visual-cpp-samples.md).
...
[Nell'esempio ATLEventHandling](../overview/visual-cpp-samples.md)
