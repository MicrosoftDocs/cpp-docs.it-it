---
title: Interfacce tear-Off di classi (ATL) | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-atl
...
---
# <a name="tear-off-interfaces-classes"></a>Classi di interfacce tear-Off
Le classi seguenti offrono il supporto per interfacce tear-off:  
