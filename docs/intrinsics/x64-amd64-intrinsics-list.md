...
La tabella seguente elenca le funzioni intrinseche disponibili per i processori x64. La colonna Tecnologia elenca il supporto del set di istruzioni richiesto. Utilizzare il [`__cpuid`](cpuid-cpuidex.md) intrinseco per determinare il supporto del set di istruzioni in fase di esecuzione. Se due voci si trovano in una sola riga, rappresentano i diversi punti di ingresso per lo stesso oggetto intrinseco. \[1] indica che la funzione intrinseca è disponibile solo per i processori AMD. \[2] indica che la funzione intrinseca è disponibile solo per i processori Intel. \[3] indica che il prototipo è una macro. L'intestazione richiesta per il prototipo di funzione è elencata nella colonna Intestazione. Per semplicità, l'intestazione intrin.h include immintrin.h e ammintrin.h.
...
| [`_xgetbv`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xgetbv) | PER XSAVE \[ 2] | immintrin.h | `unsigned __int64 _xgetbv(unsigned int);` |
| [`_xrstor`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor) | PER XSAVE \[ 2] | immintrin.h | `void _xrstor(void const*, unsigned __int64);` |
| [`_xrstor64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xrstor64) | PER XSAVE \[ 2] | immintrin.h | `void _xrstor64(void const*, unsigned __int64);` |
| [`_xsave`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave) | PER XSAVE \[ 2] | immintrin.h | `void _xsave(void*, unsigned __int64);` |
| [`_xsave64`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsave64) | PER XSAVE \[ 2] | immintrin.h | `void _xsave64(void*, unsigned __int64);` |
...
| [`_xsetbv`](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_xsetbv) | PER XSAVE \[ 2] | immintrin.h | `void _xsetbv(unsigned int, unsigned __int64);` |
