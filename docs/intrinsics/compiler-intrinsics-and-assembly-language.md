---
title: Intrinseci del compilatore e linguaggio dell'Assembly | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
|[Riferimento a Microsoft Macro Assembler](../assembler/masm/microsoft-macro-assembler-reference.md)|Viene fornito materiale di riferimento per l'assembler Macro Microsoft (masm).|  
|[Visual C++](../visual-cpp-in-visual-studio.md)|Articolo di livello superiore per la documentazione di Visual C++.|