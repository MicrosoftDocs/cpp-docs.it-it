...
ms.locfileid: "88610920"
---
# <a name="x86-intrinsics-list"></a>Elenco intrinseci x86

In questo documento sono elencati gli intrinseci supportati dal compilatore Microsoft C/C++ quando si specifica la destinazione x86.
