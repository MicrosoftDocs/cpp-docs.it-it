---
title: x86 elenco oggetti intrinseci
ms.date: 04/18/2019
helpviewer_keywords:
...
ms.locfileid: "59982395"
---
# <a name="x86-intrinsics-list"></a>x86 elenco oggetti intrinseci

Questo documento sono elencati gli intrinseci che di Microsoft C /C++ del compilatore supporta quando la destinazione è x86.
...
|[__addfsbyte](addfsbyte-addfsword-addfsdword.md)||intrin.h|__addfsbyte void (unsigned long senza segno char)|
|[__addfsdword](addfsbyte-addfsword-addfsdword.md)||intrin.h|__addfsdword void (long long senza segno, senza segno)|
|[__addfsword](addfsbyte-addfsword-addfsdword.md)||intrin.h|__addfsword void (unsigned long senza segno breve)|
|[_AddressOfReturnAddress](addressofreturnaddress.md)||intrin.h|void \* _AddressOfReturnAddress(void)|
|[_andn_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_andn_u32)|BMI [1]|ammintrin.h|unsigned int _andn_u32 (unsigned int, int senza segno)|
...
|[_InterlockedAddLargeStatistic](interlockedaddlargestatistic.md)||intrin.h|_InterlockedAddLargeStatistic lungo (\__int64 volatile \*, long)|
...
|[_InterlockedExchangePointer_HLERelease](interlockedexchangepointer-intrinsic-functions.md)|HLE [2]|immintrin.h|void \* interlockedexchangepointer_hlerelease (void \*volatile \*, void \*)|
...
|[_mm_monitor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_monitor)|SSE3|intrin.h|void _mm_monitor (const void *, unsigned int, int senza segno)|
...
|[__readfsdword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|__readfsdword(unsigned long) long senza segno|
|[__readfsword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|__readfsword(unsigned long) short senza segno|
...
|[__writedr](writedr.md)||intrin.h|__writedr void (senza segno, non firmato)|
|[__writeeflags](writeeflags.md)||intrin.h|void __writeeflags(unsigned)|
|[__writefsbyte](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|__writefsbyte void (unsigned long senza segno char)|
|[__writefsdword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|__writefsdword void (long long senza segno, senza segno)|
|[__writefsword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|__writefsword void (unsigned long senza segno breve)|
...
[x64 (amd64) le funzioni intrinseche](x64-amd64-intrinsics-list.md)
