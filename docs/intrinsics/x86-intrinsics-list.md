...
ms.locfileid: "74163504"
---
# <a name="x86-intrinsics-list"></a>Elenco intrinseci x86

In questo documento sono elencati gli intrinseci supportati daC++ Microsoft C/Compiler quando si specifica la destinazione x86.
...
## <a name="x86-intrinsics"></a>intrinseci x86
...
|[__readfsbyte](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|__readfsbyte char senza segno (Long senza segno)|
...
|[__writedr](writedr.md)||intrin.h|void __writedr (senza segno, senza segno)|
...
[oggetti intrinseci x64 (amd64)](x64-amd64-intrinsics-list.md)
