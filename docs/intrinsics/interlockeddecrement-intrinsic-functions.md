---
title: Funzioni intrinseche InterlockedDecrement | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
ms.locfileid: "45716261"
---
# <a name="interlockeddecrement-intrinsic-functions"></a>Funzioni intrinseche _InterlockedDecrement
**Sezione specifica Microsoft**  
  
Fornisce il supporto intrinseco del compilatore per il SDK di Windows Win32 [InterlockedDecrement](/windows/desktop/api/winbase/nf-winbase-interlockeddecrement) (funzione).  
...
*lpAddend*<br/>
[in, out] Puntatore alla variabile deve essere diminuito.  
