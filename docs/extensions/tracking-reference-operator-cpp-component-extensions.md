...
Un *riferimento di traccia* (`%`) si comporta come un normale riferimento C++ (`&`) ad eccezione del fatto che quando un oggetto viene assegnato a un riferimento di traccia, il conteggio dei riferimenti dell'oggetto viene incrementato.
