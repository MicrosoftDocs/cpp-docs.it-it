...
[Vincoli su parametri di tipo generico (C++/CLI)](constraints-on-generic-type-parameters-cpp-cli.md)<br/>
Informazioni sull'utilizzo di vincoli nei tipi generici.

[Uso dei generics (C++/CLI)](consuming-generics-cpp-cli.md)<br/>
