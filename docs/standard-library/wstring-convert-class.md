...
|*Stato*|Oggetto di tipo [state_type](#state_type) che rappresenta lo stato della conversione.|
|*Berr*|L'oggetto [byte_string](#byte_string) da visualizzare in caso di errori.|
