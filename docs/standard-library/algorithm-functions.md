...
La prima funzione modello restituisce [is_sorted_until](http://msdn.microsoft.com/bbad99d0-deaa-4fe6-ae58-eb5b3e4dded0)`( first, last ) == last`. Il `operator<` funzione esegue il confronto dell'ordine.
