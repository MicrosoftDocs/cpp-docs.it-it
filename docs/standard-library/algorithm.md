...
|[shuffle](../standard-library/algorithm-functions.md#std__shuffle)|Riproduce con sequenza casuale (ridispone) gli elementi di un intervallo specifico usando un generatore di numeri casuali.|  
