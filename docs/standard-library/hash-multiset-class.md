...
-   Una classe modello, poiché la funzionalità che fornisce è generica e indipendente dal tipo specifico di dati contenuti come elementi o chiavi. I tipi di dati da utilizzare per gli elementi e le chiavi vengono invece specificati come parametri nel modello di classe i insieme alla funzione di confronto e all'allocatore.  
 ...
 L'oggetto hash_multiset ordina la sequenza che controlla chiamando un oggetto di tratti hash archiviato di tipo [value_compare](#hash_multiset__value_compare). È possibile accedere a questo oggetto archiviato chiamando la funzione membro [key_comp](#hash_multiset__key_comp). Un oggetto funzione di questo tipo deve comportarsi come un oggetto della classe `hash_compare`*<Key,* **less***\<Key> >.* In particolare, per tutti i valori *Key* di tipo **Key**, la chiamata **Trait**( *Key*) genera una distribuzione di valori di tipo **size_t**.  
...
|||  
|-|-|  
|[hash_multiset](#hash_multiset__hash_multiset)|Costruisce un `hash_multiset` vuoto o che rappresenta una copia totale o parziale di un altro `hash_multiset`.|  
  
### <a name="typedefs"></a>Typedef  
  
|||  
|-|-|  
|[allocator_type](#hash_multiset__allocator_type)|Tipo che rappresenta la classe `allocator` per l'oggetto `hash_multiset`.|  
|[const_iterator](#hash_multiset__const_iterator)|Tipo che fornisce un iteratore bidirezionale in grado di leggere un elemento `const` nel `hash_multiset`.|  
|[const_pointer](#hash_multiset__const_pointer)|Tipo che fornisce un puntatore a un elemento `const` in un `hash_multiset`.|  
|[const_reference](#hash_multiset__const_reference)|Tipo che fornisce un riferimento a un elemento `const` archiviato in un `hash_multiset` per la lettura e l'esecuzione di operazioni `const`.|  
|[const_reverse_iterator](#hash_multiset__const_reverse_iterator)|Tipo che fornisce un iteratore bidirezionale in grado di leggere un elemento `const` nel `hash_multiset`.|  
|[difference_type](#hash_multiset__difference_type)|Tipo Signed Integer che specifica la differenza tra due iteratori che puntano a elementi all'interno dello stesso `hash_multiset`.|  
|[iterator](#hash_multiset__iterator)|Tipo che fornisce un iteratore bidirezionale in grado di leggere o modificare qualsiasi elemento di un `hash_multiset`.|  
|[key_compare](#hash_multiset__key_compare)|Tipo che fornisce un oggetto funzione in grado di confrontare due chiavi di ordinamento per determinare l'ordine relativo di due elementi nel `hash_multiset`.|  
|[key_type](#hash_multiset__key_type)|Tipo che descrive un oggetto archiviato come elemento di un `hash_set` grazie alla relativa funzione di chiave di ordinamento.|  
|[pointer](#hash_multiset__pointer)|Tipo che fornisce un puntatore a un elemento in un `hash_multiset`.|  
|[reference](#hash_multiset__reference)|Tipo che fornisce un riferimento a un elemento archiviato in un `hash_multiset`.|  
|[reverse_iterator](#hash_multiset__reverse_iterator)|Tipo che fornisce un iteratore bidirezionale in grado di leggere o modificare un elemento di un `hash_multiset` invertito.|  
|[size_type](#hash_multiset__size_type)|Tipo Unsigned Integer in grado di rappresentare il numero di elementi di un `hash_multiset`.|  
|[value_compare](#hash_multiset__value_compare)|Tipo che fornisce due oggetti funzione, un predicato binario della classe compare in grado di confrontare due valori di elemento di un `hash_multiset` per determinarne l'ordine relativo e un predicato unario che genera un hash per gli elementi.|  
|[value_type](#hash_multiset__value_type)|Tipo che descrive un oggetto archiviato come elemento di un `hash_multiset` grazie alla relativa funzione di un valore.|  
  
### <a name="member-functions"></a>Funzioni membro  
  
|||  
|-|-|  
|[begin](#hash_multiset__begin)|Restituisce un iteratore che punta al primo elemento in `hash_multiset`.|  
|[hash_multiset::cbegin](#hash_multiset__cbegin)|Restituisce un iteratore const che punta al primo elemento del `hash_multiset`.|  
|[hash_multiset::cend](#hash_multiset__cend)|Restituisce un iteratore const che punta alla posizione successiva all'ultimo elemento di un `hash_multiset`.|  
|[clear](#hash_multiset__clear)|Cancella tutti gli elementi di un `hash_multiset`.|  
|[count](#hash_multiset__count)|Restituisce il numero di elementi di un `hash_multiset` la cui chiave corrisponde a una chiave specificata dal parametro|  
|[hash_multiset::crbegin](#hash_multiset__crbegin)|Restituisce un iteratore const che punta al primo elemento di un `hash_multiset` invertito.|  
|[hash_multiset::crend](#hash_multiset__crend)|Restituisce un iteratore const che punta alla posizione successiva all'ultimo elemento di un set `hash_multiset` invertito.|  
|[hash_multiset::emplace](#hash_multiset__emplace)|Inserisce un elemento costruito sul posto in un `hash_multiset`.|  
|[hash_multiset::emplace_hint](#hash_multiset__emplace_hint)|Inserisce un elemento costruito sul posto in un `hash_multiset`, con un suggerimento sulla posizione.|  
|[empty](#hash_multiset__empty)|Verifica se un `hash_multiset` è vuoto.|  
|[end](#hash_multiset__end)|Restituisce un iteratore che punta alla posizione successiva all'ultimo elemento di un `hash_multiset`.|  
|[equal_range](#hash_multiset__equal_range)|Restituisce una coppia di iteratori rispettivamente al primo elemento di un `hash_multiset` con una chiave maggiore di una chiave specificata e al primo elemento di `hash_multiset` con una chiave uguale o maggiore di tale chiave.|  
|[erase](#hash_multiset__erase)|Rimuove un elemento o un intervallo di elementi di un `hash_multiset` dalle posizioni specificate oppure rimuove gli elementi che corrispondono a una chiave specificata.|  
|[find](#hash_multiset__find)|Restituisce un iteratore che punta alla posizione di un elemento in un `hash_multiset` che dispone di una chiave equivalente a una chiave specificata.|  
|[get_allocator](#hash_multiset__get_allocator)|Restituisce una copia dell'oggetto `allocator` utilizzato per costruire il `hash_multiset`.|  
|[insert](#hash_multiset__insert)|Inserisce un elemento o un intervallo di elementi in un `hash_multiset`.|  
|[key_comp](#hash_multiset__key_compare)|Recupera una copia dell'oggetto di confronto utilizzato per ordinare le chiavi di un `hash_multiset`.|  
|[lower_bound](#hash_multiset__lower_bound)|Restituisce un iteratore al primo elemento di un `hash_multiset` con una chiave uguale o maggiore di una chiave specificata.|  
|[max_size](#hash_multiset__max_size)|Restituisce la lunghezza massima del `hash_multiset`.|  
|[rbegin](#hash_multiset__rbegin)|Restituisce un iteratore che punta al primo elemento di un `hash_multiset` invertito.|  
|[rend](#hash_multiset__rend)|Restituisce un iteratore che punta alla posizione successiva all'ultimo elemento di un `hash_multiset` invertito.|  
|[size](#hash_multiset__size)|Restituisce il numero di elementi nel `hash_multiset`.|  
|[swap](#hash_multiset__swap)|Scambia gli elementi di due `hash_multiset`.|  
|[upper_bound](#hash_multiset__upper_bound)|Restituisce un iteratore al primo elemento di un `hash_multiset` con una chiave uguale o maggiore di una chiave specificata.|  
|[value_comp](#hash_multiset__value_comp)|Recupera una copia dell'oggetto dei tratti hash usato per generare un hash e ordinare i valori delle chiavi dell'elemento in un `hash_multiset`.|  
  
### <a name="operators"></a>Operatori  
  
|||  
|-|-|  
|[hash_multiset::operator=](#hash_multiset__operator_eq)|Sostituisce gli elementi dell'oggetto hash_multiset con una copia di un altro oggetto hash_multiset.|  
...
### <a name="example"></a>Esempio  
  Vedere l'esempio relativo a [get_allocator](#hash_multiset__get_allocator) per indicazioni su come usare `allocator_type`.  
...
### <a name="example"></a>Esempio  
  Vedere l'esempio relativo a [begin](#hash_multiset__begin) per indicazioni su come usare `const_iterator`.  
...
### <a name="remarks"></a>Note  
 ...
 Nella maggior parte dei casi, è consigliabile usare un [const_iterator](#hash_multiset__const_iterator) per accedere agli elementi di un oggetto **const** hash_multiset.  
...
### <a name="example"></a>Esempio  
  Vedere l'esempio relativo a [rend](#hash_multiset__rend) per indicazioni su come dichiarare e usare `const_reverse_iterator`.  
...
### <a name="remarks"></a>Note  
 `crbegin` viene usato con un oggetto `hash_multiset` invertito proprio come [hash_multiset::begin](#hash_multiset__begin) viene usato con un oggetto `hash_multiset`.  
...
### <a name="remarks"></a>Note  
 `crend` viene usato con un oggetto `hash_multiset` invertito proprio come [hash_multiset::end](#hash_multiset__end) viene usato con un oggetto `hash_multiset`.  
...
### <a name="return-value"></a>Valore restituito  
 La funzione membro [hash_multiset::emplace](#hash_multiset__emplace) restituisce un iteratore che punta alla posizione in cui il nuovo elemento è stato inserito nell'oggetto `hash_multiset`.  
...
### <a name="return-value"></a>Valore restituito  
 Coppia di iteratori in cui il primo è l'elemento [lower_bound](#hash_multiset__lower_bound) e il secondo è l'elemento [upper_bound](#hash_multiset__upper_bound) della chiave.  
...
### <a name="return-value"></a>Valore restituito  
 Tipo [iterator](#hash_multiset__iterator) o [const_iterator](#hash_multiset__const_iterator) che punta alla posizione di un elemento equivalente a una chiave specificata o che punta alla posizione successiva all'ultimo elemento dell'oggetto hash_multiset se non viene trovata alcuna corrispondenza per la chiave.  
...
### <a name="remarks"></a>Note  
 ...
 Il quarto costruttore sposta l'oggetto `hash_multiset``Right`.  
...
### <a name="example"></a>Esempio  
  Vedere l'esempio relativo a [begin](#hash_multiset__begin) per indicazioni su come dichiarare e usare **iterator**.  
 ...
 **bool operator**( **const Key&** *_xVal,* **const Key&** _ `yVal`);  
 ...
 Si noti che [key_compare](#hash_multiset__key_compare) e [value_compare](#hash_multiset__value_compare) sono sinonimi per il parametro di modello **Traits**. Entrambi i tipi vengono forniti per le classi hash_set e hash_multiset, dove sono identici, per la compatibilità con le classi hash_map e hash_multimap, dove sono distinti.  
...
### <a name="example"></a>Esempio  
  Vedere l'esempio relativo a [key_comp](#hash_multiset__key_comp) per indicazioni su come dichiarare e usare `key_compare`.  
 ...
 **key_type** è un sinonimo per il parametro di modello `Key`.  
 ...
 Si noti che `key_type` e [value_type](../standard-library/hash-set-class.md#hash_set__value_type) sono sinonimi per il parametro di modello **Key**. Entrambi i tipi vengono forniti per le classi set e multiset, dove sono identici, per la compatibilità con le classi map e multimap, dove sono distinti.  
...
### <a name="example"></a>Esempio  
  Vedere l'esempio relativo a [value_type](#hash_multiset__value_type) per indicazioni su come dichiarare e usare `key_type`.  
...
### <a name="remarks"></a>Note  
 ...
 Nella maggior parte dei casi, è consigliabile usare un tipo [iterator](#hash_multiset__iterator) per accedere agli elementi di un oggetto multiset.  
...
### <a name="remarks"></a>Note  
 `rbegin` viene usato con un oggetto hash_multiset invertito proprio come [begin](#hash_multiset__begin) viene usato con un oggetto hash_multiset.  
...
### <a name="remarks"></a>Note  
 `rend` viene usato con un oggetto hash_multiset invertito proprio come [end](#hash_multiset__end) viene usato con un oggetto hash_multiset.  
...
### <a name="example"></a>Esempio  
  Vedere l'esempio relativo a [rbegin](#hash_multiset__rbegin) per indicazioni su come dichiarare e usare `reverse_iterator`.  
...
### <a name="example"></a>Esempio  
  Vedere l'esempio relativo a [size](#hash_multiset__size) per indicazioni su come dichiarare e usare `size_type`.  
 ...
 **value_compare** è un sinonimo per il parametro di modello `Traits`.  
 ...
 Si noti che [key_compare](#hash_multiset__key_compare) e **value_compare** sono sinonimi per il parametro di modello **Traits**. Entrambi i tipi vengono forniti per le classi set e multiset, dove sono identici, per la compatibilità con le classi map e multimap, dove sono distinti.  
  
 In Visual C++ .NET 2003 i membri dei file di intestazione [<hash_map>](../standard-library/hash-map.md) e [<hash_set>](../standard-library/hash-set.md) non si trovano più nello spazio dei nomi std, ma sono stati spostati nello spazio dei nomi stdext. Per altre informazioni, vedere [Spazio dei nomi stdext](../standard-library/stdext-namespace.md).  
  
### <a name="example"></a>Esempio  
  Vedere l'esempio relativo a [value_comp](#hash_multiset__value_comp) per indicazioni su come dichiarare e usare `value_compare`.  
