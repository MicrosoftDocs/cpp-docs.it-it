...
ms.locfileid: "68268383"
---
# <a name="ltvariantgt-functions"></a>&lt;variante&gt; funzioni
...
Ottiene la variante di un oggetto se esiste.
...
Restituire **true** se esiste una variante.
...
## <a name="visit"></a> visita

Passa al successivo **variante**.
