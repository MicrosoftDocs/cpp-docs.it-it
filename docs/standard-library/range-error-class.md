...
Valore restituito da [che cosa](../standard-library/exception-class.md) è una copia di `message.data`. Per altre informazioni, vedere [basic_string::d ATA](../standard-library/basic-string-class.md#data).
