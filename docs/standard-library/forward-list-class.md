...
>  L'oggetto allocatore archiviato non viene copiato quando viene assegnato l'oggetto contenitore.  
 ...
 Le aggiunte alla sequenza controllata possono avvenire mediante chiamate a [forward_list::insert_after](#forward_list__insert_after), che è l'unica funzione membro che chiama il costruttore `Type(const  T&)`. `forward_list` potrebbe anche chiamare costruttori di spostamento. Se tale espressione genera un'eccezione, l'oggetto contenitore non inserisce nuovi elementi e genera di nuovo l'eccezione. Pertanto, un oggetto della classe modello `forward_list` rimane in uno stato noto quando si verificano tali eccezioni.  
  
### <a name="constructors"></a>Costruttori  
  
|||  
|-|-|  
|[forward_list](#forward_list__forward_list)|Costruisce un oggetto di tipo `forward_list`.|  
  
### <a name="typedefs"></a>Typedef  
  
|||  
|-|-|  
|[allocator_type](#forward_list__allocator_type)|Tipo che rappresenta la classe allocator per un oggetto elenco di inoltro.|  
|[const_iterator](#forward_list__const_iterator)|Tipo che fornisce un iteratore costante per l'elenco di inoltro.|  
|[const_pointer](#forward_list__const_pointer)|Tipo che fornisce un puntatore a un elemento `const` in un elenco di inoltro.|  
|[const_reference](#forward_list__const_reference)|Tipo che fornisce un riferimento costante a un elemento nell'elenco di inoltro.|  
|[difference_type](#forward_list__difference_type)|Tipo intero con segno che può essere usato per rappresentare il numero di elementi di un elenco di inoltro in un intervallo compreso tra gli elementi a cui puntano gli iteratori.|  
|[iterator](#forward_list__iterator)|Tipo che fornisce un iteratore per l'elenco di inoltro.|  
|[pointer](#forward_list__pointer)|Tipo che fornisce un puntatore a un elemento nell'elenco di inoltro.|  
|[reference](#forward_list__reference)|Tipo che fornisce un riferimento a un elemento nell'elenco di inoltro.|  
|[size_type](#forward_list__size_type)|Tipo che rappresenta la distanza senza segno tra due elementi.|  
|[value_type](#forward_list__value_type)|Tipo che rappresenta il tipo di elemento archiviato in un elenco di inoltro.|  
  
### <a name="member-functions"></a>Funzioni membro  
  
|||  
|-|-|  
|[assign](#forward_list__assign)|Cancella gli elementi da un elenco di inoltro e copia un nuovo set di elementi in un elenco di inoltro di destinazione.|  
|[before_begin](#forward_list__before_begin)|Restituisce un iteratore che punta alla posizione precedente al primo elemento in un elenco di inoltro.|  
|[begin](#forward_list__begin)|Restituisce un iteratore che punta al primo elemento in un elenco di inoltro.|  
|[cbefore_begin](#forward_list__cbefore_begin)|Restituisce un iteratore const che punta alla posizione precedente al primo elemento in un elenco di inoltro.|  
|[cbegin](#forward_list__cbegin)|Restituisce un iteratore const che punta al primo elemento in un elenco di inoltro.|  
|[cend](#forward_list__cend)|Restituisce un iteratore const che punta alla posizione successiva all'ultimo elemento in un elenco di inoltro.|  
|[clear](#forward_list__clear)|Cancella tutti gli elementi di un elenco di inoltro.|  
|[emplace_after](#forward_list__emplace_after)|Sposta un nuovo elemento dopo una posizione specificata.|  
|[emplace_front](#forward_list__emplace_front)|Aggiunge un elemento costruito sul posto all'inizio dell'elenco.|  
|[empty](#forward_list__empty)|Verifica se un elenco di inoltro è vuoto.|  
|[end](#forward_list__end)|Restituisce un iteratore che punta alla posizione successiva all'ultimo elemento in un elenco di inoltro.|  
|[erase_after](#forward_list__erase_after)|Rimuove gli elementi dall'elenco di inoltro dopo una posizione specificata.|  
|[front](#forward_list__front)|Restituisce un riferimento al primo elemento in un elenco di inoltro.|  
|[get_allocator](#forward_list__get_allocator)|Restituisce una copia dell'oggetto allocatore usato per costruire un elenco di inoltro.|  
|[insert_after](#forward_list__insert_after)|Aggiunge elementi all'elenco di inoltro dopo una posizione specificata.|  
|[max_size](#forward_list__max_size)|Restituisce la lunghezza massima di un elenco di inoltro.|  
|[merge](#forward_list__merge)|Rimuove gli elementi dall'elenco di argomenti, li inserisce nell'elenco di inoltro di destinazione e dispone il nuovo set combinato di elementi in ordine crescente o in un altro ordine specificato.|  
|[pop_front](#forward_list__pop_front)|Elimina l'elemento all'inizio di un elenco di inoltro.|  
|[push_front](#forward_list__push_front)|Elimina un elemento all'inizio di un elenco di inoltro.|  
|[remove](#forward_list__remove)|Cancella gli elementi in un elenco di inoltro che corrispondono a un valore specificato.|  
|[remove_if](#forward_list__remove_if)|Cancella gli elementi da un elenco di inoltro per il quale viene soddisfatto un predicato specificato.|  
|[resize](#forward_list__resize)|Specifica una nuova dimensione per un elenco di inoltro.|  
|[reverse](#forward_list__reverse)|Inverte l'ordine degli elementi in un elenco di inoltro.|  
|[sort](#forward_list__sort)|Dispone gli elementi in ordine crescente o in base a un ordine specificato da un predicato.|  
|[splice_after](#forward_list__splice_after)|Unisce di nuovo i collegamenti tra nodi.|  
|[swap](#forward_list__swap)|Scambia gli elementi di due elenchi di inoltro.|  
|[unique](#forward_list__unique)|Rimuove gli elementi adiacenti che superano un test specificato.|  
  
### <a name="operators"></a>Operatori  
  
|||  
|-|-|  
|[operator=](#forward_list__operator_eq)|Sostituisce gli elementi dell'elenco con una copia di un altro elenco di inoltro.|  
...
### <a name="remarks"></a>Note  
 Questa funzione membro inserisce un elemento con gli argomenti costruttore ` val` subito dopo l'elemento a cui punta `Where` nella sequenza controllata. Il comportamento altrimenti è uguale a quello di [forward_list::insert_after](#forward_list__insert_after).  
...
### <a name="return-value"></a>Valore restituito  
 Iteratore che designa il primo elemento rimanente oltre tutti gli elementi rimossi oppure [forward_list::end](#forward_list__end) se tale elemento non esiste.  
...
### <a name="remarks"></a>Note  
 ...
 Se l'operazione di splicing nell'intervallo inserisce `N` elementi e `&Source != this`, un oggetto della classe [iterator](#forward_list__iterator) sarà incrementato `N` volte.  
