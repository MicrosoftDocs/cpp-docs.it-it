---
description: 'Altre informazioni su: regex_token_iterator Class'
...
|[operatore = =](#op_eq_eq)|Confronta gli iteratori per verificarne l'uguaglianza.|
