...
|`student_t_distribution::operator()`||[student_t_distribution::param_type](#student_t_distribution__param_type)|  
 ...
 Per informazioni dettagliate sulla distribuzione Student-*t*, vedere l'articolo di Wolfram MathWorld [Students t-Distribution](http://go.microsoft.com/fwlink/LinkId=401094) (Distribuzione Student-t).  
