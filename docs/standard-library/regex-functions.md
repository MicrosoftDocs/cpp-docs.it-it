...
*BidIt*<br/>
Tipo di iteratore per le sottocorrispondenze. Per i casi comuni questa è una delle `string::const_iterator`, `wstring::const_iterator`, `const char*` o `const wchar_t*`.
