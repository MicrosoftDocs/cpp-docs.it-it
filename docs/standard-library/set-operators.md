...
*a sinistra* un oggetto di tipo `set`.

*a destra* un oggetto di tipo `set`.
...
*a sinistra* un oggetto di tipo `multiset`.

*a destra* un oggetto di tipo `multiset`.
