...
`left` Un oggetto di tipo **impostare**.

`right` Un oggetto di tipo **impostare**.
...
`left` Un oggetto di tipo `multiset`.

`right` Un oggetto di tipo `multiset`.
