...
## <a name="remarks"></a>Note  
 Il valore restituito dalla [classe exception](../standard-library/exception-class.md) è una copia di **message**`.`[data](../standard-library/basic-string-class.md#basic_string__data).  
