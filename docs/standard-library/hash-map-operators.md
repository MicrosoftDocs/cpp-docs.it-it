...
*a sinistra* un oggetto di tipo `hash_map`.

*a destra* un oggetto di tipo `hash_map`.
...
*a sinistra* un oggetto di tipo `hash_multimap`.

*a destra* un oggetto di tipo `hash_multimap`.
