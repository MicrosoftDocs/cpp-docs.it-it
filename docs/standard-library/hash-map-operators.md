...
`left` Un oggetto di tipo `hash_map`.

`right` Un oggetto di tipo `hash_map`.
...
`left` Un oggetto di tipo `hash_multimap`.

`right` Un oggetto di tipo `hash_multimap`.
