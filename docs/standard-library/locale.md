...
|[time_base](../standard-library/time-base-class.md)|Classe che funge da classe base per i facet di un modello di classe time_get, definendo solo il tipo enumerato DateOrder e diverse costanti di questo tipo.|
