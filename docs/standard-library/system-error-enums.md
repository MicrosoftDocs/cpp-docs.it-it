---
title: Enumerazioni &lt;system_error&gt; | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="ltsystemerrorgt-enums"></a>Enumerazioni &lt;system_error&gt;
|||  
|-|-|  
|[Enumerazione errc](#errc_enumeration)|[Enumerazione io_errc](#io_errc_enumeration)|  
  
##  <a name="a-nameerrcenumerationa--errc-enumeration"></a><a name="errc_enumeration"></a>  Enumerazione errc  
...
##  <a name="a-nameioerrcenumerationa--ioerrc-enumeration"></a><a name="io_errc_enumeration"></a>  Enumerazione io_errc  
 Fornisce nomi simbolici per le condizioni di errore in \<iostream>. Può essere usata creare gli oggetti [error_condition](../standard-library/error-condition-class.md) da confrontare con il valore restituito dalla funzione [ios_base::failure](../standard-library/ios-base-class.md#ios_base__failure)`code()`.  
