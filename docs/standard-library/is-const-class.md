---
description: 'Altre informazioni su: is_const Class'
...
ms.locfileid: "97231212"
---
# <a name="is_const-class"></a>Classe is_const
...
Un'istanza del predicato di tipo include true se *Ty* è `const-qualified` .
