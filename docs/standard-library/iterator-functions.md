...
Se `InputIterator` soddisfa i requisiti per un tipo di iteratore bidirezionale, può essere *Off* negativo. Se `InputIterator` è un tipo di iteratore di input o di avanzamento, *off* deve essere non negativo.
