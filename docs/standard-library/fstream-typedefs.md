...
È anche `wifstream`, un typedef che specializza `basic_ifstream` per leggere i caratteri **wchar_t** a doppia larghezza. Per altre informazioni, vedere [wifstream](../standard-library/fstream-typedefs.md#wifstream).
...
Tipo `basic_fstream` specializzato sui parametri del modello **wchar_t** .
...
Tipo `basic_ifstream` specializzato sui parametri del modello **wchar_t** .
...
Tipo `basic_ofstream` specializzato sui parametri del modello **wchar_t** .
...
Tipo `basic_filebuf` specializzato sui parametri del modello **wchar_t** .
