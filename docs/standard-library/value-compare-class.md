...
## <a name="example"></a>Esempio  
 Vedere l'esempio relativo ad [hash_map::value_comp](../standard-library/hash-map-class.md#hash_map__value_comp) per indicazioni su come dichiarare e usare la classe value_compare.  
