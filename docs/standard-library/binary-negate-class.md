...
`Func` Funzione binaria da negare.

`left` Il secondo operando della funzione binaria da negare.

`right` L'operando destro della funzione binaria da negare.
