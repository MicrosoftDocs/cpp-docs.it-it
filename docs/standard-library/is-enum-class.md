...
Un'istanza del predicato di tipo contiene true se il tipo `Ty` è un tipo di enumerazione o un form `cv-qualified` di un tipo di enumerazione; in caso contrario, contiene false.
