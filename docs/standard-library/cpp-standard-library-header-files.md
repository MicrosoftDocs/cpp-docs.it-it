...
File di intestazione della libreria standard di C++ e delle relative estensioni per categoria.  
 ...
 `Algorithms` [[altre informazioni](../cpp/algorithms-modern-cpp.md)]  
 ...
 `Containers` [[altre informazioni](../cpp/containers-modern-cpp.md)]  
 `Sequence`  
 ...
 `Error Handling` [[altre informazioni](../cpp/errors-and-exception-handling-modern-cpp.md)]  
 ...
 `Input/Output` [[altre informazioni](../cpp/string-and-i-o-formatting-modern-cpp.md)]  
 ...
 `Memory Management` [[altre informazioni](../cpp/smart-pointers-modern-cpp.md)]  
