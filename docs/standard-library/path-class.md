...
La seconda funzione membro Converte la sequenza archiviata `mypath` codifica preferita dal sistema hot per una sequenza char e la restituisce archiviata in un oggetto di tipo stringa.
