...
|[indicatore di misura](#pointer)|Tipo che fornisce un puntatore al tipo di oggetto gestito dall'allocatore.|
|[Riferimento](#reference)|Tipo che fornisce un riferimento al tipo di oggetto gestito dall'allocatore.|
|[size_type](#size_type)|Tipo integrale senza segno che può rappresentare la `allocator_base` lunghezza di qualsiasi sequenza che un oggetto può allocare.|
...
|-|-|
|[_Charalloc](#charalloc)|Alloca spazio di archiviazione per una matrice di tipo **char**.|
|[_Chardealloc](#chardealloc)|Libera l'archiviazione per la matrice contenente elementi di tipo **char**.|
|[Indirizzo](#address)|Trova l'indirizzo di un oggetto il cui valore è specificato.|
...
|[Distruggere](#destroy)|Chiama un distruttore di oggetti senza deallocare la memoria in cui è stato archiviato l'oggetto.|
...
Alloca spazio di archiviazione per una matrice di tipo **char**.
...
Libera l'archiviazione per la matrice contenente elementi di tipo **char**.
...
## <a name="allocator_baseaddress"></a><a name="address"></a>allocator_base::indirizzo
...
## <a name="allocator_baseallocate"></a><a name="allocate"></a>allocator_base::allocare
...
|Parametro|Descrizione|
|---------------|-----------------|
|*va bene*|Oggetto allocatore da copiare.|
...
## <a name="allocator_baseconstruct"></a><a name="construct"></a>allocator_base::costrutto
...
## <a name="allocator_basedifference_type"></a><a name="difference_type"></a>allocator_base::difference_type (tipo) allocator_base
...
## <a name="allocator_basereference"></a><a name="reference"></a>allocator_base::riferimento
...
Tipo integrale senza segno che può rappresentare la `allocator_base` lunghezza di qualsiasi sequenza che un oggetto può allocare.
