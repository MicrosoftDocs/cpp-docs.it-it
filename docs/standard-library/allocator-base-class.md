...
*Sincronizzazione*\
I criteri di sincronizzazione per l'allocatore, ovvero la [Classe sync_none](sync-none-class.md), la [Classe sync_per_container](sync-per-container-class.md), la [Classe sync_per_thread](sync-per-thread-class.md) o la [Classe sync_shared](sync-shared-class.md).
