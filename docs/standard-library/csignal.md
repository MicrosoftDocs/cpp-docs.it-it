...
ms.workload:
- cplusplus
ms.openlocfilehash: 52d6f1043f55c9c610467f9e820e34f5ee874970
...
Include l'intestazione della libreria C standard \<signal.h> e aggiunge i nomi associati allo spazio dei nomi `std`.  
