---
description: 'Altre informazioni su: &lt; cwchar&gt;'
title: '&lt;cwchar&gt;'
ms.date: 11/04/2016
f1_keywords:
- <cwchar>
...
ms.locfileid: "97232980"
---
# <a name="ltcwchargt"></a>&lt;cwchar&gt;

Include l'intestazione della libreria C standard \<wchar.h> e aggiunge i nomi associati allo `std` spazio dei nomi.
