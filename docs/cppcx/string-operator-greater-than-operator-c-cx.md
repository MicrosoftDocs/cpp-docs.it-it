...
## Note  
 Questo operatore equivale a chiamare in modo esplicito [String::CompareOrdinal](../cppcx/string-compareordinal-method.md) e a ottenere un risultato maggiore di zero.  
