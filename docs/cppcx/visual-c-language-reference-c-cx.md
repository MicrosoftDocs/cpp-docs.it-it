...
> [!NOTE]
> C + + WinRT è una nuova, standard C + + 17 language proiezione for Windows Runtime APIs. È disponibile in Windows 10 SDK più recente dalla versione 1803 in poi. C + + WinRT implementato interamente nel file di intestazione è progettato per fornire l'accesso di prima classe per l'API di Windows moderne.
