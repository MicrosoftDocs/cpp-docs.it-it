...
|[Creazione di App e librerie](../cppcx/building-apps-and-libraries-c-cx.md)|Viene illustrato come usare l'IDE per compilare le App e collegarsi a librerie statiche e DLL.|
