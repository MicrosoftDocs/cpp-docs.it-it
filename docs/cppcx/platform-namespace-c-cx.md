---
title: Spazio dei nomi Platform (C + c++ /CX) | Microsoft Docs
ms.custom: ''
ms.date: 12/30/2016
...
|[Classe Platform::Delegate](../cppcx/platform-delegate-class.md)|Rappresenta la firma di una funzione di callback.|  
