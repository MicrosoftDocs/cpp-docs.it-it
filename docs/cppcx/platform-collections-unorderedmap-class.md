...
### <a name="parameters"></a>Parametri  
 ...
 il  
 Oggetto [std:: initializer_list](../standard-library/initializer-list-class.md) di [std:: Pair](../standard-library/pair-structure.md)oggetti utilizzati per inizializzare la mappa.  
