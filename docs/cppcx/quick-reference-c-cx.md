---
description: 'Altre informazioni su: riferimento rapido (C++/CX)'
...
|Concetto|C++ standard|C++/CX|Commenti|
|-------------|--------------------|------------------------------------------------------------------|-------------|
