...
|Nome|Descrizione|
|----------|-----------------|
|[Metodo CompareStringOrdinal](comparestringordinal-method.md)|Confronta due oggetti `HSTRING` specificati e restituisce un intero che ne indica la posizione relativa in un ordinamento.|
