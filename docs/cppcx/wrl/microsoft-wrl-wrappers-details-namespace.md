...
|Nome|Descrizione|
|----------|-----------------|
|[Metodo CompareStringOrdinal](comparestringordinal-method.md)|Confronta due specificato `HSTRING` degli oggetti e restituisce un intero che indica la posizione relativa di una sequenza di ordinamento.|
