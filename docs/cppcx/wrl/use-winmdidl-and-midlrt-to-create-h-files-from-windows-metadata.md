---
description: 'Altre informazioni su: procedura: usare winmdidl.exe e midlrt.exe per creare file con estensione h dai metadati di Windows'
...
**/OutDir:**<em>dir</em><br/>
Specifica una directory di output. Se il percorso contiene spazi, usare le virgolette. La directory di output predefinita è *\<drive>* : \Users \\ *\<username>* \AppData\Local\VirtualStore\Program Files (x86) \microsoft Visual Studio 12,0 \\ .
