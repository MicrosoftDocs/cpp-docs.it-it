---
title: "Metodo Vector::InsertAt | Microsoft Docs"
ms.custom: ""
ms.date: "12/14/2016"
...
#### Parametri  
 ...
 `item`  
 Elemento da inserire in Vector dopo l'elemento specificato da `index`. Il tipo di `item` è definito dall'oggetto typename *T*.  
