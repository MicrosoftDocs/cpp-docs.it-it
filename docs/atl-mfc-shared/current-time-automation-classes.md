---
title: 'Ora corrente: Classi di automazione | Documenti Microsoft'
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
La procedura seguente viene illustrato come creare un `COleDateTime` dell'oggetto e inizializzarlo con l'ora corrente.  
