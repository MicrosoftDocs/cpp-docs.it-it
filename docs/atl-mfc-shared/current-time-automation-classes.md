---
title: 'Ora corrente: Classi di automazione | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
ms.locfileid: "48860615"
---
# <a name="current-time-automation-classes"></a>Ora corrente: Classi di automazione

La procedura seguente illustra come creare un `COleDateTime` dell'oggetto e inizializzarla con l'ora corrente.
