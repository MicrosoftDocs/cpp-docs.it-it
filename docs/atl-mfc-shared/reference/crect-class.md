---
description: 'Altre informazioni su: classe CRect'
title: Classe CRect
ms.date: 11/06/2018
f1_keywords:
- CRect
...
*lpSrcRect*<br/>
Punta alla struttura [](/windows/win32/api/windef/ns-windef-rect) o `CRect` all'oggetto Rect da copiare.
