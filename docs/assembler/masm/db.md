...
ms.locfileid: "32052180"
---
# <a name="db"></a>DB
Alloca e, facoltativamente, consente di inizializzare un byte di spazio di archiviazione per ogni `initializer`. `DB` è un sinonimo di [BYTE](../../assembler/masm/byte-masm.md)  
