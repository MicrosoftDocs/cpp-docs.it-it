...
|Opzione|Azione|
|------------|------------|
|**/AT**|Abilita il supporto del modello di memoria minuscola. Abilita i messaggi di errore per i costrutti di codice che violano i requisiti per i file in formato. com. Si noti che questo non è equivalente a [. Direttiva MODEL](dot-model.md) **Tiny** .<br /><br /> Non disponibile in ml64. exe.|
...
|**/ERRORREPORT** [ **NONE** &#124; **PROMPT** &#124; **QUEUE** &#124; **SEND** ]|Se ml. exe o ml64. exe non riesce in fase di esecuzione, è possibile utilizzare **/errorreport** per inviare informazioni a Microsoft in merito a questi errori interni.<br /><br /> Per ulteriori informazioni su **/errorreport**, vedere [/errorreport (segnala gli errori interni del compilatore)](../../build/reference/errorreport-report-internal-compiler-errors.md).|
...
|**/Sn**|Disattiva la tabella di simboli durante la generazione di un elenco.|
...
|**/St** *text*|Specifica il titolo per l'elenco di origine. Uguale al testo del [titolo](title.md) .|
