...
ms.locfileid: "43683232"
---
# <a name="data"></a>.DATA

Se usato con [. MODELLO](../../assembler/masm/dot-model.md), viene avviato un segmento di dati quasi per i dati inizializzati (_DATA nome segmento).
