---
title: operatore WIDTH | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-masm
...
ms.locfileid: "32056688"
---
# <a name="operator-width"></a>Operatore WIDTH
Restituisce la larghezza in bit dell'oggetto corrente *recordfieldname* o *record*.  
