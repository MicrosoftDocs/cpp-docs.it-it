---
title: '@DataSize| Documenti Microsoft'
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
0 per **TINY**, **SMALL**, **Media**, e **FLAT** modelli, 1 per **COMPACT** e  **GRANDE** modelli e 2 per **molto grandi** modello (equivalgono numerico).  
