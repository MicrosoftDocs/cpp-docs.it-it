...
ms.locfileid: "50562708"
---
# <a name="operator-gt-masm-run-time"></a>operatore &gt;= (MASM Run Time)

È maggiore o uguale a. Utilizzato solo all'interno [. IF](../../assembler/masm/dot-if.md), [. Sebbene](../../assembler/masm/dot-while.md), o [. Ripetere](../../assembler/masm/dot-repeat.md) blocca e valutate in fase di esecuzione, non in fase di assembly.
