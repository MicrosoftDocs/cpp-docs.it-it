---
title: TEXTEQU | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Assegna *textitem* a *nome*. Il *textitem* può essere una stringa letterale, una costante preceduta da un `%`, o la stringa restituita da una funzione di macro.  
