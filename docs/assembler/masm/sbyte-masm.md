...
alloca e facoltativamente inizializza un Signed Byte di archiviazione per ciascuno `initializer`.  Può essere utilizzato come un identificatore di tipo in un tipo è valido.  
