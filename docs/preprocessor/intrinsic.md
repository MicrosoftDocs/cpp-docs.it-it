...
|[cos](../c-runtime-library/reference/cos-cosf-cosl-cosh-coshf-coshl.md)||||  
 ...
 Vedere [funzione # pragma](../preprocessor/function-c-cpp.md) per informazioni e un esempio su come abilitare/disabilitare le funzioni intrinseche per un blocco di testo di origine.  
