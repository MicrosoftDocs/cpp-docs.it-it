...
|[C4062](../error-messages/compiler-warnings/compiler-warning-level-4-c4062.md) (livello 4)|l'identificatore' enumeratore '%$S' nell'istruzione switch dell'enum '%$pS' non viene gestito|
...
|[C4264](../error-messages/compiler-warnings/compiler-warning-level-1-c4264.md) (livello 1)|'funzione_virtuale': override non disponibile per la funzione membro virtuale dalla base '%$pC'. La funzione è nascosta.|
...
|C4426 (livello 1)|flag di ottimizzazione modificati dopo l'inclusione dell'intestazione, potrebbe essere dovuto a optimize () #pragma|
...
|[C4437](../error-messages/compiler-warnings/compiler-warning-level-4-c4437.md) (livello 4)|dynamic_cast dalla base virtuale '%$S' a '%$S' potrebbe non riuscire in alcuni contesti|
|C4444 (livello 3)|'__unaligned' di livello superiore non implementato nel contesto|
|C4464 (livello 4)|il percorso include relativo contiene '... '|
...
|[C4557](../error-messages/compiler-warnings/compiler-warning-level-3-c4557.md) (livello 3)|'__assume' contiene l'effetto 'effetto'|
...
|C4598 (livelli 1 e 3)|' #include "*intestazione*"': il numero di intestazione *numero* nell'intestazione precompilata non corrisponde a compilazione corrente in tale posizione|
|C4599 (livello 3)|'*opzione* *percorso*': il numero di argomenti della riga di comando *numero* non corrisponde a intestazione precompilata|
...
|C4654 (livello 4)|Includere codice inserito prima dell'intestazione precompilata riga verrà ignorata. Aggiungere codice all'intestazione precompilata.|
...
|C4786 (livello 3)|'*simbolo*': nome oggetto troncato a 'number' caratteri nelle informazioni di debug|
|[C4820](../error-messages/compiler-warnings/compiler-warning-level-4-c4820.md) (livello 4)|'byte' byte di riempimento aggiunti dopo costrutto 'nome_membro'|
...
|[C4946](../error-messages/compiler-warnings/compiler-warning-level-1-c4946.md) (livello 1)|reinterpret_cast utilizzato tra le classi correlate 'classe1' e 'classe2'|
...
|C5031 (livello 4)|#pragma warning (POP): probabile mancata corrispondenza, visualizzazione dello stato di avviso inserito nel file diverso|
...
|||
|-|-|
|[C4471 (livello 4)](../error-messages/compiler-warnings/compiler-warning-level-4-c4471.md)|una dichiarazione con prototipo di un'enumerazione senza ambito deve avere un tipo sottostante (presupposto int)|
|[C4608 (livello 3)](../error-messages/compiler-warnings/compiler-warning-level-3-c4608.md)|' unione\_membro ' è già stato inizializzato da un altro membro dell'unione nell'elenco di inizializzatori, 'union_member'|
...
Questi avvisi sono stati disattivata per impostazione predefinita nelle versioni del compilatore prima di Visual Studio 2012:
