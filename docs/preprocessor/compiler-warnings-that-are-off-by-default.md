---
title: Gli avvisi del compilatore disattivati per impostazione predefinita | Documenti Microsoft
ms.date: 05/30/2018
ms.technology:
- cpp-tools
ms.topic: reference
...
- **avviso #pragma (valore predefinito:** *numero_avviso* **)**
...
|[C4242](../error-messages/compiler-warnings/compiler-warning-level-4-c4242.md) (livello 4)|'*identificatore*': conversione da '*type1*'a'*type2*', possibile perdita di dati|
|[C4254](../error-messages/compiler-warnings/compiler-warning-level-4-c4254.md) (livello 4)|'*operatore*': conversione da '*type1*'a'*type2*', possibile perdita di dati|
...
|[C4289](../error-messages/compiler-warnings/compiler-warning-level-4-c4289.md) (livello 4)|utilizzata estensione non standard: '*var*': variabile di controllo ciclo dichiarata nel ciclo for e utilizzata all'esterno di ambito del ciclo for|
...
|[C4412](../error-messages/compiler-warnings/compiler-warning-level-2-c4412.md) (livello 2)|'*funzione*': funzione firma contiene il tipo '*tipo*'; Gli oggetti C++ sono non è sicuro passare tra codice pure e misto o nativo|
...
|[C4464](../error-messages/compiler-warnings/c4464.md) (livello 4)|percorso include relativo contiene '... '|
...
|[C4536](../error-messages/compiler-warnings/compiler-warning-level-4-c4536.md) (livello 4)|'type name': il nome del tipo eccede eccede il limite di '*limite*' caratteri|
...
|[C4571](../error-messages/compiler-warnings/compiler-warning-level-4-c4571.md) (livello 4)|informativo: la semantica di catch è cambiata dopo Visual C++ 7.1; le eccezioni strutturate (SEH) non vengono più rilevate|
|C4574 (livello 4)|'*identificatore*'è definito come ' 0': si intendeva usare ' #if *identificatore*'?|
|C4577 (livello 1)|'noexcept' utilizzato con nessun specificato; la modalità di gestione delle eccezioni terminazione in caso di eccezione non è garantita. Specificare /EHsc|
...
|C4588 (livello 1)|'*anonymous_structure*': modifica del comportamento: viene chiamato non è più implicitamente distruttore|
...
|[C4668](../error-messages/compiler-warnings/compiler-warning-level-4-c4668.md) (livello 4)|'*simbolo*'non è definito come macro del preprocessore, sostituendo con '0' per'*direttive*'|
...
|[C4692](../error-messages/compiler-warnings/compiler-warning-level-1-c4692.md) (livello 1)|'*funzione*': la firma del membro non privato contiene il tipo nativo privato '*tipo_nativo del*'|
...
|C4749 (livello 4)|supportata in modo condizionale: offsetof a società senza-standard del layout di tipo '*tipo*'|
|C4767 (livello 4)|nome della sezione '*simbolo*' è più lungo di 8 caratteri e verrà troncata dal linker|
...
|C4837 (livello 4)|rilevato trigramma: '? *carattere*'sostituito'*carattere*'|
...
|[C4986](../error-messages/compiler-warnings/compiler-warning-c4986.md) (livello 4)|'*simbolo*': la specifica di eccezione non corrisponde alla dichiarazione precedente|
...
|[C5045](../error-messages/compiler-warnings/c5045.md)|Compilatore inserirà attenuazione Spectre per carico di memoria se è specificata l'opzione /Qspectre <sup>15.7</sup>|

<sup>14.1</sup> questo avviso non è disponibile a partire da Visual Studio 2015 Update 1.  
<sup>14.3</sup> questo avviso non è disponibile a partire da Visual Studio 2015 Update 3.  
<sup>15.3</sup> questo avviso non è disponibile a partire da Visual Studio 2017 versione 15.3.  
<sup>15,5</sup> questo avviso non è disponibile a partire da Visual Studio 2017 versione 15,5.  
<sup>15.7</sup> questo avviso non è disponibile a partire da Visual Studio 2017 versione 15.7.  
...
|[C4319](../error-messages/compiler-warnings/compiler-warning-level-1-c4319.md) (livello 1)|'*operatore*': estensione zero '*type1*'a'*type2*' di dimensioni maggiori|
