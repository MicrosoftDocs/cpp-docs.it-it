---
title: fp_contract | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
## <a name="example"></a>Esempio  
 Il codice generato da questo esempio non utilizza il Fused Multiply Add (**fma**) istruzione su processori Itanium. Impostare come commento le `#pragma fp_contract (off)`, il codice generato utilizzerà il **fma** istruzione.  
