...
> [!NOTE]
>  `CCriticalSection`, a differenza di altre classi di sincronizzazione di MFC, non è di una richiesta di blocco temporizzata. Il periodo di attesa per un thread diventi disponibile è infinito.  
