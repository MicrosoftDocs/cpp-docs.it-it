...
Rappresenta un breve vettore di tre integer senza segno.  
...
|Nome|Descrizione|  
|----------|-----------------|  
|[Costruttore uint\_3::uint\_3](../Topic/uint_3::uint_3%20Constructor.md)|Di overload.  Il costruttore predefinito, inizializza tutti gli elementi a 0.|  
  
### Metodi pubblici  
  
|Nome|Descrizione|  
|----------|-----------------|  
|Metodo uint\_3::get\_x.||  
|Metodo uint\_3::get\_xy.||  
|metodo di uint\_3::get\_xyz||  
|metodo di uint\_3::get\_xz||  
|metodo di uint\_3::get\_xzy||  
|Metodo uint\_3::get\_y.||  
|Metodo uint\_3::get\_yx.||  
|metodo di uint\_3::get\_yxz||  
|metodo di uint\_3::get\_yz||  
|metodo di uint\_3::get\_yzx||  
|metodo di uint\_3::get\_z||  
|metodo di uint\_3::get\_zx||  
|metodo di uint\_3::get\_zxy||  
|metodo di uint\_3::get\_zy||  
|metodo di uint\_3::get\_zyx||  
|Metodo uint\_t::ref\_b||  
|Metodo uint\_t::ref\_g||  
|Metodo uint\_t::ref\_r||  
|Metodo uint\_t::ref\_x||  
|Metodo uint\_t::ref\_y||  
|Metodo uint\_t::ref\_z||  
|Metodo uint\_3::set\_x.||  
|Metodo uint\_3::set\_xy.||  
|metodo di uint\_3::set\_xyz||  
|metodo di uint\_3::set\_xz||  
|metodo di uint\_3::set\_xzy||  
|Metodo uint\_3::set\_y.||  
|Metodo uint\_3::set\_yx.||  
|metodo di uint\_3::set\_yxz||  
|metodo di uint\_3::set\_yz||  
|metodo di uint\_3::set\_yzx||  
|metodo di uint\_3::set\_z||  
|metodo di uint\_3::set\_zx||  
|metodo di uint\_3::set\_zxy||  
|metodo di uint\_3::set\_zy||  
|Metodo uint\_3::set\_zyx||  
  
### Operatori pubblici  
  
|Nome|Descrizione|  
|----------|-----------------|  
|Operatore uint\_3::operator\-\-||  
|Operatore uint\_3::operator%\=||  
|Operatore uint\_3::operator&\=||  
|Operatore uint\_3::operator\*\=||  
|Operatore uint\_3::operator\/\=||  
...
|Nome|Descrizione|  
|----------|-----------------|  
|[Costante uint\_3::size](../Topic/uint_3::size%20Constant.md)||  
  
### Membri dati pubblici  
  
|Nome|Descrizione|  
|----------|-----------------|  
|membro dati di uint\_3::b||  
|membro dati di uint\_3::bg||  
|membro dati di uint\_3::bgr||  
|membro dati di uint\_3::br||  
|membro dati di uint\_3::brg||  
|membro dati uint\_3::g||  
|membro dati di uint\_3::gb||  
|membro dati di uint\_3::gbr||  
|membro dati uint\_3::gr||  
|membro dati di uint\_3::grb||  
|Membro dati uint\_3::r||  
|membro dati di uint\_3::rb||  
|membro dati di uint\_3::rbg||  
|Membro dati uint\_3::rg||  
|membro dati di uint\_3::rgb||  
|Membro dati uint\_3::x||  
|Membro dati uint\_3::xy||  
|membro dati di uint\_3::xyz||  
|membro dati di uint\_3::xz||  
|membro dati di uint\_3::xzy||  
|Membro dati uint\_3::y||  
|Membro dati uint\_3::yx||  
|membro dati di uint\_3::yxz||  
|membro dati di uint\_3::yz||  
|membro dati di uint\_3::yzx||  
|membro dati di uint\_3::z||  
|membro dati di uint\_3::zx||  
|membro dati di uint\_3::zxy||  
|membro dati di uint\_3::zy||  
|membro dati di uint\_3::zyx||  
