...
ms.locfileid: "46402063"
---
# <a name="concurrencyprecisemath-namespace"></a>Spazio dei nomi Concurrency::precise_math

Le funzioni di `precise_math` dello spazio dei nomi sono conformi a C99. Entrambi precisione singola e precisione doppia le versioni di ogni funzione sono incluse. Ad esempio, `acos` è la versione a precisione doppia e `acosf` è la versione con precisione singola. Queste funzioni, tra cui le funzioni a precisione singola, richiedono supporto a precisione doppia esteso sull'acceleratore. È possibile usare la [Accelerator:: supports_double_precision](accelerator-class.md#supports_double_precision) per determinare se è possibile eseguire queste funzioni in un acceleratore specifico.
...
|Nome|Descrizione|
|----------|-----------------|
|[acos](concurrency-precise-math-namespace-functions.md#acos)|Di overload. Calcola l'arcocoseno dell'argomento|
|[acosf](concurrency-precise-math-namespace-functions.md#acosf)|Calcola l'arcocoseno dell'argomento|
...
|[atan2](concurrency-precise-math-namespace-functions.md#atan2)|Di overload. Calcola l'arcotangente di x|
|[atan2f](concurrency-precise-math-namespace-functions.md#atan2f)|Calcola l'arcotangente di x|
...
|[ceil](concurrency-precise-math-namespace-functions.md#ceil)|Di overload. Calcola il tetto massimo dell'argomento|
|[ceilf](concurrency-precise-math-namespace-functions.md#ceilf)|Calcola il tetto massimo dell'argomento|
|[copysign](concurrency-precise-math-namespace-functions.md#copysign)|Di overload. Produce un valore con la grandezza di x e il segno di y|
|[copysignf](concurrency-precise-math-namespace-functions.md#copysignf)|Produce un valore con la grandezza di x e il segno di y|
...
|[cospi](concurrency-precise-math-namespace-functions.md#cospi)|Di overload. Calcola il valore del coseno di pi greco \* x|
|[cospif](concurrency-precise-math-namespace-functions.md#cospif)|Calcola il valore del coseno di pi greco \* x|
...
|[floor](concurrency-precise-math-namespace-functions.md#floor)|Di overload. Calcola il tetto minimo dell'argomento|
|[floorf](concurrency-precise-math-namespace-functions.md#floorf)|Calcola il tetto minimo dell'argomento|
|[fma](concurrency-precise-math-namespace-functions.md#fma)|Di overload. Calcolo ( x \* y) + z, arrotondato come un'unica operazione ternaria|
|[fmaf](concurrency-precise-math-namespace-functions.md#fmaf)|Calcolo ( x \* y) + z, arrotondato come un'unica operazione ternaria|
...
|[isinf](concurrency-precise-math-namespace-functions.md#isinf)|Di overload. Determina se l'argomento è un numero infinito|
...
|[log1p](concurrency-precise-math-namespace-functions.md#log1p)|Di overload. Calcola il logaritmo di base e di 1 più l'argomento|
|[log1pf](concurrency-precise-math-namespace-functions.md#log1pf)|Calcola il logaritmo di base e di 1 più l'argomento|
...
|[logb](concurrency-precise-math-namespace-functions.md#logb)|Di overload. Estrae l'esponente di x, come valore intero con segno in formato a virgola mobile|
|[logbf](concurrency-precise-math-namespace-functions.md#logbf)|Estrae l'esponente di x, come valore intero con segno in formato a virgola mobile|
|[logf](concurrency-precise-math-namespace-functions.md#logf)|Calcola il logaritmo in base e dell'argomento|
|[modf](concurrency-precise-math-namespace-functions.md#modf)|Di overload. Divide x in parte frazionaria e parte intera.|
|[modff](concurrency-precise-math-namespace-functions.md#modff)|Divide x in parte frazionaria e parte intera.|
...
|[nearbyint](concurrency-precise-math-namespace-functions.md#nearbyint)|Di overload. Arrotonda l'argomento in un valore intero nel formato a virgola mobile, utilizzando la direzione di arrotondamento corrente.|
|[nearbyintf](concurrency-precise-math-namespace-functions.md#nearbyintf)|Arrotonda l'argomento in un valore intero nel formato a virgola mobile, utilizzando la direzione di arrotondamento corrente.|
|[nextafter](concurrency-precise-math-namespace-functions.md#nextafter)|Di overload. Determinare il prossimo valore rappresentabile, nel tipo della funzione, dopo x in direzione di y|
|[nextafterf](concurrency-precise-math-namespace-functions.md#nextafterf)|Determinare il prossimo valore rappresentabile, nel tipo della funzione, dopo x in direzione di y|
...
|[remquo](concurrency-precise-math-namespace-functions.md#remquo)|Di overload. Calcola il resto stesso come y REM x. Inoltre consente di calcolare i bit più bassi 23 di x il quoziente y e assegna tale valore lo stesso segno x/y. Archivia questo valore con segno nel valore integer a cui punta quo.|
|[remquof](concurrency-precise-math-namespace-functions.md#remquof)|Calcola il resto stesso come y REM x. Inoltre consente di calcolare i bit più bassi 23 di x il quoziente y e assegna tale valore lo stesso segno x/y. Archivia questo valore con segno nel valore integer a cui punta quo.|
|[round](concurrency-precise-math-namespace-functions.md#round)|Di overload. Arrotonda x all'integer più vicino|
|[roundf](concurrency-precise-math-namespace-functions.md#roundf)|Arrotonda x all'integer più vicino|
...
|[scalb](concurrency-precise-math-namespace-functions.md#scalb)|Di overload. Moltiplica x da FLT_RADIX di y il risparmio energia|
|[scalbf](concurrency-precise-math-namespace-functions.md#scalbf)|Moltiplica x da FLT_RADIX di y il risparmio energia|
|[scalbn](concurrency-precise-math-namespace-functions.md#scalbn)|Di overload. Moltiplica x da FLT_RADIX di y il risparmio energia|
|[scalbnf](concurrency-precise-math-namespace-functions.md#scalbnf)|Moltiplica x da FLT_RADIX di y il risparmio energia|
|[signbit](concurrency-precise-math-namespace-functions.md#signbit)|Di overload. Determina se il segno di x è un valore negativo|
|[signbitf](concurrency-precise-math-namespace-functions.md#signbitf)|Determina se il segno di x è un valore negativo|
|[sin](concurrency-precise-math-namespace-functions.md#sin)|Di overload. Calcola il valore del seno dell'argomento|
|[sincos](concurrency-precise-math-namespace-functions.md#sincos)|Di overload. Calcola un valore del seno e il coseno di x|
|[sincosf](concurrency-precise-math-namespace-functions.md#sincosf)|Calcola un valore del seno e il coseno di x|
