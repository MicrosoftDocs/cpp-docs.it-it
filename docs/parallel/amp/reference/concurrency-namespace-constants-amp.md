...
## <a name="modulename_max_length-constant"></a><a name="modulename_max_length"></a>MODULENAME_MAX_LENGTH costante

Memorizza la lunghezza massima del nome del modulo. Questo valore deve essere lo stesso nel compilatore e in fase di esecuzione.
