...
Rappresenta un short vector di tre numeri a virgola mobile.  
...
|Nome|Descrizione|  
|----------|-----------------|  
|[Costruttore float\_3::float\_3](../Topic/float_3::float_3%20Constructor.md)|Di overload.  Il costruttore predefinito, inizializza tutti gli elementi a 0.|  
  
### Metodi pubblici  
  
|Nome|Descrizione|  
|----------|-----------------|  
|Metodo float\_3::get\_x||  
|Metodo float\_3::get\_xy||  
|Metodo float\_3::get\_xyz||  
|Metodo float\_3::get\_xz||  
|Metodo float\_3::get\_xzy||  
|Metodo float\_3::get\_y||  
|Metodo float\_3::get\_yx||  
|Metodo float\_3::get\_yxz||  
|Metodo float\_3::get\_yz||  
|Metodo float\_3::get\_yzx||  
|Metodo float\_3::get\_z||  
|Metodo float\_3::get\_zx||  
|Metodo float\_3::get\_zxy||  
|Metodo float\_3::get\_zy||  
|Metodo float\_3::get\_zyx||  
|Metodo float\_3::ref\_b||  
|Metodo float\_3::ref\_g||  
|Metodo float\_3::ref\_r||  
|Metodo float\_3::ref\_x||  
|Metodo float\_3::ref\_y||  
|Metodo float\_3::ref\_z||  
|Metodo float\_3::set\_x||  
|Metodo float\_3::set\_xy||  
|Metodo float\_3::set\_xyz||  
|Metodo float\_3::set\_xz||  
|Metodo float\_3::set\_xzy||  
|Metodo float\_3::set\_y||  
|Metodo float\_3::set\_yx||  
|Metodo float\_3::set\_yxz||  
|Metodo float\_3::set\_yz||  
|Metodo float\_3::set\_yzx||  
|Metodo float\_3::set\_z||  
|Metodo float\_3::set\_zx||  
|Metodo float\_3::set\_zxy||  
|Metodo float\_3::set\_zy||  
|Metodo float\_3::set\_zyx||  
  
### Operatori pubblici  
  
|Nome|Descrizione|  
|----------|-----------------|  
|Operatore float\_3::operator\-||  
|Operatore float\_3::operator\-\-||  
|Operatore float\_3::operator\*\=||  
|Operatore float\_3::operator\/\=||  
|Operatore float\_3::operator\+\+||  
...
|Nome|Descrizione|  
|----------|-----------------|  
|[Costante float\_3::size](../Topic/float_3::size%20Constant.md)||  
  
### Membri dati pubblici  
  
|Nome|Descrizione|  
|----------|-----------------|  
|Membro dati float\_3::b||  
|Membro dati float\_3::bg||  
|Membro dati float\_3::bgr||  
|Membro dati float\_3::br||  
|Membro dati float\_3::brg||  
|Membro dati float\_3::g||  
|Membro dati float\_3::gb||  
|Membro dati float\_3::agbr||  
|Membro dati float\_3::gr||  
|Membro dati float\_3::grb||  
|Membro dati float\_3::r||  
|Membro dati float\_3::rb||  
|Membro dati float\_3::rbg||  
|Membro dati float\_3::rg||  
|Membro dati float\_3::rgb||  
|Membro dati float\_3::x||  
|Membro dati float\_3::xy||  
|Membro dati float\_3::xyz||  
|Membro dati float\_3::xz||  
|Membro dati float\_3::xzy||  
|Membro dati float\_3::y||  
|Membro dati float\_3::yx||  
|Membro dati float\_3::yxz||  
|Membro dati float\_3::yz||  
|Membro dati float\_3::yzx||  
|Membro dati float\_3::z||  
|Membro dati float\_3::zx||  
|Membro dati float\_3::zxy||  
|Membro dati float\_3::zy||  
|Membro dati float\_3::zyx||  
