---
title: Classe int_4 | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-amp
...
ms.locfileid: "33694485"
---
# <a name="int4-class"></a>Classe int_4
Rappresenta uno short vector di quattro valori integer.  
...
|Nome|Descrizione|  
|----------|-----------------|  
|[Costruttore int_4](#ctor)|Di overload. Predefinito, costruttore inizializza tutti gli elementi con 0.|  
