...
Il tipo di enumerazione viene utilizzato per indicare le modalità di indirizzo supportate per il campionamento delle trame.
...
Il tipo di enumerazione viene utilizzato per indicare le modalità di filtro supportate per il campionamento delle trame.
...
**Intestazione:** spazio **dei nomi** amp_graphics.h: Concurrency::graphics
