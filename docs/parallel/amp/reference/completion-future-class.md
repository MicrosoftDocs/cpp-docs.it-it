...
2.  `std::future_status::ready` Se l'operazione asincrona associata viene completata.  
  
3.  `std::future_status::timeout` Se il periodo di tempo specificato è scaduto.  
