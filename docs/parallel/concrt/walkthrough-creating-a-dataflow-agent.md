...
4.  Creare il messaggio di oggetti buffer che verranno incluse nella rete del flusso di dati.  
  
 [!code-cpp[concrt-dataflow-agent#3](../../parallel/concrt/codesnippet/cpp/walkthrough-creating-a-dataflow-agent_4.cpp)]  
  
5.  Connettere il buffer di messaggi per formare una rete.  
  
 [!code-cpp[concrt-dataflow-agent#4](../../parallel/concrt/codesnippet/cpp/walkthrough-creating-a-dataflow-agent_5.cpp)]  
  
6.  Attendere che il `event` e `countdown event` oggetti da impostare. Questi eventi indicano che l'agente ha ricevuto il valore di sentinel e che tutte le operazioni è sono completata.  
