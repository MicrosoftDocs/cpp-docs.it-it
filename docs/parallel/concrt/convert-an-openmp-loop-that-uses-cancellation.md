---
title: "Procedura: Converte un ciclo OpenMP che usa l'annullamento per usare il runtime di concorrenza"
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "69631522"
---
# <a name="how-to-convert-an-openmp-loop-that-uses-cancellation-to-use-the-concurrency-runtime"></a>Procedura: Converte un ciclo OpenMP che usa l'annullamento per usare il runtime di concorrenza
