...
Per un esempio in cui viene illustrato come adattare il codice esistente per l'utilizzo di un' [attività leggera, vedere Procedura dettagliata: Adattamento del codice esistente per l'utilizzo di](../../parallel/concrt/walkthrough-adapting-existing-code-to-use-lightweight-tasks.md)attività semplici.
