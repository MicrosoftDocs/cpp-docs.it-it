---
title: Panoramica del runtime di concorrenza
ms.date: 11/19/2018
helpviewer_keywords:
...
ms.locfileid: "77142925"
---
# <a name="overview-of-the-concurrency-runtime"></a>Panoramica del runtime di concorrenza
...
- [Perché un runtime per la concorrenza è importante](#runtime)

- [Architettura](#architecture)

- [C++Espressioni lambda](#lambda)

- [Requisiti](#requirements)

## <a name="dlls"></a>Cronologia di implementazione di runtime di concorrenza

In Visual Studio 2010 fino a 2013, il runtime di concorrenza è stato incorporato in msvcr100. dll tramite msvcr120. dll.  Quando il refactoring di UCRT si è verificato in Visual Studio 2015, la DLL è stata sottoposta a refactoring in tre parti:
...
## <a name="runtime"></a>Perché un runtime per la concorrenza è importante
...
**Architettura runtime di concorrenza**

![Architettura runtime di concorrenza](../../parallel/concrt/media/concurrencyrun.png "Architettura del runtime di concorrenza")
...
### <a name="parallel-patterns-library"></a>PPL (Parallel Patterns Library)
...
Usare la libreria PPL (Parallel Patterns Library) per i calcoli locali che possono trarre vantaggio dall'esecuzione parallela. Ad esempio, è possibile usare l'algoritmo [Concurrency::p arallel_for](reference/concurrency-namespace-functions.md#parallel_for) per trasformare un ciclo di `for` esistente per agire in parallelo.
...
## <a name="lambda"></a>C++ Espressioni lambda
...
La runtime di concorrenza viene dichiarata nello spazio dei nomi [Concurrency](../../parallel/concrt/reference/concurrency-namespace.md) . È anche possibile usare la [concorrenza](../../parallel/concrt/reference/concurrency-namespace.md), ovvero un alias per questo spazio dei nomi. Lo spazio dei nomi `concurrency::details` supporta runtime di concorrenza Framework e non può essere utilizzato direttamente dal codice.
