...
|Nome|Descrizione|  
|----------|-----------------|  
|[Costruttore operation\_timed\_out::operation\_timed\_out](../Topic/operation_timed_out::operation_timed_out%20Constructor.md)|Di overload.  Costruisce un oggetto `operation_timed_out`.|  
