...
|Nome|Descrizione|  
|----------|-----------------|  
|[Costruttore concurrent\_unordered\_multimap::concurrent\_unordered\_multimap](../Topic/concurrent_unordered_multimap::concurrent_unordered_multimap%20Constructor.md)|Di overload.  Costruisce una multimappa non ordinata simultanea.|  
  
### Metodi pubblici  
  
|Nome|Descrizione|  
|----------|-----------------|  
|[Metodo concurrent\_unordered\_multimap::hash\_function](../Topic/concurrent_unordered_multimap::hash_function%20Method.md)|Restituisce l'oggetto archiviato della funzione hash.|  
|[Metodo concurrent\_unordered\_multimap::insert](../Topic/concurrent_unordered_multimap::insert%20Method.md)|Di overload.  Aggiunge elementi all'oggetto `concurrent_unordered_multimap`.|  
|[Metodo concurrent\_unordered\_multimap::key\_eq](../Topic/concurrent_unordered_multimap::key_eq%20Method.md)|Restituisce l'oggetto archiviato della funzione di confronto di uguaglianza.|  
|[Metodo concurrent\_unordered\_multimap::swap](../Topic/concurrent_unordered_multimap::swap%20Method.md)|Scambia il contenuto di due oggetti `concurrent_unordered_multimap`.  Tale metodo non è sicuro per concorrenza.|  
|[Metodo concurrent\_unordered\_multimap::unsafe\_erase](../Topic/concurrent_unordered_multimap::unsafe_erase%20Method.md)|Di overload.  Rimuove gli elementi da `concurrent_unordered_multimap` alle posizioni specificate.  Tale metodo non è sicuro per concorrenza.|  
  
### Operatori pubblici  
  
|Nome|Descrizione|  
|----------|-----------------|  
|[Operatore concurrent\_unordered\_multimap::operator\=](../Topic/concurrent_unordered_multimap::operator=%20Operator.md)|Di overload.  Assegna il contenuto di un altro oggetto `concurrent_unordered_multimap` a questo.  Tale metodo non è sicuro per concorrenza.|  
