---
title: le costanti dello spazio dei nomi di concorrenza | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.topic: reference
f1_keywords:
...
Questa categoria di eventi non è attualmente generata dal Runtime di concorrenza.
