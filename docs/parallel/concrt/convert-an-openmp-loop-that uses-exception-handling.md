---
title: "Procedura: convertire un ciclo OpenMP che usa la gestione delle eccezioni per l'uso del Runtime di concorrenza | Microsoft Docs"
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-concrt
