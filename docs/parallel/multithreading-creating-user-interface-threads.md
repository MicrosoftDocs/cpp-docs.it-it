...
|[Eseguire](../mfc/reference/cwinthread-class.md#run)| Funzione di controllo per il thread. Contiene il message pump. Raramente sottoposto a override. |  
