---
title: A.22 utilizzando la clausola default (None) | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
```  
 ...
 Per ulteriori informazioni sul `default` clausola, vedere [sezione 2.7.2.5](../../parallel/openmp/2-7-2-5-default.md) nella pagina 28.