---
title: Relog
description: Riferimento C++ alla funzione relog di build Insights SDK.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
La funzione `Relog` viene utilizzata per leggere gli eventi MSVC da una traccia di Event Tracing for Windows (ETW) e scriverli in una nuova traccia ETW modificata.
