---
title: enum EVENT_ID
description: L'SDK di Build Insights di C'è EVENT_ID riferimento all'enumerazione.
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "81325571"
---
# <a name="event_id-enum"></a>enum EVENT_ID
...
L'enumerazione. `EVENT_ID`

## <a name="members"></a>Membri

| Nome | Valore | URL dettagli evento |
|--|--|--|
...
| `EVENT_ID_COMPILER` | 7 (0x00000007) | [Compilatore](../event-table.md#compiler) |
...
| `EVENT_ID_FUNCTION` | 15 (0x000000F) | [Funzione](../event-table.md#function) |
...
| `EVENT_ID_LTCG` | 19 (0x00000013) | [LTCG (InviETG)](../event-table.md#ltcg) |
...
Questi valori vengono utilizzati con le funzioni C SDK.
