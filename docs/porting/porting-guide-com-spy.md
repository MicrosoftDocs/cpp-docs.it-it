...
Questo comando di registrazione post-compilazione non è più necessario. Al contrario, è sufficiente rimuovere il comando di compilazione personalizzato e specificare nelle impostazioni del **linker** per registrare l'output.
