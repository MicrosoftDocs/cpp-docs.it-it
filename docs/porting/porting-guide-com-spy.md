...
```  
 ...
 È inoltre necessario apportare una modifica simile a IPersistStreamInit_Load.  
...
```  
 ...
 Questo comando di registrazione post-compilazione non è più necessario. È invece sufficiente rimuovere il comando di compilazione personalizzato e specificare di registrare l'output nelle impostazioni del linker.  
