...
## [Conversione e aggiornamento: esempi e case study](porting-and-upgrading-examples-and-case-studies.md)
### [Guida alla conversione: MFC Scribble](porting-guide-mfc-scribble.md)
### [Guida alla conversione: COM Spy](porting-guide-com-spy.md)
### [Guida alla conversione: Spy++](porting-guide-spy-increment.md)
...
### [Procedura: Usare codice C++ esistente in un'app UWP (Universal Windows Platform)](how-to-use-existing-cpp-code-in-a-universal-windows-platform-app.md)
