---
title: Organizzazione dei riferimenti al linguaggio C | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
---
# <a name="organization-of-the-c-language-reference"></a>Organizzazione dei riferimenti al linguaggio C
