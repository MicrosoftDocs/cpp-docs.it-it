...
description: Informazioni sulla grammatica C standard per le espressioni implementate dal compilatore Microsoft C/C++.
ms.date: 10/30/2020
...
&emsp;*`postfix-expression`***`(`** *`argument-expression-list`* <sub>consenso esplicito</sub>**`)`**\
