---
title: Espressioni e assegnazioni
ms.date: 11/04/2016
helpviewer_keywords:
...
- [Effetti collaterali](../c-language/side-effects.md)

- [Punti di sequenza](../c-language/c-sequence-points.md)

- [Operatori](../c-language/c-operators.md)
