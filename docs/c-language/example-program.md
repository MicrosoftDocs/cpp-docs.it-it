...
```  
 ...
 La durata e la visibilità degli identificatori vengono illustrate in [Durata, ambito, visibilità e collegamento](../c-language/lifetime-scope-visibility-and-linkage.md).  Per ulteriori informazioni sulle funzioni, vedere [Funzioni](../c-language/functions-c.md).  
