---
title: Tipo long double | Microsoft Docs
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.author: mblome
manager: ghogen
ms.openlocfilehash: 62c2ab1579e95d09904070a3f916228ef9974036
...
Il tipo `long double` è identico al tipo [double](../c-language/type-double.md).  
