---
title: "Passaggio di argomenti a main | Microsoft Docs"
ms.custom: ""
ms.date: "12/05/2016"
...
```  
 ...
 La terza riga precedente, in cui **main** accetta tre parametri, è un'estensione Microsoft allo standard ANSI C.  Il terzo parametro, **envp**, è una matrice di puntatori alle variabili di ambiente.  La matrice **envp** viene interrotta da un puntatore null.  Vedere [La funzione principale e l'esecuzione del programma](../c-language/main-function-and-program-execution.md) per ulteriori informazioni su **main** e **envp**.  
