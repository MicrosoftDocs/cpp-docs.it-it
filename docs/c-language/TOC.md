# [Riferimenti per il linguaggio C](c-language-reference.md)
...
### [Token C](c-tokens.md)
#### [Spazi vuoti](white-space-characters.md)
#### [Commenti C](c-comments.md)
#### [Valutazione di token](evaluation-of-tokens.md)
### [Parole chiave di C](c-keywords.md)
...
##### [Limiti per le costanti a virgola mobile](limits-on-floating-point-constants.md)
...
#### [Direttive per il preprocessore](directives-to-the-preprocessor.md)
...
#### [Riepilogo di durata e di visibilità](summary-of-lifetime-and-visibility.md)
...
### [Panoramica delle dichiarazioni](overview-of-declarations.md)
...
##### [Identificatore di classi di archiviazione static](static-storage-class-specifier.md)
...
#### [Operatori di suffisso](postfix-operators.md)
...
##### [Uso degli operatori di addizione](using-the-additive-operators.md)
...
##### [Conversioni dai tipi integrali con segno](conversions-from-signed-integral-types.md)
##### [Conversioni dai tipi integrali senza segno](conversions-from-unsigned-integral-types.md)
##### [Conversioni dai tipi a virgola mobile](conversions-from-floating-point-types.md)
##### [Conversioni da e verso tipi di puntatore](conversions-to-and-from-pointer-types.md)
...
### [Panoramica delle istruzioni C](overview-of-c-statements.md)
### [Istruzione break (C)](break-statement-c.md)
### [Istruzione composta (C)](compound-statement-c.md)
### [Istruzioni continue (C)](continue-statement-c.md)
...
### [Panoramica delle funzioni](overview-of-functions.md)
...
#### [Funzioni di importazione ed esportazione di DLL](dll-import-and-export-functions.md)
##### [Definizioni e dichiarazioni (C)](definitions-and-declarations-c.md)
##### [Definizione delle funzioni C inline con dllexport e dllimport](defining-inline-c-functions-with-dllexport-and-dllimport.md)
...
##### [Regole e limitazioni per l'uso di funzioni naked](rules-and-limitations-for-using-naked-functions.md)
##### [Considerazioni sulla scrittura di codice Prolog-Epilog](considerations-when-writing-prolog-epilog-code.md)
...
## [Riepilogo della sintassi del linguaggio C](c-language-syntax-summary.md)
### [Definizioni e convenzioni](definitions-and-conventions.md)
### [Grammatica lessicale](lexical-grammar.md)
#### [Riepilogo dei token](summary-of-tokens.md)
#### [Riepilogo delle parole chiave](summary-of-keywords.md)
#### [Riepilogo degli identificatori](summary-of-identifiers.md)
#### [Riepilogo delle costanti](summary-of-constants.md)
#### [Riepilogo dei valori letterali stringa](summary-of-string-literals.md)
#### [Operatori (C)](operators-c.md)
#### [Segni di punteggiatura](punctuators.md)
### [Grammatica di struttura della frase](phrase-structure-grammar.md)
#### [Riepilogo delle espressioni](summary-of-expressions.md)
#### [Riepilogo delle dichiarazioni](summary-of-declarations.md)
#### [Riepilogo delle istruzioni](summary-of-statements.md)
...
#### [Argomenti passati a main](arguments-to-main.md)
...
#### [Dimensioni massime delle matrici](largest-array-size.md)
#### [Sottrazione di puntatori](pointer-subtraction.md)
### [Registri: disponibilità di registri](registers-availability-of-registers.md)
### [Strutture, unioni, enumerazioni e campi di bit](structures-unions-enumerations-and-bit-fields.md)
#### [Accesso non corretto a un'unione](improper-access-to-a-union.md)
#### [Riempimento e allineamento dei membri della struttura](padding-and-alignment-of-structure-members.md)
#### [Segno dei campi di bit](sign-of-bit-fields.md)
#### [Archiviazione dei campi di bit](storage-of-bit-fields.md)
...
### [Istruzioni: limiti per le istruzioni Switch](statements-limits-on-switch-statements.md)
### [Direttive di pre-elaborazione](preprocessing-directives.md)
#### [Costanti carattere e inclusione condizionale](character-constants-and-conditional-inclusion.md)
#### [Inclusione di nomi file tra parentesi](including-bracketed-filenames.md)
#### [Inclusione di nomi file tra virgolette](including-quoted-filenames.md)
#### [Sequenze di caratteri](character-sequences.md)
#### [Pragma](pragmas.md)
#### [Data e ora predefiniti](default-date-and-time.md)
...
#### [Underflow dei valori a virgola mobile](underflow-of-floating-point-values.md)
#### [Funzione fmod](fmod-function.md)
#### [Funzione signal (C)](signal-function-c.md)
#### [Segnali predefiniti](default-signals.md)
#### [Caratteri di nuova riga di terminazione](terminating-newline-characters.md)
#### [Righe vuote](blank-lines.md)
#### [Caratteri Null](null-characters.md)
#### [Posizione nel file in modalità Append](file-position-in-append-mode.md)
#### [Troncamento dei file di testo](truncation-of-text-files.md)
#### [Inserimento nel buffer di file](file-buffering.md)
#### [File di lunghezza zero](zero-length-files.md)
#### [Nomi di file](filenames.md)
#### [Limiti di accesso ai file](file-access-limits.md)
#### [Eliminazione di file aperti](deleting-open-files.md)
#### [Ridenominazione con un nome già esistente](renaming-with-a-name-that-exists.md)
