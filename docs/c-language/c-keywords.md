...
helpviewer_keywords: 
  ...
  - "ridefinizione di parole chiave"
 ...
 **Sezione specifica Microsoft**  
 ...
 Lo standard ANSI C consente agli identificatori con due caratteri di sottolineatura iniziali di essere riservati per le implementazioni del compilatore.  Di conseguenza, la convenzione di Microsoft consiste nel far precedere i nomi delle parole chiave specifiche di Microsoft da un doppio carattere di sottolineatura.  Queste parole non possono essere utilizzate come nomi di identificatori.  Per una descrizione delle regole ANSI per denominare gli identificatori, incluso l'utilizzo del doppio carattere di sottolineatura, vedere [Identificatori](../c-language/c-identifiers.md).  
...
|`dllexport`2|`__inline`|`__leave`||  
 ...
 1.  La parola chiave `__based` ha utilizzi limitati nelle compilazioni di destinazione a 32 bit e a 64 bit.  
  
 2.  Questi sono identificatori speciali se utilizzato con `__declspec` e il relativo utilizzo in altri contesti non è limitato.  
