 ...
 **Sezione specifica Microsoft**  
 ...
 La dimensione massima di una matrice è definita da **size\_t**.  Definito nel file di intestazione STDDEF.H, **size\_t** è `unsigned int` con l'intervallo da 0x00000000 a 0x7CFFFFFF.  
