---
title: Nozioni fondamentali di programmazione Internet MFC | Microsoft Docs
ms.custom: ''
ms.date: 09/12/2018
ms.technology:
- cpp-mfc
...
![Le applicazioni client e server](../mfc/media/vc38bq1.gif "vc38bq1")
