...
Per ulteriori informazioni, vedere [mapping dei messaggi di Windows alla classe della finestra di dialogo](../mfc/mapping-windows-messages-to-your-class.md) .
