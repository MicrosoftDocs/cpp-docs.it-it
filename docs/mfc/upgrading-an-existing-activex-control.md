...
2.  Nel **License pacchetto Authoring Tool** nella finestra di dialogo il **controlli disponibili** casella di riepilogo, selezionare ogni controllo ActiveX che verrà usato nella pagina HTML e fare clic su concesso in licenza **Add**.  
...
2.  Inserire il \<oggetto > tag per il controllo con licenza dopo il tag di gestione delle licenze.  
...
3.  Inserire il \<INCORPORAMENTO > attributo per il file LPK, se si usa il plug-in NCompass ActiveX.  
 ...
 Per altre informazioni sulle licenze dei controlli, vedere [controlli ActiveX: gestione delle licenze di un controllo ActiveX](../mfc/mfc-activex-controls-licensing-an-activex-control.md).  
