...
Viene illustrato come aggiungere un oggetto D2D a un progetto e illustra come usare D2D.

[Procedura dettagliata: aggiunta di animazione a un progetto MFC](../mfc/walkthrough-adding-animation-to-an-mfc-project.md)<br/>
Viene illustrato come aggiungere un oggetto grafico a un progetto e illustra come animare lo.
