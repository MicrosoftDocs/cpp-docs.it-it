...
### [Eccezioni: intercettazione ed eliminazione di eccezioni](exceptions-catching-and-deleting-exceptions.md)
...
### [Eccezioni: eccezioni del database](exceptions-database-exceptions.md)
...
##### [Server di automazione: problemi di durata dell'oggetto](automation-servers-object-lifetime-issues.md)
...
#### [Contenitori: file compositi](containers-compound-files.md)
...
#### [Oggetti dati e origini dati: creazione ed eliminazione definitiva](data-objects-and-data-sources-creation-and-destruction.md)
...
#### [Trascinamento della selezione: implementazione di una destinazione di rilascio](drag-and-drop-implementing-a-drop-target.md)
...
#### [Menu e risorse: aggiunta di contenitori](menus-and-resources-container-additions.md)
#### [Menu e risorse: aggiunta di server](menus-and-resources-server-additions.md)
...
##### [Controlli ActiveX MFC: accesso alle proprietà di ambiente](mfc-activex-controls-accessing-ambient-properties.md)
...
##### [Controlli ActiveX MFC: creazione di una sottoclasse di un controllo Windows](mfc-activex-controls-subclassing-a-windows-control.md)
...
##### [Contenitori di controlli ActiveX: uso dei controlli in un contenitore diverso da una finestra di dialogo](activex-control-containers-using-controls-in-a-non-dialog-container.md)
...
##### [Appunti: operazioni di copia e incolla di dati](clipboard-copying-and-pasting-data.md)
...
#### [Procedura dettagliata: Aggiunta di CTaskDialog in un'applicazione](walkthrough-adding-a-ctaskdialog-to-an-application.md)
...
### [Guida di HTML: Guida sensibile al contesto per i programmi](html-help-context-sensitive-help-for-your-programs.md)
...
#### [Procedura dettagliata: Creazione di un'applicazione barra multifunzione con MFC](walkthrough-creating-a-ribbon-application-by-using-mfc.md)
...
#### [Windows Sockets: socket di datagrammi](windows-sockets-datagram-sockets.md)
#### [Windows Sockets: uso di socket con archivi](windows-sockets-using-sockets-with-archives.md)
#### [Windows Sockets: sequenza delle operazioni](windows-sockets-sequence-of-operations.md)
...
#### [Windows Sockets: derivazione da classi socket](windows-sockets-deriving-from-socket-classes.md)
#### [Windows Sockets: notifiche dei socket](windows-sockets-socket-notifications.md)
#### [Windows Sockets: blocco](windows-sockets-blocking.md)
#### [Windows Sockets: ordine dei byte](windows-sockets-byte-ordering.md)
...
## [TN029: finestre con barre di divisione](tn029-splitter-windows.md)
...
## [TN046: convenzioni dei commenti per le classi MFC](tn046-commenting-conventions-for-the-mfc-classes.md)
## [TN047: rilascio dei requisiti di transazione database](tn047-relaxing-database-transaction-requirements.md)
## [TN048: scrittura di programmi di amministrazione e installazione ODBC per applicazioni di database MFC](tn048-writing-odbc-setup-and-administration-programs.md)
...
## [TN053: routine DFX personalizzate per le classi di database DAO](tn053-custom-dfx-routines-for-dao-database-classes.md)
## [TN054: chiamata diretta a DAO durante l'uso delle classi DAO MFC](tn054-calling-dao-directly-while-using-mfc-dao-classes.md)
## [TN055: migrazione di applicazioni di classi di database ODBC MFC a classi DAO MFC](tn055-migrating-mfc-odbc-database-class-applications-to-mfc-dao-classes.md)
...
## [TN059: uso di macro di conversione MFC MBCS-Unicode](tn059-using-mfc-mbcs-unicode-conversion-macros.md)
...
## [TN062: reflection di messaggi per controlli Windows](tn062-message-reflection-for-windows-controls.md)
## [TN063: debug di DLL di estensioni MFC per Internet](tn063-debugging-internet-extension-dlls.md)
## [TN064: threading di modello di apartment nei controlli ActiveX](tn064-apartment-model-threading-in-activex-controls.md)
## [TN065: supporto di doppia interfaccia per i server di automazione OLE](tn065-dual-interface-support-for-ole-automation-servers.md)
## [TN066: problemi comuni di portabilità da MFC 3.x a 4.0](tn066-common-mfc-3-x-to-4-0-porting-issues.md)
...
## [TN070: nomi delle classi di finestra MFC](tn070-mfc-window-class-names.md)
...
## [Classe radice: CObject](root-class-cobject.md)
...
## [Procedura dettagliata: Inserimento di controlli sulle barre degli strumenti](walkthrough-putting-controls-on-toolbars.md)
