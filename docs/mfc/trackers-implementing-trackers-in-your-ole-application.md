...
L'articolo illustra anche l'uso degli stili dagli strumenti di rilevamento. Inoltre, rende diversi documenti di riferimento per l'esempio OLE MFC [OCLIENT](../overview/visual-cpp-samples.md).
