...
Utilizzare classe `CMenu` per modificare i menu e voci di menu in tempo reale. `CMenu`Incapsula un Windows `HMENU` gestire e fornisce funzioni membro per l'uso dei menu.  
