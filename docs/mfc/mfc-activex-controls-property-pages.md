...
2.  Usare l'editor finestre per aggiungere controlli al modello di pagina di proprietà.  
...
2.  Fare doppio clic il **dialogo** icona directory.  
...
5.  Per questo esempio, un testo controllo etichetta "didascalia:" e un controllo casella di modifica con un identificatore IDC_CAPTION sono sufficienti.  
