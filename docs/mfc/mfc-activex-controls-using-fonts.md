---
title: 'Controlli ActiveX MFC: Utilizzo di tipi di carattere | Microsoft Docs'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
5.  Nel **nome della proprietà** fare clic su **Font**.  
...
5.  Nel **nome della proprietà** , digitare un nome per la proprietà. Per questo esempio, usare **HeadingFont**.  
  
6.  Per **Tipo di implementazione**, fare clic su **Metodi Get/Set**.  
  
7.  Nel **tipo di proprietà** , quindi selezionare **IDispatch** <strong>\*</strong> per il tipo della proprietà.  
...
###  <a name="_core_processing_font_notifications"></a> Elaborazione delle notifiche di tipo di carattere  
 ...
 ![Implementare più interfacce dell'oggetto font](../mfc/media/vc373q1.gif "vc373q1")  
