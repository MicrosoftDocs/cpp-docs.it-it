...
3.  Nel **file di tipo** , quindi selezionare **tutti i file (\*.\*)** .  
  
4.  Nella casella di riepilogo di file, fare doppio clic il. File IDL che si desidera inserire nel progetto.  
  
5.  Fare clic su **aperto** dopo avere aggiunto tutte le necessarie. File IDL.  
