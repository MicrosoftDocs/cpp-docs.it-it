...
- [Aggiunta di controlli a una finestra delle proprietà](../mfc/adding-controls-to-a-property-sheet.md) (invece di una pagina delle proprietà)

- [Lo scambio di dati tra una finestra delle proprietà e il programma](../mfc/exchanging-data.md)
