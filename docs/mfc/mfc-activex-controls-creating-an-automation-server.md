...
1. Eseguire l'override [IsInvokeAllowed](../mfc/reference/colecontrol-class.md#isinvokeallowed). Per altre informazioni, vedere l'articolo della Knowledge Base Q146120.
