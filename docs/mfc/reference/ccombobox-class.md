...
## <a name="remarks"></a>Note  
 ...
 La tabella seguente confronta la casella combinata tre [stili](../../mfc/reference/combo-box-styles.md).  
...
|Elenco a discesa|Quando eliminato verso il basso|Statico|  
 ...
 È possibile creare un `CComboBox` oggetto da un modello di finestra di dialogo o direttamente nel codice. In entrambi i casi, chiamare prima il costruttore `CComboBox` per costruire la `CComboBox` dell'oggetto, quindi chiamare il [crea](#create) funzione membro per creare il controllo e associarlo alla `CComboBox` oggetto.  
...
- **ON_CBN_CLOSEUP** (Windows 3.1 e versioni successive). La casella di riepilogo di una casella combinata è chiuso. Questo messaggio di notifica non verrà inviato per una casella combinata con la [CBS_SIMPLE](../../mfc/reference/combo-box-styles.md) stile.  
  
- **ON_CBN_DBLCLK** l'utente fa doppio clic su una stringa nella casella di riepilogo di una casella combinata. Questo messaggio di notifica verrà inviato solo per una casella combinata con la **CBS_SIMPLE** stile. Per una casella combinata con la [CBS_DROPDOWN](../../mfc/reference/combo-box-styles.md) o [CBS_DROPDOWNLIST](../../mfc/reference/combo-box-styles.md) stile, non è possibile eseguire un doppio clic in quanto un solo clic nasconde la casella di riepilogo.  
...
### <a name="remarks"></a>Note  
 ...
 Quando **crea** esegue, Windows invia il [WM_NCCREATE](../../mfc/reference/cwnd-class.md#onnccreate), [WM_CREATE](../../mfc/reference/cwnd-class.md#oncreate), [WM_NCCALCSIZE](../../mfc/reference/cwnd-class.md#onnccalcsize), e [WM_GETMINMAXINFO](../../mfc/reference/cwnd-class.md#ongetminmaxinfo) messaggi alla casella combinata.  
...
### <a name="remarks"></a>Note  
 Se la casella combinata è stata creata con uno stile di disegno personalizzato, ma senza il [CBS_HASSTRINGS](../../mfc/reference/combo-box-styles.md) stile, `FindStringExact` tenta di ottenere il valore della parola doppia rispetto al valore di `lpszFind`.  
...
### <a name="remarks"></a>Note  
 Questa funzione membro emula la funzionalità del [CB_GETCOMBOBOXINFO](http://msdn.microsoft.com/library/windows/desktop/bb775839) del messaggio, come descritto nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Note  
 ...
 Questo metodo invia il [CB_GETCUEBANNER](http://msdn.microsoft.com/library/windows/desktop/bb775843) messaggio, come descritto nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="getdroppedcontrolrect"></a>CComboBox::GetDroppedControlRect  
 Chiamare il `GetDroppedControlRect` la funzione membro per recuperare le coordinate dello schermo della finestra visibile (eliminato) elenco a discesa di una casella combinata a discesa.  
...
### <a name="example"></a>Esempio  
 [!code-cpp[NVC_MFC_CComboBox n. 16](../../mfc/reference/codesnippet/cpp/ccombobox-class_16.cpp)]  
...
-   Fare clic sul controllo statico Visualizza una casella di riepilogo solo per le caselle combinate con il [CBS_DROPDOWNLIST](../../mfc/reference/combo-box-styles.md) stile.  
...
### <a name="example"></a>Esempio  
 [!code-cpp[NVC_MFC_CComboBox n. 20](../../mfc/reference/codesnippet/cpp/ccombobox-class_20.cpp)]  
...
### <a name="example"></a>Esempio  
 [!code-cpp[N. 22 NVC_MFC_CComboBox](../../mfc/reference/codesnippet/cpp/ccombobox-class_22.cpp)]  
  
##  <a name="getitemheight"></a>CComboBox::GetItemHeight  
 Chiamare il `GetItemHeight` la funzione membro per recuperare l'altezza degli elementi di elenco in una casella combinata.  
...
### <a name="parameters"></a>Parametri  
 `nIndex`  
 Specifica il componente della casella combinata è necessario recuperare la cui altezza. Se il `nIndex` parametro è -1, viene recuperato l'altezza della parte di controllo di modifica (o testo statico) della casella combinata. Se la casella combinata di [CBS_OWNERDRAWVARIABLE](../../mfc/reference/combo-box-styles.md) stile, `nIndex` specifica l'indice in base zero dell'elemento di elenco, è necessario recuperare la cui altezza. In caso contrario, `nIndex` deve essere impostato su 0.  
...
### <a name="example"></a>Esempio  
 [!code-cpp[N. 23 NVC_MFC_CComboBox](../../mfc/reference/codesnippet/cpp/ccombobox-class_23.cpp)]  
...
### <a name="example"></a>Esempio  
 [!code-cpp[N. 24 NVC_MFC_CComboBox](../../mfc/reference/codesnippet/cpp/ccombobox-class_24.cpp)]  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [CB_GETMINVISIBLE](http://msdn.microsoft.com/library/windows/desktop/bb775915) messaggio, come descritto nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Note  
 Chiamare questa funzione prima di aggiungere un numero elevato di elementi nella parte della casella di riepilogo il `CComboBox`.  
...
### <a name="example"></a>Esempio  
 [!code-cpp[N. 26 NVC_MFC_CComboBox](../../mfc/reference/codesnippet/cpp/ccombobox-class_26.cpp)]  
...
### <a name="example"></a>Esempio  
 [!code-cpp[N. 27 NVC_MFC_CComboBox](../../mfc/reference/codesnippet/cpp/ccombobox-class_27.cpp)]  
...
### <a name="remarks"></a>Note  
 Se la casella combinata non ha lo stile [CBS_AUTOHSCROLL](../../mfc/reference/combo-box-styles.md), l'impostazione del limite di testo per essere più grande della dimensione del controllo di modifica non avrà effetto.  
...
### <a name="example"></a>Esempio  
 [!code-cpp[N. 28 NVC_MFC_CComboBox](../../mfc/reference/codesnippet/cpp/ccombobox-class_28.cpp)]  
...
### <a name="example"></a>Esempio  
 [!code-cpp[N. 29 NVC_MFC_CComboBox](../../mfc/reference/codesnippet/cpp/ccombobox-class_29.cpp)]  
...
### <a name="example"></a>Esempio  
 [!code-cpp[N. 30 NVC_MFC_CComboBox](../../mfc/reference/codesnippet/cpp/ccombobox-class_30.cpp)]  
...
### <a name="example"></a>Esempio  
 [!code-cpp[N. 31 NVC_MFC_CComboBox](../../mfc/reference/codesnippet/cpp/ccombobox-class_31.cpp)]  
...
### <a name="example"></a>Esempio  
 [!code-cpp[N. 32 NVC_MFC_CComboBox](../../mfc/reference/codesnippet/cpp/ccombobox-class_32.cpp)]  
...
### <a name="remarks"></a>Note  
 ...
 Questo metodo invia il [CB_SETCUEBANNER](http://msdn.microsoft.com/library/windows/desktop/bb775897) messaggio, come descritto nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="setextendedui"></a>CComboBox::SetExtendedUI  
 Chiamare il `SetExtendedUI` la funzione membro per selezionare l'interfaccia utente predefinita o l'interfaccia utente estesa per una casella combinata con la [CBS_DROPDOWN](../../mfc/reference/combo-box-styles.md) o [CBS_DROPDOWNLIST](../../mfc/reference/combo-box-styles.md) stile.  
...
##  <a name="setitemheight"></a>CComboBox::SetItemHeight  
 Chiamare il `SetItemHeight` la funzione membro per impostare l'altezza degli elementi dell'elenco in una casella combinata o l'altezza della parte di una casella combinata controllo di modifica (o testo statico).  
...
### <a name="parameters"></a>Parametri  
 ...
 Se la casella combinata di [CBS_OWNERDRAWVARIABLE](../../mfc/reference/combo-box-styles.md) stile, `nIndex` specifica l'indice in base zero dell'elemento di elenco il cui altezza è impostato; in caso contrario, `nIndex` deve essere 0 e l'altezza dell'elenco di tutti gli elementi verranno impostati.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [CB_SETMINVISIBLE](http://msdn.microsoft.com/library/windows/desktop/bb775915) messaggio, come descritto nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Note  
 Il sistema consente di scorrere la casella di riepilogo fino a quando l'elemento specificato da `nIndex` viene visualizzata nella parte superiore dell'elenco è stato raggiunto casella o l'intervallo di scorrimento massimo.  
...
### <a name="remarks"></a>Note  
 ...
 Questa funzione membro non ha alcun effetto su una casella combinata creata con la [CBS_SIMPLE](../../mfc/reference/combo-box-styles.md) stile.  
