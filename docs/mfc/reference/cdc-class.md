---
description: 'Ulteriori informazioni su: classe CDC'
title: CDC (classe)
ms.date: 11/19/2018
f1_keywords:
- CDC
...
Restituisce 0 in caso di errore. Per informazioni dettagliate sull'errore, chiamare [GetLastError](/windows/win32/api/errhandlingapi/nf-errhandlingapi-getlasterror).
...
In caso di esito negativo, GDI_ERROR. Per informazioni dettagliate sull'errore, chiamare [GetLastError](/windows/win32/api/errhandlingapi/nf-errhandlingapi-getlasterror).
