...
|Nome|Descrizione|  
|----------|-----------------|  
|[CHtmlEditCtrlBase::AddToGlyphTable](#addtoglyphtable)|Aggiunge una voce alla tabella del glifo, che specifica le immagini da visualizzare per tag specifici in modalità progettazione.|  
|[CHtmlEditCtrlBase::Bold](#bold)|Alterna lo stato in grassetto del testo selezionato.|  
|[CHtmlEditCtrlBase::Button](#button)|Sovrascrive un controllo pulsante per la selezione corrente.|  
...
|[CHtmlEditCtrlBase::EmptyGlyphTable](#emptyglyphtable)|Rimuove tutte le voci della tabella glifo, che nasconde tutte le immagini visualizzate per i tag in modalità progettazione.|  
...
|[CHtmlEditCtrlBase::GetBlockFormatNames](#getblockformatnames)|Recupera le stringhe che corrispondono ai tag di formato di blocchi disponibili.|  
...
|[CHtmlEditCtrlBase::GetShowAlignedSiteTags](#getshowalignedsitetags)|Restituisce se viene visualizzata un'icona per tutti gli elementi con un **styleFloat** proprietà.|  
|[CHtmlEditCtrlBase::GetShowAllTags](#getshowalltags)|Restituisce se il controllo WebBrowser visualizzare le icone per mostrare la posizione di tutti i tag in un documento.|  
...
|[CHtmlEditCtrlBase::GetShowMiscTags](#getshowmisctags)|Specifica se il controllo WebBrowser visualizza tutti i tag mostrati in Microsoft Internet Explorer 4.0.|  
...
|[CHtmlEditCtrlBase::HorizontalLine](#horizontalline)|Sovrascrive una riga orizzontale sulla selezione corrente.|  
...
|[CHtmlEditCtrlBase::InsInputUpload](#insinputupload)|Sovrascrive un controllo caricamento file sulla selezione corrente.|  
...
|[CHtmlEditCtrlBase::JustifyCenter](#justifycenter)|Centra il blocco di formato in cui la selezione corrente si trova.|  
|[CHtmlEditCtrlBase::JustifyLeft](#justifyleft)|Allinea a sinistra del blocco di formato in cui la selezione corrente si trova.|  
|[CHtmlEditCtrlBase::JustifyRight](#justifyright)|Allinea a destra il blocco di formato in cui la selezione corrente si trova.|  
|[CHtmlEditCtrlBase::ListBox](#listbox)|Sovrascrive un controllo di selezione di casella di riepilogo sulla selezione corrente.|  
|[CHtmlEditCtrlBase::Marquee](#marquee)|Sovrascrive un perimetro vuoto nella selezione corrente.|  
...
|[CHtmlEditCtrlBase::Outdent](#outdent)|Riduce di un incremento il rientro del blocco del formato in cui la selezione corrente si trova.|  
|[CHtmlEditCtrlBase::Paragraph](#paragraph)|Sovrascrive un'interruzione di riga sulla selezione corrente.|  
...
|[CHtmlEditCtrlBase::SetAbsolutePosition](#setabsoluteposition)|Imposta proprietà posizione di un elemento "assoluto" o "statico".|  
...
|[CHtmlEditCtrlBase::SetBookMark](#setbookmark)|Crea un ancoraggio di segnalibro per il punto di selezione oppure dall'inserimento corrente.|  
...
|[CHtmlEditCtrlBase::SetShowAlignedSiteTags](#setshowalignedsitetags)|Viene visualizzata un'icona per tutti gli elementi con un **styleFloat** proprietà.|  
|[CHtmlEditCtrlBase::SetShowAllTags](#setshowalltags)|Visualizzare le icone per mostrare la posizione di tutti i tag in un documento.|  
...
|[CHtmlEditCtrlBase::TextBox](#textbox)|Sovrascrive un controllo di testo per la selezione corrente.|  
...
##  <a name="addtoglyphtable"></a>  CHtmlEditCtrlBase::AddToGlyphTable  
 Aggiunge una voce alla tabella del glifo, che specifica le immagini da visualizzare per tag specifici in modalità progettazione.  
 ...
 *nTagType*  
 Tipo di tag: 0 indica che l'immagine è per solo il tag di apertura. 1 indica che l'immagine è solo il tag di chiusura. 2 indica che l'immagine è per i tag di apertura e chiusura. Singolo tag, ad esempio br e commento devono essere aggiunti con il tipo di tag impostato su 0.  
  
 *nAlignment*  
 Allineamento (solo elementi rettangolari): questo parametro indica che l'immagine è per un elemento con un attributo di allineamento. A sinistra = 0, center = 1, a destra = 2 e undefined = 3. A sinistra, destra o attributi center devono essere impostata esplicitamente sull'elemento.  
  
 *nPosInfo*  
 Informazioni sul posizionamento. Determina lo stile CSS fogli valore posizionamento (CSS) dell'icona sono applicati, dove statico posizionamento = 0, il posizionamento assoluto = 1, il posizionamento relativo = 2 e tutti i = 3. Questo campo consente di specificare un glifo per un tag non posizionato e un'altra icona per visualizzare un punto di ancoraggio quando il tag è posizionato.  
  
 *nDirection*  
 La direzione. Questo parametro specifica l'immagine di un tag in base all'ordine di lettura della lingua corrente. 0 specifica da sinistra a destra, il valore 1 specifica da destra a sinistra, 2 specifica alto verso il basso, 3 specifica dal basso verso l'alto e 4 specifica tutti i. Questo campo in genere impostato a 4.  
...
### <a name="return-value"></a>Valore restituito  
 Restituisce S_OK se l'operazione riesce, o un valore HRESULT dell'errore in caso di errore.  
  
### <a name="remarks"></a>Note  
 Per ulteriori informazioni sui parametri, vedere "Glifo tabella stringa di formato" nella [glifi di modifica utilizzando](https://msdn.microsoft.com/library/aa969614.aspx).  
  
 Questo metodo invia il [ID di comando IDM_ADDTOGLYPHTABLE](https://msdn.microsoft.com/library/aa769891.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_BOLD](https://msdn.microsoft.com/library/aa769861.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_BUTTON](https://msdn.microsoft.com/library/aa769966.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_CHECKBOX](https://msdn.microsoft.com/library/aa769972.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_CLEARSELECTION](https://msdn.microsoft.com/library/aa770038.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_COPY](https://msdn.microsoft.com/library/aa769872.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_CUT](https://msdn.microsoft.com/library/aa769875.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_DELETE](https://msdn.microsoft.com/library/aa769876.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_DROPDOWNBOX](https://msdn.microsoft.com/library/aa769984.aspx) al controllo WebBrowser.  
  
##  <a name="emptyglyphtable"></a>  CHtmlEditCtrlBase::EmptyGlyphTable  
 Rimuove tutte le voci della tabella glifo, che nasconde tutte le immagini visualizzate per i tag in modalità progettazione.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_EMPTYGLYPHTABLE](https://msdn.microsoft.com/library/aa769907.aspx) al controllo WebBrowser.  
 ...
 *cmdExecOpt*  
 Valori ricavati dal [OLECMDEXECOPT](http://msdn.microsoft.com/library/windows/desktop/ms683930) enumerazione, che descrivono come l'oggetto deve eseguire il comando.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_FONT](https://msdn.microsoft.com/library/aa769913.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Per altre informazioni, vedere [ID di comando IDM_ABSOLUTE_POSITION](https://msdn.microsoft.com/library/aa769889.aspx).  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_BACKCOLOR](https://msdn.microsoft.com/library/aa769858.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_BLOCKFMT](https://msdn.microsoft.com/library/aa769883.aspx) al controllo WebBrowser.  
  
##  <a name="getblockformatnames"></a>  CHtmlEditCtrlBase::GetBlockFormatNames  
 Recupera le stringhe che corrispondono ai tag di formato di blocchi disponibili.  
...
### <a name="remarks"></a>Note  
 Per altre informazioni, vedere [ID di comando IDM_BOOKMARK](https://msdn.microsoft.com/library/aa769873.aspx).  
...
### <a name="remarks"></a>Note  
 Se la selezione corrente viene utilizzato più di un tipo di carattere *cioè strFace* sarà una stringa vuota.  
  
 Questo metodo invia il [ID di comando IDM_FONTNAME](https://msdn.microsoft.com/library/aa769880.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_FONTSIZE](https://msdn.microsoft.com/library/aa769881.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_FORECOLOR](https://msdn.microsoft.com/library/aa769882.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_GETFRAMEZONE](https://msdn.microsoft.com/library/aa769916.aspx) al controllo WebBrowser.  
...
##  <a name="getshowalignedsitetags"></a>  CHtmlEditCtrlBase::GetShowAlignedSiteTags  
 Restituisce se viene visualizzata un'icona per tutti gli elementi con un **styleFloat** proprietà.  
...
### <a name="parameters"></a>Parametri  
 *bCurValue*  
 True se viene visualizzata un'icona per tutti gli elementi con un **styleFloat** proprietà; false se viene visualizzata alcuna icona.  
  
### <a name="return-value"></a>Valore restituito  
 Restituisce S_OK se l'operazione riesce, o un valore HRESULT dell'errore in caso di errore.  
  
### <a name="remarks"></a>Note  
 Per altre informazioni, vedere [ID di comando IDM_SHOWALIGNEDSITETAGS](https://msdn.microsoft.com/library/aa769947.aspx).  
  
##  <a name="getshowalltags"></a>  CHtmlEditCtrlBase::GetShowAllTags  
 Restituisce se il controllo WebBrowser visualizzare le icone per mostrare la posizione di tutti i tag in un documento.  
...
### <a name="parameters"></a>Parametri  
 *bCurValue*  
 True se il controllo WebBrowser visualizzare le icone per mostrare la posizione di tutti i tag in un documento. false se non esiste.  
  
### <a name="return-value"></a>Valore restituito  
 Restituisce S_OK se l'operazione riesce, o un valore HRESULT dell'errore in caso di errore.  
  
### <a name="remarks"></a>Note  
 Per altre informazioni, vedere [ID di comando IDM_SHOWALLTAGS](https://msdn.microsoft.com/library/aa769948.aspx).  
...
### <a name="parameters"></a>Parametri  
 *bCurValue*  
 True se il controllo WebBrowser viene visualizzata un'icona per i tag di area, false in caso contrario.  
  
### <a name="return-value"></a>Valore restituito  
 Restituisce S_OK se l'operazione riesce, o un valore HRESULT dell'errore in caso di errore.  
  
### <a name="remarks"></a>Note  
 Per altre informazioni, vedere [ID di comando IDM_SHOWAREATAGS](https://msdn.microsoft.com/library/aa769949.aspx).  
...
### <a name="remarks"></a>Note  
 Per altre informazioni, vedere [ID di comando IDM_SHOWWBRTAGS](https://msdn.microsoft.com/library/aa769956.aspx).  
...
### <a name="remarks"></a>Note  
 Per altre informazioni, vedere [ID di comando IDM_SHOWCOMMENTTAGS](https://msdn.microsoft.com/library/aa769950.aspx).  
  
##  <a name="getshowmisctags"></a>  CHtmlEditCtrlBase::GetShowMiscTags  
 Specifica se il controllo WebBrowser visualizza tutti i tag mostrati in Microsoft Internet Explorer 4.0.  
...
### <a name="remarks"></a>Note  
 Per altre informazioni, vedere [ID di comando IDM_SHOWMISCTAGS](https://msdn.microsoft.com/library/aa769952.aspx).  
...
### <a name="remarks"></a>Note  
 Per altre informazioni, vedere [ID di comando IDM_SHOWSCRIPTTAGS](https://msdn.microsoft.com/library/aa769953.aspx).  
...
### <a name="parameters"></a>Parametri  
 *bCurValue*  
 True se il controllo WebBrowser viene visualizzata un'icona per tutti i tag di stile, false se non esiste  
  
### <a name="return-value"></a>Valore restituito  
 Restituisce S_OK se l'operazione riesce, o un valore HRESULT dell'errore in caso di errore.  
  
### <a name="remarks"></a>Note  
 Per altre informazioni, vedere [ID di comando IDM_SHOWSTYLETAGS](https://msdn.microsoft.com/library/aa769954.aspx).  
...
### <a name="remarks"></a>Note  
 Per altre informazioni, vedere [ID di comando IDM_SHOWUNKNOWNTAGS](https://msdn.microsoft.com/library/aa769955.aspx).  
  
##  <a name="horizontalline"></a>  CHtmlEditCtrlBase::HorizontalLine  
 Sovrascrive una riga orizzontale sulla selezione corrente.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_HORIZONTALLINE](https://msdn.microsoft.com/library/aa769968.aspx) al controllo WebBrowser.  
...
### <a name="parameters"></a>Parametri  
 *szUrl*  
 L'URL del collegamento ipertestuale.  
  
### <a name="return-value"></a>Valore restituito  
 Restituisce S_OK se l'operazione riesce, o un valore HRESULT dell'errore in caso di errore.  
  
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_HYPERLINK](https://msdn.microsoft.com/library/aa769874.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_IE50_PASTE](https://msdn.microsoft.com/library/aa769922.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_IFRAME](https://msdn.microsoft.com/library/aa769969.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_IMAGE](https://msdn.microsoft.com/library/aa769970.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_INDENT](https://msdn.microsoft.com/library/aa769963.aspx) al controllo WebBrowser.  
...
### <a name="parameters"></a>Parametri  
 *IDdm*  
 L'ID per la finestra.  
  
### <a name="return-value"></a>Valore restituito  
 Restituisce S_OK se l'operazione riesce, o un valore HRESULT dell'errore in caso di errore.  
  
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_INSFIELDSET](https://msdn.microsoft.com/library/aa769967.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_INSINPUTBUTTON](https://msdn.microsoft.com/library/aa769971.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_INSINPUTHIDDEN](https://msdn.microsoft.com/library/aa769974.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_INSINPUTIMAGE](https://msdn.microsoft.com/library/aa769975.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_INSINPUTPASSWORD](https://msdn.microsoft.com/library/aa769976.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_INSINPUTRESET](https://msdn.microsoft.com/library/aa769978.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_INSINPUTSUBMIT](https://msdn.microsoft.com/library/aa769979.aspx) al controllo WebBrowser.  
  
##  <a name="insinputupload"></a>  CHtmlEditCtrlBase::InsInputUpload  
 Sovrascrive un controllo caricamento file sulla selezione corrente.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_INSINPUTUPLOAD](https://msdn.microsoft.com/library/aa769973.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_1D_ELEMENT](https://msdn.microsoft.com/library/aa769885.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_2D_ELEMENT](https://msdn.microsoft.com/library/aa769886.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_ITALIC](https://msdn.microsoft.com/library/aa769988.aspx) al controllo WebBrowser.  
  
##  <a name="justifycenter"></a>  CHtmlEditCtrlBase::JustifyCenter  
 Centra il blocco di formato in cui la selezione corrente si trova.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_JUSTIFYCENTER](https://msdn.microsoft.com/library/aa769989.aspx) al controllo WebBrowser.  
  
##  <a name="justifyleft"></a>  CHtmlEditCtrlBase::JustifyLeft  
 Allinea a sinistra del blocco di formato in cui la selezione corrente si trova.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_JUSTIFYLEFT](https://msdn.microsoft.com/library/aa770011.aspx) al controllo WebBrowser.  
  
##  <a name="justifyright"></a>  CHtmlEditCtrlBase::JustifyRight  
 Allinea a destra il blocco di formato in cui la selezione corrente si trova.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_JUSTIFYRIGHT](https://msdn.microsoft.com/library/aa770013.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_LISTBOX](https://msdn.microsoft.com/library/aa769985.aspx) al controllo WebBrowser.  
  
##  <a name="marquee"></a>  CHtmlEditCtrlBase::Marquee  
 Sovrascrive un perimetro vuoto nella selezione corrente.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_MARQUEE](https://msdn.microsoft.com/library/aa769981.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_ORDERLIST](https://msdn.microsoft.com/library/aa769982.aspx) al controllo WebBrowser.  
  
##  <a name="outdent"></a>  CHtmlEditCtrlBase::Outdent  
 Riduce di un incremento il rientro del blocco del formato in cui la selezione corrente si trova.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_OUTDENT](https://msdn.microsoft.com/library/aa770015.aspx) al controllo WebBrowser.  
  
##  <a name="paragraph"></a>  CHtmlEditCtrlBase::Paragraph  
 Sovrascrive un'interruzione di riga sulla selezione corrente.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_PARAGRAPH](https://msdn.microsoft.com/library/aa769983.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_PASTE](https://msdn.microsoft.com/library/aa770017.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_PRINT](https://msdn.microsoft.com/library/aa769937.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_PRINTPREVIEW](https://msdn.microsoft.com/library/aa769938.aspx) al controllo WebBrowser.  
...
### <a name="parameters"></a>Parametri  
 *cmdID*  
 ID di comando. Identificatori di comando vengono prelevati i `CGID_MSHTML` del gruppo di comandi. Questi comandi sono definiti in Mshtmcid.h. È inoltre possibile trovare l'elenco in corrispondenza [MSHTML comando identificatori](http://go.microsoft.com/fwlink/p/?linkid=149220).  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_RADIOBUTTON](https://msdn.microsoft.com/library/aa769977.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_REFRESH](https://msdn.microsoft.com/library/aa770020.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_REMOVEFORMAT](https://msdn.microsoft.com/library/aa770021.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_SELECTALL](https://msdn.microsoft.com/library/aa770025.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_2D_POSITION](https://msdn.microsoft.com/library/aa769887.aspx) al controllo WebBrowser.  
  
##  <a name="setabsoluteposition"></a>  CHtmlEditCtrlBase::SetAbsolutePosition  
 Imposta proprietà posizione di un elemento "assoluto" o "statico".  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_ABSOLUTE_POSITION](https://msdn.microsoft.com/library/aa769889.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_ATOMICSELECTION](https://msdn.microsoft.com/library/aa769892.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_AUTOURLDETECT_MODE](https://msdn.microsoft.com/library/aa769893.aspx) al controllo WebBrowser.  
...
### <a name="parameters"></a>Parametri  
 *nColor*  
 Il colore. Vedere *pvaIn* in [ID comando IDM_BACKCOLOR](https://msdn.microsoft.com/library/aa769858.aspx).  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_BACKCOLOR_](https://msdn.microsoft.com/library/aa769858.aspx) al controllo WebBrowser.  
...
##  <a name="setbookmark"></a>  CHtmlEditCtrlBase::SetBookMark  
 Crea un ancoraggio di segnalibro per il punto di selezione oppure dall'inserimento corrente.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_BOOKMARK](https://msdn.microsoft.com/library/aa769873.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_CSSEDITING_LEVEL](https://msdn.microsoft.com/library/aa769903.aspx) al controllo WebBrowser.  
...
### <a name="parameters"></a>Parametri  
 *bNewValue*  
 Se true, disabilita il bordo tratteggiato e gli handle intorno a un elemento selezionabile sito quando l'elemento ha "modifica lo stato attivo" in modalità progettazione. vale a dire, quando il contenuto dell'elemento o il testo può essere modificato.  
  
### <a name="return-value"></a>Valore restituito  
 Restituisce S_OK se l'operazione riesce, o un valore HRESULT dell'errore in caso di errore.  
  
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM_DISABLE_EDITFOCUS_UI](https://msdn.microsoft.com/library/aa769905.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando FONTNAME IDM](https://msdn.microsoft.com/library/aa769880.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM FONTSIZE](https://msdn.microsoft.com/library/aa769881.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM FORECOLOR](https://msdn.microsoft.com/library/aa769882.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM IE50_PASTE_MODE](https://msdn.microsoft.com/library/aa769923.aspx) al controllo WebBrowser.  
  
##  <a name="setliveresize"></a>  CHtmlEditCtrlBase::SetLiveResize  
 Fa sì che il controllo WebBrowser aggiornare l'aspetto di un elemento in modo continuo durante un'operazione di ridimensionamento o spostamento, anziché aggiornare solo al termine dello spostamento o ridimensionare.  
...
### <a name="parameters"></a>Parametri  
 *bNewValue*  
 Se true, fa sì che il controllo WebBrowser aggiornare l'aspetto di un elemento in modo continuo durante un'operazione di ridimensionamento o spostamento. Se false, viene aggiornato solo al termine del ridimensionamento o spostamento.  
  
### <a name="return-value"></a>Valore restituito  
 Restituisce S_OK se l'operazione riesce, o un valore HRESULT dell'errore in caso di errore.  
  
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM LIVERESIZE](https://msdn.microsoft.com/library/aa769928.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM MULTIPLESELECTION](https://msdn.microsoft.com/library/aa769929.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM OVERRIDE_CURSOR](https://msdn.microsoft.com/library/aa769932.aspx) al controllo WebBrowser.  
...
### <a name="parameters"></a>Parametri  
 *bNewValue*  
 Se true, tutti gli elementi che hanno una visibilità impostato su "hidden" o visualizzare il set di proprietà su "none" non risulterà in modalità di progettazione e in modalità browse. Se false, tali elementi verranno visualizzati solo in modalità browse.  
  
### <a name="return-value"></a>Valore restituito  
 Restituisce S_OK se l'operazione riesce, o un valore HRESULT dell'errore in caso di errore.  
  
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM RESPECTVISIBILITY_INDESIGN](https://msdn.microsoft.com/library/aa770023.aspx) al controllo WebBrowser.  
  
##  <a name="setshowalignedsitetags"></a>  CHtmlEditCtrlBase::SetShowAlignedSiteTags  
 Viene visualizzata un'icona per tutti gli elementi con un **styleFloat** proprietà.  
...
### <a name="parameters"></a>Parametri  
 *bNewValue*  
 Se true, viene visualizzata un'icona per tutti gli elementi con un **styleFloat** proprietà.  
  
### <a name="return-value"></a>Valore restituito  
 Restituisce S_OK se l'operazione riesce, o un valore HRESULT dell'errore in caso di errore.  
  
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM SHOWALIGNEDSITETAGS](https://msdn.microsoft.com/library/aa769947.aspx) al controllo WebBrowser.  
  
##  <a name="setshowalltags"></a>  CHtmlEditCtrlBase::SetShowAllTags  
 Visualizzare le icone per mostrare la posizione di tutti i tag in un documento.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM SHOWALLTAGS](https://msdn.microsoft.com/library/aa769948.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM SHOWAREATAGS](https://msdn.microsoft.com/library/aa769949.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM SHOWWBRTAGS](https://msdn.microsoft.com/library/aa769956.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM SHOWCOMMENTTAGS](https://msdn.microsoft.com/library/aa769950.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM SHOWMISCTAGS](https://msdn.microsoft.com/library/aa769952.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM SHOWSCRIPTTAGS](https://msdn.microsoft.com/library/aa769953.aspx) al controllo WebBrowser.  
  
##  <a name="setshowstyletags"></a>  CHtmlEditCtrlBase::SetShowStyleTags  
 Consente di visualizzare un glifo per tutti i tag di stile.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM SHOWSTYLETAGS](https://msdn.microsoft.com/library/aa769954.aspx) al controllo WebBrowser.  
  
##  <a name="setshowunknowntags"></a>  CHtmlEditCtrlBase::SetShowUnknownTags  
 Consente di visualizzare un glifo per tutti i tag sconosciuti.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM SHOWUNKNOWNTAGS](https://msdn.microsoft.com/library/aa769955.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM TEXTAREA](https://msdn.microsoft.com/library/aa769986.aspx) al controllo WebBrowser.  
  
##  <a name="textbox"></a>  CHtmlEditCtrlBase::TextBox  
 Sovrascrive un controllo di testo per la selezione corrente.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM TEXTBOX](https://msdn.microsoft.com/library/aa769980.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [IDM UNDERLINE ID comando](https://msdn.microsoft.com/library/aa770035.aspx) al controllo WebBrowser.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [ID di comando IDM UNORDERLIST](https://msdn.microsoft.com/library/aa769987.aspx) al controllo WebBrowser.  
