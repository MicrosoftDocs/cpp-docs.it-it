...
### <a name="remarks"></a>Note  
 ...
 È comune per utilizzare la stessa classe per elementi collegati e incorporati. `IsLinkedItem` Consente di rendere gli elementi collegati si comportano in modo diverso rispetto agli elementi incorporati, anche se molte volte il codice è comune.  
