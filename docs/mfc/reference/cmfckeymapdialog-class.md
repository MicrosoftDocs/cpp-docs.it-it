...
Nell'esempio seguente viene illustrato come costruire un oggetto del `CMFCKeyMapDialog` classe. In questo esempio fa parte di [esempio dimostrativo di Visual Studio](../../visual-cpp-samples.md).
