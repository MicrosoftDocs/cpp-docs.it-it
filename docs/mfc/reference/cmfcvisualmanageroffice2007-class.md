...
|`CMFCVisualManagerOffice2007::GetStyle`|Restituisce la combinazione di colori corrente dell' `CMFCVisualManagerOffice2007` interfaccia utente grafica che, a sua volta, riproduce la gui Microsoft Office 2007.|
