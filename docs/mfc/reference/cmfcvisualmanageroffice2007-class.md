...
Nell'esempio seguente viene illustrato come utilizzare il gestore visualizzazione Office 2007. Questo frammento di codice fa parte di [esempio dimostrativo avviso Desktop](../../overview/visual-cpp-samples.md).
