---
title: CDateTimeCtrl (classe) | Documenti di Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|[CDateTimeCtrl::Create](#create)|Crea il controllo selezione data e ora e lo collega a di `CDateTimeCtrl` oggetto.|  
...
|[CDateTimeCtrl::GetMonthCalFont](#getmonthcalfont)|Recupera il tipo di carattere attualmente utilizzata dal controllo di calendario mensile figlio del controllo di selezione ora e Data.|  
|[CDateTimeCtrl::GetMonthCalStyle](#getmonthcalstyle)|Ottiene lo stile del controllo selezione data e ora corrente.|  
|[CDateTimeCtrl::GetRange](#getrange)|Recupera corrente minimo e massimo consentito ora di sistema per un controllo selezione data e ora.|  
...
## <a name="remarks"></a>Note  
 ...
 È possibile personalizzare il controllo selezione data e ora applicando una varietà di stili per l'oggetto durante la creazione. Vedere [data e ora degli stili del controllo selezione](http://msdn.microsoft.com/library/windows/desktop/bb761728) nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)] per ulteriori informazioni sugli stili specifici per il controllo selezione data e ora. È possibile impostare il formato di visualizzazione del controllo DTP utilizzando gli stili dei formati. Questi stili di formato sono descritti in "Formato stili" nel [!INCLUDE[winsdkshort](../../atl-mfc-shared/reference/includes/winsdkshort_md.md)] argomento [stili Date e Time selezione controllo](http://msdn.microsoft.com/library/windows/desktop/bb761728).  
  
 Il controllo selezione data e ora utilizza inoltre le notifiche e i callback, che sono descritte in [utilizzando CDateTimeCtrl](../../mfc/using-cdatetimectrl.md).  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [DTM_CLOSEMONTHCAL](http://msdn.microsoft.com/library/windows/desktop/bb761753) messaggio, che è descritta nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
##  <a name="a-namecreatea--cdatetimectrlcreate"></a><a name="create"></a>CDateTimeCtrl::Create  
 Crea il controllo selezione data e ora e lo collega a di `CDateTimeCtrl` oggetto.  
...
### <a name="parameters"></a>Parametri  
 `dwStyle`  
 Specifica la combinazione di stili del controllo Data ora. Vedere [data e ora degli stili del controllo selezione](http://msdn.microsoft.com/library/windows/desktop/bb761728) nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)] per ulteriori informazioni sugli stili di selezione data e ora.  
 ...
 `nID`  
 Specifica l'ID di controllo. Data e ora di selezione del controllo  
...
2.  Chiamare questa funzione membro, che crea il controllo selezione data e ora di Windows e lo collega a di `CDateTimeCtrl` oggetto.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [DTM_GETDATETIMEPICKERINFO](http://msdn.microsoft.com/library/windows/desktop/bb761755) messaggio, che è descritta nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="example"></a>Esempio  
 Esempio di codice seguente indica se viene recuperato correttamente le informazioni sul controllo selezione data e ora corrente.  
...
### <a name="return-value"></a>Valore restituito  
 Oggetto **COLORREF** che rappresenta l'impostazione del colore per la parte specificata del controllo calendario mensile se ha esito positivo. In caso contrario, la funzione restituisce -1.  
  
### <a name="remarks"></a>Note  
 Questa funzione membro implementa il comportamento del messaggio Win32 [DTM_GETMCCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb761759), come descritto nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
### <a name="example"></a>Esempio  
 [!code-cpp[NVC_MFC_CDateTimeCtrl n.&2;](../../mfc/reference/codesnippet/cpp/cdatetimectrl-class_5.cpp)]  
  
##  <a name="a-namegetmonthcalctrla--cdatetimectrlgetmonthcalctrl"></a><a name="getmonthcalctrl"></a>:: GetMonthCalCtrl  
...
### <a name="return-value"></a>Valore restituito  
 Un puntatore a un [CMonthCalCtrl](../../mfc/reference/cmonthcalctrl-class.md) oggetto, o **NULL** se ha esito negativo o se la finestra non è visibile.  
  
### <a name="remarks"></a>Note  
 Controlli selezione data e ora creano un controllo di calendario mensile figlio quando l'utente fa clic sulla freccia a discesa. Quando il `CMonthCalCtrl` oggetto non è più necessario, viene eliminato, l'applicazione non deve fare affidamento sulla memorizzazione dell'oggetto che rappresenta di calendario mensile figlio del controllo di date time picker.  
...
##  <a name="a-namegetmonthcalfonta--cdatetimectrlgetmonthcalfont"></a><a name="getmonthcalfont"></a>CDateTimeCtrl::GetMonthCalFont  
 Ottiene il tipo di carattere attualmente utilizzata dal controllo calendario mensile del controllo di selezione ora e Data.  
...
### <a name="return-value"></a>Valore restituito  
 Un puntatore a un [CFont](../../mfc/reference/cfont-class.md) oggetto, o **NULL** in caso contrario.  
  
### <a name="remarks"></a>Note  
 Il `CFont` oggetto a cui fa riferimento il valore restituito è un oggetto temporaneo e viene eliminato durante il tempo di elaborazione inattive successivo.  
  
##  <a name="a-namegetmonthcalstylea--cdatetimectrlgetmonthcalstyle"></a><a name="getmonthcalstyle"></a>CDateTimeCtrl::GetMonthCalStyle  
 Ottiene lo stile del controllo calendario mensile di elenco a discesa che viene associato al controllo di selezione data e ora corrente.  
...
### <a name="return-value"></a>Valore restituito  
 Lo stile del controllo calendario mensile elenco a discesa, ovvero una combinazione bit per bit (o) di stili del controllo selezione data e ora. Per ulteriori informazioni, vedere [degli stili del controllo calendario mese](http://msdn.microsoft.com/library/windows/desktop/bb760919).  
  
### <a name="remarks"></a>Note  
 Questo metodo invia il [DTM_GETMCSTYLE](http://msdn.microsoft.com/library/windows/desktop/bb761763) messaggio, che è descritta nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
##  <a name="a-namegetrangea--cdatetimectrlgetrange"></a><a name="getrange"></a>CDateTimeCtrl::GetRange  
 Recupera corrente minimo e massimo consentito ora di sistema per un controllo selezione data e ora.  
...
### <a name="parameters"></a>Parametri  
 ...
 `pMaxRange`  
 Un puntatore a un `COleDateTime` oggetto o un `CTime` oggetto che contiene l'ultima volta cui è consentito il `CDateTimeCtrl` oggetto.  
  
### <a name="return-value"></a>Valore restituito  
 Oggetto `DWORD` contenente i flag che indicano quali intervalli impostati. Se  
...
### <a name="remarks"></a>Note  
 Questa funzione membro implementa il comportamento del messaggio Win32 [DTM_GETRANGE](http://msdn.microsoft.com/library/windows/desktop/bb761767), come descritto nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Nell'implementazione di MFC, è possibile specificare `COleDateTime` o `CTime` utilizzi.  
...
### <a name="return-value"></a>Valore restituito  
 Nella prima versione, diverso da zero se il tempo è stata scritta correttamente la `COleDateTime` oggetto; in caso contrario 0. Nelle versioni seconda e terza un `DWORD` uguale al valore di **dwFlag** set di membri [NMDATETIMECHANGE](http://msdn.microsoft.com/library/windows/desktop/bb761730) struttura. Vedere il **osservazioni** sezione più avanti per ulteriori informazioni.  
  
### <a name="remarks"></a>Note  
 Questa funzione membro implementa il comportamento del messaggio Win32 [DTM_GETSYSTEMTIME](http://msdn.microsoft.com/library/windows/desktop/bb761769), come descritto nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Nell'implementazione MFC di **GetTime**, è possibile utilizzare `COleDateTime` o `CTime` classi, oppure è possibile utilizzare un `SYSTEMTIME` struttura, per archiviare le informazioni sull'ora.  
  
 Il valore restituito `DWORD` nelle versioni seconda e terza sopra, indica se il controllo selezione data e ora è impostato sullo stato di "Nessuna data", come indicato nella [NMDATETIMECHANGE](http://msdn.microsoft.com/library/windows/desktop/bb761730) membro della struttura `dwFlags`. Se il valore restituito è uguale a **GDT_NONE**, il controllo è impostato su "Nessuna data" status e utilizza il **DTS_SHOWNONE** stile. Se il valore restituito è uguale a **GDT_VALID**, l'ora di sistema correttamente viene archiviato nel percorso di destinazione.  
...
### <a name="remarks"></a>Note  
 Questo metodo invia il [DTM_GETIDEALSIZE](http://msdn.microsoft.com/library/windows/desktop/bb761757) messaggio, che è descritta nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="example"></a>Esempio  
 Esempio di codice seguente recupera le dimensioni ideali per la visualizzazione del controllo selezione data e ora.  
...
### <a name="parameters"></a>Parametri  
 *pstrFormat*  
 Un puntatore a una stringa di formato di terminazione zero che definisce la visualizzazione desiderata. Impostando questo parametro su **NULL** reimposterà il controllo con la stringa di formato predefinito per lo stile corrente.  
...
### <a name="remarks"></a>Note  
 Questa funzione membro implementa il comportamento del messaggio Win32 [DTM_SETFORMAT](http://msdn.microsoft.com/library/windows/desktop/bb761771), come descritto nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
### <a name="example"></a>Esempio  
 [!code-cpp[6 NVC_MFC_CDateTimeCtrl](../../mfc/reference/codesnippet/cpp/cdatetimectrl-class_10.cpp)]  
...
### <a name="parameters"></a>Parametri  
 `iColor`  
 `int`valore che specifica quale area del controllo calendario mensile per impostare. Questo valore può essere uno dei valori seguenti.  
...
|MCSC_TRAILINGTEXT|Impostare il colore utilizzato per visualizzare intestazioni e testo giorno finali. Intestazione giorni iniziale e finale sono i giorni dei mesi precedenti e seguenti che vengono visualizzati sul calendario corrente.|  
  
 `ref`  
 Oggetto **COLORREF** valore che rappresenta il colore che verrà impostato per l'area specificata del calendario mensile.  
  
### <a name="return-value"></a>Valore restituito  
 Oggetto **COLORREF** che rappresenta l'impostazione del colore precedenti per la parte specificata del controllo calendario mensile se ha esito positivo. Il messaggio in caso contrario, restituisce -1.  
  
### <a name="remarks"></a>Note  
 Questa funzione membro implementa il comportamento del messaggio Win32 [DTM_SETMCCOLOR](http://msdn.microsoft.com/library/windows/desktop/bb761773), come descritto nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="parameters"></a>Parametri  
 ...
 `bRedraw`  
 Specifica se il controllo deve essere ridisegnato immediatamente dopo l'impostazione del carattere. Impostando questo parametro su **TRUE** , nel controllo viene ridisegnato.  
  
### <a name="remarks"></a>Note  
 Questa funzione membro implementa il comportamento del messaggio Win32 [DTM_SETMCFONT](http://msdn.microsoft.com/library/windows/desktop/bb761775), come descritto nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
  
### <a name="example"></a>Esempio  
 [!code-cpp[NVC_MFC_CDateTimeCtrl&#7;](../../mfc/reference/codesnippet/cpp/cdatetimectrl-class_11.cpp)]  
  
> [!NOTE]
>  Se si utilizza questo codice, si desidera rendere membro di una di `CDialog`-derivata denominata `m_MonthFont` di tipo **CFont**.  
  
##  <a name="a-namesetmonthcalstylea--cdatetimectrlsetmonthcalstyle"></a><a name="setmonthcalstyle"></a>CDateTimeCtrl::SetMonthCalStyle  
 Imposta lo stile del controllo calendario mensile di elenco a discesa che viene associato al controllo di selezione data e ora corrente.  
...
|Parametro|Descrizione|  
|---------------|-----------------|  
|[in] `dwStyle`|Un mese nuovo stile del controllo, ovvero una combinazione bit per bit (OR) di stili del controllo calendario mese di calendario. Per ulteriori informazioni, vedere [degli stili del controllo calendario mese](http://msdn.microsoft.com/library/windows/desktop/bb760919).|  
  
### <a name="return-value"></a>Valore restituito  
 Lo stile precedente del controllo calendario mensile di riepilogo a discesa.  
  
### <a name="remarks"></a>Note  
 Questo metodo invia il [DTM_SETMCSTYLE](http://msdn.microsoft.com/library/windows/desktop/bb761778) messaggio, che è descritta nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
...
### <a name="remarks"></a>Note  
 Questa funzione membro implementa il comportamento del messaggio Win32 [DTM_SETRANGE](http://msdn.microsoft.com/library/windows/desktop/bb761780), come descritto nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Nell'implementazione di MFC, è possibile specificare `COleDateTime` o `CTime` utilizzi. Se il `COleDateTime` oggetto ha un **NULL** stato, l'intervallo verrà rimosso. Se il `CTime` puntatore o `COleDateTime` puntatore **NULL**, verrà rimossa l'intervallo.  
...
### <a name="parameters"></a>Parametri  
 *timeNew*  
 Un riferimento a un [COleDateTime](../../atl-mfc-shared/reference/coledatetime-class.md) oggetto che contiene l'a cui verrà impostato il controllo.  
  
 *pTimeNew*  
 Nella seconda versione precedente, un puntatore a un [CTime](../../atl-mfc-shared/reference/ctime-class.md) oggetto contenente l'ora in cui verrà impostato il controllo. Nella terza versione precedente, un puntatore a un [SYSTEMTIME](http://msdn.microsoft.com/library/windows/desktop/ms724950) struttura contenente l'ora in cui verrà impostato il controllo.  
  
### <a name="return-value"></a>Valore restituito  
 Diverso da zero se ha esito positivo; in caso contrario 0.  
  
### <a name="remarks"></a>Note  
 Questa funzione membro implementa il comportamento del messaggio Win32 [DTM_SETSYSTEMTIME](http://msdn.microsoft.com/library/windows/desktop/bb761782), come descritto nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)]. Nell'implementazione MFC di **SetTime**, è possibile utilizzare il `COleDateTime` o `CTime` classi, oppure è possibile utilizzare un `SYSTEMTIME` struttura, per impostare le informazioni sull'ora.  
