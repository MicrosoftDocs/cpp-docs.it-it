...
ms.locfileid: "36955989"
---
# <a name="cdraglistbox-class"></a>Classe CDragListBox
Oltre a fornire la funzionalità di una casella di riepilogo di Windows, il `CDragListBox` classe consente all'utente di spostare elementi casella di riepilogo, ad esempio nomi di file, nella casella di riepilogo.  
...
|Nome|Descrizione|  
|----------|-----------------|  
|[CDragListBox::BeginDrag](#begindrag)|Chiamato dal framework quando inizia un'operazione di trascinamento.|  
...
|[CDragListBox::ItemFromPt](#itemfrompt)|Restituisce le coordinate dell'elemento che viene trascinato.|  
...
## <a name="remarks"></a>Note  
 ...
 Il controllo casella di riepilogo è associato il `CDragListBox` classe non può disporre il **LBS_SORT** o il **LBS_MULTIPLESELECT** stile. Per una descrizione di stili casella di riepilogo, vedere [stili casella di riepilogo](../../mfc/reference/styles-used-by-mfc.md#list-box-styles).  
 ...
 Per ulteriori informazioni sull'assegnazione controlli alle variabili membro, vedere [scelta rapida per la definizione delle variabili membro per i controlli finestra](../../windows/defining-member-variables-for-dialog-controls.md).  
 ...
 *pt*  
 Un [CPoint](../../atl-mfc-shared/reference/cpoint-class.md) oggetto che contiene le coordinate dell'elemento che viene trascinato.  
  
### <a name="return-value"></a>Valore restituito  
 Diverso da zero se il trascinamento può, in caso contrario 0.  
  
### <a name="remarks"></a>Note  
 Eseguire l'override di questa funzione se si desidera controllare cosa accade quando inizia un'operazione di trascinamento. L'implementazione predefinita acquisisce il mouse e rimane in modalità di trascinamento fino a quando l'utente fa clic sul pulsante sinistro o destro del mouse o preme ESC, a quel punto viene annullata l'operazione di trascinamento.  
...
### <a name="parameters"></a>Parametri  
 *pt*  
 Un [CPoint](../../atl-mfc-shared/reference/cpoint-class.md) oggetto che contiene gli assi x e y coordinate del cursore dello schermo.  
  
### <a name="return-value"></a>Valore restituito  
 L'ID risorsa del cursore da visualizzare. Sono possibili valori sono i seguenti:  
...
### <a name="remarks"></a>Note  
 Restituisce il comportamento predefinito `DL_MOVECURSOR`. Eseguire l'override di questa funzione se si desidera fornire funzionalità aggiuntive.  
 ...
 *pt*  
 Un [CPoint](../../atl-mfc-shared/reference/cpoint-class.md) oggetto che contiene le coordinate del sito di destinazione.  
...
### <a name="parameters"></a>Parametri  
 *pt*  
 Un [CPoint](../../atl-mfc-shared/reference/cpoint-class.md) oggetto che contiene le coordinate di un punto all'interno della casella di elenco.  
  
 *bAutoScroll*  
 Diverso da zero se è consentito lo scorrimento, in caso contrario 0.  
  
### <a name="return-value"></a>Valore restituito  
 Indice in base zero dell'elemento casella di riepilogo trascinamento.  
