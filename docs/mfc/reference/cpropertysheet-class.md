...
*lpRect*<br/>
Punta a un [RECT](/previous-versions/dd162897\(v=vs.85\)) struttura oppure [CRect](../../atl-mfc-shared/reference/crect-class.md) oggetto che contiene la finestra di dialogo coordina da convertire.
