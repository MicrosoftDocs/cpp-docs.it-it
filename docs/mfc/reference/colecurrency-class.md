...
Per altre informazioni, vedere la [CURRENCY](/windows/desktop/api/wtypes/ns-wtypes-tagcy) e [VARIANT](/previous-versions/windows/desktop/api/oaidl/ns-oaidl-tagvariant) voci nel SDK di Windows.
