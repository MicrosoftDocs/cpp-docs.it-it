...
### <a name="parameters"></a>Parametri  
 ...
 [in] `bVertcalOnly`  
 `TRUE`Per specificare che la raccolta è possibile ridimensionare solo verticale; `FALSE` per specificare che la raccolta può essere ridimensionato sia verticalmente e orizzontalmente.  
