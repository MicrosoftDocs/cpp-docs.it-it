...
> [!NOTE]
>  Oltre ai messaggi definiti dall'utente, `ON_MESSAGE` gestisce i messaggi meno comuni di Windows. Per ulteriori informazioni, vedere l'articolo della Knowledge Base [99848: INFO: utilizzo di Macro ON_MESSAGE() ai messaggi meno comune mappa](http://go.microsoft.com/fwlink/p/?linkid=192022).  
