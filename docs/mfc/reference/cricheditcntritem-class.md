...
Chiamare questa funzione per sincronizzare l'aspetto del dispositivo, [DVASPECT](/windows/win32/api/wtypes/ne-wtypes-dvaspect), di `CRichEditCntrltem` questo oggetto con quello specificato da *reo*.
