...
|[CMFCRibbonButton::GetToolTipText](#gettooltiptext)|Restituisce il testo della descrizione comando dell'elemento della barra multifunzione. (Overrides [CMFCRibbonBaseElement::GetToolTipText](../../mfc/reference/cmfcribbonbaseelement-class.md#gettooltiptext).)|
|[CMFCRibbonButton::HasCompactMode](#hascompactmode)|Specifica se l'elemento della barra multifunzione dispone di una modalità compatta. (OverrideS [CMFCRibbonBaseElement::HasCompactMode](../../mfc/reference/cmfcribbonbaseelement-class.md#hascompactmode).)|
|[CMFCRibbonButton::HasIntermediateMode](#hasintermediatemode)|Specifica se l'elemento della barra multifunzione dispone di una modalità intermedia. (Overrides [CMFCRibbonBaseElement::HasIntermediateMode](../../mfc/reference/cmfcribbonbaseelement-class.md#hasintermediatemode).)|
|[CMFCRibbonButton::HasLargeMode](#haslargemode)|Specifica se l'elemento della barra multifunzione dispone di una modalità di dimensioni elevate. (Overrides [CMFCRibbonBaseElement::HasLargeMode](../../mfc/reference/cmfcribbonbaseelement-class.md#haslargemode).)|
...
|[CMFCRibbonButton::SetText](#settext)|Imposta il testo per l'elemento della barra multifunzione. (Overrides [CMFCRibbonBaseElement::SetText](../../mfc/reference/cmfcribbonbaseelement-class.md#settext).)|
...
Per utilizzare un pulsante della barra multifunzione in un'applicazione, costruire l'oggetto pulsante e aggiungerlo al [gruppo](../../mfc/reference/cmfcribbonpanel-class.md)della barra multifunzione appropriato.
...
[in] Specifica un indice in base zero dell'immagine di grandi dimensioni del pulsante nell'elenco immagini della categoria padre.
...
Nell'esempio seguente viene `CMFCRibbonButton` illustrato come costruire un oggetto.
...
[in] *pDC*<br/>
[in] *digitare*<br/>
[in] *rectImage (immagine rect)*<br/>

### <a name="remarks"></a>Osservazioni

## <a name="cmfcribbonbuttondrawribbontext"></a><a name="drawribbontext"></a>Controllo CMFCRibbonButton::DrawRibbonText
...
[in] *rectText (testo rect)*<br/>
[in] *UiDTFlags (proprietà)*<br/>
[in] *clrText (testo)*<br/>
...
Indice in base zero dell'elemento secondario associato *all'oggetto uiID*. -1 se tale sottoelemento non è presente.

## <a name="cmfcribbonbuttongetcommandrect"></a><a name="getcommandrect"></a>CMFCRibbonButton::GetCommandRectCMFCRibbonButton::GetCommandRect
...
*bLargeImage (informazioni in base all'immagine in*<br/>
[in] Se TRUE, restituisce l'indice dell'immagine nell'elenco di immagini che contiene le immagini di grandi dimensioni; in caso contrario restituisce l'indice dell'immagine nell'elenco di immagini che contiene le immagini piccole.
...
Un handle per un menu di Windows assegnato al pulsante; NULL se non è stato assegnato alcun menu.
...
## <a name="cmfcribbonbuttonhaslargemode"></a><a name="haslargemode"></a>Controllo CMFCRibbonButton::HasLargeMode
...
## <a name="cmfcribbonbuttonisapplicationbutton"></a><a name="isapplicationbutton"></a>Controllo CMFCRibbonButton::IsApplicationButton
...
## <a name="cmfcribbonbuttoniscommandareahighlighted"></a><a name="iscommandareahighlighted"></a>Controllo CMFCRibbonButton::IsCommandAreaHighlighted
...
TRUESe è stato abilitato il comando predefinito per un pulsante della barra multifunzione. FALSE in caso contrario.
...
## <a name="cmfcribbonbuttonismenuareahighlighted"></a><a name="ismenuareahighlighted"></a>Controllo CMFCRibbonButton::IsMenuAreaHighlighted
...
## <a name="cmfcribbonbuttonispopupdefaultmenulook"></a><a name="ispopupdefaultmenulook"></a>Controllo CMFCRibbonButton::IsPopupDefaultMenuLook
...
TRUESe menu è allineato a destra; in caso contrario, FALSE.
...
## <a name="cmfcribbonbuttononfillbackground"></a><a name="onfillbackground"></a>Controllo CMFCRibbonButton::OnFillBackground
...
TRUESe l'elemento specificato è stato rimosso correttamente. in caso contrario FALSE se *nIndex* è negativo o supera il numero di voci di menu nel menu a comparsa.
...
*bSet* è rilevante solo quando il pulsante dispone di un menu. Se *bSet* è TRUE, il pulsante può eseguire il comando predefinito e il menu a comparsa assegnato viene visualizzato solo quando un utente fa clic sulla freccia sul bordo destro del pulsante. In caso contrario, il pulsante non può eseguire il comando predefinito e il menu a comparsa viene visualizzato indipendentemente dall'area del pulsante su cui l'utente fa clic.

## <a name="cmfcribbonbuttonsetdescription"></a><a name="setdescription"></a>CMFCRibbonButton::SetDescrizione
...
*bLargeImage (informazioni in base all'immagine in*<br/>
[in] Se TRUE, l'indice specificato fa riferimento all'elenco di immagini di grandi dimensioni. In caso contrario, l'indice fa riferimento all'elenco delle immagini piccole.
...
*Hmenu*<br/>
Un handle per un menu di Windows.

*bIsDefaultCommand (comando)*<br/>
...
Se TRUE, il menu è allineato a destra. In caso contrario, il menu viene allineato a sinistra.

*uiMenuResID (informazioni in questo stato in stato di un'applicazione di*<br/>
UN ID risorsa di menu.
...
*bImpostazione*<br/>
[in] Se TRUE, il menu è allineato a destra. In caso contrario, il menu viene allineato a sinistra
