...
##  <a name="close"></a>  CAnimateCtrl::Close  
 Chiude la clip AVI che è stato precedentemente aperto nel controllo animazione (se presente) e la rimuove dalla memoria.  
...
- **WS_DISABLED** raramente  
 ...
 Oltre a stili di finestra elencati in precedenza, si desidera applicare uno o più degli stili del controllo animazione a un controllo di animazione. Vedere il SDK di Windows per altre informazioni su [stili del controllo animazione](http://msdn.microsoft.com/library/windows/desktop/bb761886).  
...
### <a name="parameters"></a>Parametri  
 ...
 `dwStyle`  
 Specifica lo stile del controllo animazione. Applicare qualsiasi combinazione di finestra e stili del controllo animazione descritte in [stili del controllo animazione](http://msdn.microsoft.com/library/windows/desktop/bb761886) in Windows SDK.  
