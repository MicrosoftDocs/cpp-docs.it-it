---
title: Classe CRenderTarget | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|Nome|Descrizione|  
|----------|-----------------|  
|[CRenderTarget::Attach](#attach)|Collega a esistente di eseguire il rendering dell'interfaccia di destinazione per l'oggetto|  
|[CRenderTarget::BeginDraw](#begindraw)|Avvia il disegno in questa destinazione di rendering.|  
|[CRenderTarget::Clear](#clear)|Cancella l'area di disegno per il colore specificato.|  
|[CRenderTarget::COLORREF_TO_D2DCOLOR](#colorref_to_d2dcolor)|Converte l'oggetto D2D1_COLOR_F GDI colore e i valori alfa.|  
|[CRenderTarget::CreateCompatibleRenderTarget](#createcompatiblerendertarget)|Crea una nuova destinazione di rendering di bitmap per l'utilizzo durante il disegno fuori schermo intermedio è compatibile con la destinazione di rendering corrente.|  
...
|[CRenderTarget::DrawGeometry](#drawgeometry)|Disegna la struttura della geometria specificata utilizzando lo stile di traccia specificato.|  
|[CRenderTarget::DrawGlyphRun](#drawglyphrun)|Disegna le icone specificate.|  
...
|[CRenderTarget::DrawText](#drawtext)|Disegna il testo specificato utilizzando le informazioni di formato fornite da un oggetto IDWriteTextFormat.|  
...
|[CRenderTarget::EndDraw](#enddraw)|Termina le operazioni di disegno sulla destinazione di rendering e indica lo stato di errore corrente e di un tag associati.|  
...
|[CRenderTarget::FillOpacityMask](#fillopacitymask)|Applica la maschera di opacità descritta da nella bitmap specificata per un pennello che, utilizzato per disegnare un'area della destinazione di rendering.|  
...
|[CRenderTarget::Flush](#flush)|Esegue tutti i comandi di disegnati in sospeso.|  
|[CRenderTarget::GetAntialiasMode](#getantialiasmode)|Recupera la modalità di anti-aliasing corrente per operazioni di disegno non di testo.|  
|[CRenderTarget::GetDpi](#getdpi)|Restituisce il rendering punti per pollice (DPI) di destinazione|  
|[CRenderTarget::GetMaximumBitmapSize](#getmaximumbitmapsize)|Ottiene la dimensione massima, espressa in unità di dipendente dal dispositivo (pixel), di qualsiasi dimensione di una bitmap supportato dalla destinazione di rendering|  
|[CRenderTarget::GetPixelFormat](#getpixelformat)|Recupera la modalità di alfa e formato di pixel della destinazione di rendering|  
...
|[CRenderTarget::GetTags](#gettags)|Ottiene l'etichetta per le operazioni di disegnare successive.|  
|[CRenderTarget::GetTextAntialiasMode](#gettextantialiasmode)|Ottiene la modalità di anti-aliasing per il testo e le operazioni di disegno glifo.|  
...
|[CRenderTarget::PopAxisAlignedClip](#popaxisalignedclip)|Rimuove l'ultimo clip allineato all'asse dalla destinazione di rendering. Dopo che questo metodo viene chiamato, il ritaglio non viene più applicata alle operazioni di disegno successive.|  
|[CRenderTarget::PopLayer](#poplayer)|Interrompe il reindirizzamento delle operazioni di disegno al livello specificato da PushLayer l'ultima chiamata.|  
|[CRenderTarget::PushAxisAlignedClip](#pushaxisalignedclip)|Rimuove l'ultimo clip allineato all'asse dalla destinazione di rendering. Dopo che questo metodo viene chiamato, il ritaglio non viene più applicata alle operazioni di disegno successive.|  
...
|[CRenderTarget::RestoreDrawingState](#restoredrawingstate)|Imposta stato di disegno della destinazione di rendering a quello del ID2D1DrawingStateBlock specificato.|  
|[CRenderTarget::SaveDrawingState](#savedrawingstate)|Salva lo stato corrente di disegno di ID2D1DrawingStateBlock specificato.|  
|[CRenderTarget::SetAntialiasMode](#setantialiasmode)|Imposta la modalità di anti-aliasing della destinazione di rendering. La modalità di anti-aliasing si applica a tutte le operazioni di disegnare successive, escluso il testo e le operazioni di disegno glifo.|  
|[CRenderTarget::SetDpi](#setdpi)|Imposta i punti per pollice (DPI) della destinazione di rendering.|  
|[CRenderTarget::SetTags](#settags)|Specifica un'etichetta per le operazioni di disegnare successive.|  
...
|[CRenderTarget::SetTextRenderingParams](#settextrenderingparams)|Specifica le opzioni per il rendering di testo da applicare a tutti i glifi le operazioni di disegno e testo successivo.|  
...
|nome|Descrizione|  
|----------|-----------------|  
|[CRenderTarget::m_lstResources](#m_lstresources)|Un elenco dei puntatori agli oggetti CD2DResource.|  
...
##  <a name="clear"></a>  CRenderTarget::Clear  
 Cancella l'area di disegno per il colore specificato.  
...
### <a name="parameters"></a>Parametri  
 `color`  
 Colore a cui è stata deselezionata l'area di disegno.  
...
##  <a name="createcompatiblerendertarget"></a>  CRenderTarget::CreateCompatibleRenderTarget  
 Crea una nuova destinazione di rendering di bitmap per l'utilizzo durante il disegno fuori schermo intermedio è compatibile con la destinazione di rendering corrente.  
...
### <a name="parameters"></a>Parametri  
 `bitmapTarget`  
 Quando questo metodo viene restituito, contiene l'indirizzo di un puntatore a una nuova destinazione di rendering di bitmap. Questo parametro viene passato non inizializzato.  
...
### <a name="parameters"></a>Parametri  
 `bDeleteResources`  
 Se bDeleteResources è TRUE, tutte le risorse disponibili in m_lstResources verranno automaticamente eliminato definitivamente.  
...
### <a name="parameters"></a>Parametri  
 ...
 `interpolationMode`  
 La modalità di interpolazione da utilizzare se la bitmap viene ridimensionata o ruotata per l'operazione di disegno.  
  
 `pRectSrc`  
 Le dimensioni e posizione, espressa in pixel indipendenti dal dispositivo nello spazio delle coordinate della bitmap, dell'area all'interno della bitmap da disegnare.  
...
### <a name="parameters"></a>Parametri  
 `ellipse`  
 Specifica la posizione e il raggio dell'ellisse da disegnare, in pixel indipendenti dal dispositivo.  
...
##  <a name="drawgeometry"></a>  CRenderTarget::DrawGeometry  
 Disegna la struttura della geometria specificata utilizzando lo stile di traccia specificato.  
...
### <a name="parameters"></a>Parametri  
 ...
 `measuringMode`  
 Un valore che indica la modalità in cui vengono utilizzate le metriche glifo per misurare il testo quando viene formattato. Il valore predefinito è DWRITE_MEASURING_MODE_NATURAL.  
...
### <a name="parameters"></a>Parametri  
 ...
 `ptTo`  
 Il punto finale della riga, in pixel indipendenti dal dispositivo.  
  
 `pBrush`  
 Pennello utilizzato per disegnare il tratto della linea.  
  
 `fStrokeWidth`  
 Un valore maggiore o uguale a 0,0 f che specifica lo spessore del tratto. Se questo parametro non è specificato, per impostazione predefinita a 1.0 f. Il tratto è centrato sulla riga.  
  
 `strokeStyle`  
 Stile del tratto da disegno, o NULL per disegnare una linea continua.  
...
### <a name="parameters"></a>Parametri  
 ...
 `pBrush`  
 Il pennello usato per disegnare il tratto del rettangolo  
 ...
 `strokeStyle`  
 Stile del tratto da disegno, o NULL per disegnare un tratto continuo.  
...
### <a name="parameters"></a>Parametri  
 ...
 `fStrokeWidth`  
 La larghezza del tratto del rettangolo arrotondato. Il tratto è centrato sulla struttura del rettangolo arrotondato. Il valore predefinito è 1.0 f.  
...
##  <a name="drawtext"></a>  CRenderTarget::DrawText  
 Disegna il testo specificato utilizzando le informazioni di formato fornite da un oggetto IDWriteTextFormat.  
...
### <a name="parameters"></a>Parametri  
 ...
 `textFormat`  
 Un oggetto che descrive la formattazione del testo da disegnare, ad esempio il tipo di carattere, dimensioni del carattere e la direzione di flusso di dettagli.  
  
 `options`  
 Un valore che indica se il testo deve essere bloccato nei limiti dei pixel e indica se il testo deve essere ritagliato nel rettangolo di layout. Il valore predefinito è D2D1_DRAW_TEXT_OPTIONS_NONE, che indica che il testo deve essere bloccato nei limiti dei pixel e non deve essere ritagliato nel rettangolo di layout.  
...
### <a name="parameters"></a>Parametri  
 `ptOrigin`  
 Il punto, in pixel indipendenti dal dispositivo, in cui viene disegnato l'angolo superiore sinistro del testo descritto da textLayout descritto.  
  
 `textLayout`  
 Testo formattato da disegnare. Gli effetti di disegnati che non ereditano da ID2D1Resource vengono ignorati. Se non esistono effetti di disegno che ereditano da ID2D1Resource che non sono pennelli, questo metodo ha esito negativo e la destinazione di rendering verrà inserita in uno stato di errore.  
  
 `pBrushForeground`  
 Pennello utilizzato per disegnare il testo in textLayout che non dispone già di un pennello associato come un effetto di disegno (specificato dal metodo IDWriteTextLayout:: SetDrawingEffect).  
  
 `options`  
 Un valore che indica se il testo deve essere bloccato nei limiti dei pixel e indica se il testo deve essere ritagliato nel rettangolo di layout. Il valore predefinito è D2D1_DRAW_TEXT_OPTIONS_NONE, che indica che il testo deve essere bloccato nei limiti dei pixel e non deve essere ritagliato nel rettangolo di layout.  
  
##  <a name="enddraw"></a>  CRenderTarget::EndDraw  
 Termina le operazioni di disegno sulla destinazione di rendering e indica lo stato di errore corrente e di un tag associati.  
...
### <a name="parameters"></a>Parametri  
 `ellipse`  
 Specifica la posizione e il raggio, device independent pixel, dell'ellisse da disegnare.  
  
 `pBrush`  
 Pennello usato per colorare l'interno dell'ellisse.  
...
### <a name="parameters"></a>Parametri  
 ...
 `pBrush`  
 Il pennello usato per disegnare la geometria della parte interno.  
  
 `pOpacityBrush`  
 Maschera di opacità da applicare alla geometria; NULL per alcuna maschera di opacità. Se si specifica una maschera di opacità (il parametro opacityBrush), pennello deve essere un ID2D1BitmapBrush che è impostato su D2D1_EXTEND_MODE_CLAMP relative modalità di estendere x e y. Per altre informazioni, vedere la sezione Osservazioni.  
...
### <a name="parameters"></a>Parametri  
 `pMesh`  
 La mesh per disegnare.  
  
 `pBrush`  
 Pennello utilizzato per disegnare la trama.  
  
##  <a name="fillopacitymask"></a>  CRenderTarget::FillOpacityMask  
 Applica la maschera di opacità descritta da nella bitmap specificata per un pennello che, utilizzato per disegnare un'area della destinazione di rendering.  
...
### <a name="parameters"></a>Parametri  
 ...
 `pBrush`  
 Pennello utilizzato per disegnare l'area di destinazione di rendering specificata da destinationRectangle.  
  
 `content`  
 Il tipo di contenuto che contiene la maschera di opacità. Il valore viene utilizzato per determinare lo spazio colore in cui viene aggiunta la maschera di opacità.  
  
 `rectDest`  
 L'area di destinazione di rendering da disegnare, in pixel indipendenti dal dispositivo.  
  
 `rectSrc`  
 L'area della bitmap da utilizzare come la maschera di opacità, in pixel indipendenti dal dispositivo.  
...
### <a name="parameters"></a>Parametri  
 ...
 `pBrush`  
 Pennello utilizzato per disegnare il rettangolo della parte interno.  
...
### <a name="parameters"></a>Parametri  
 ...
 `pBrush`  
 Pennello usato per colorare l'interno del rettangolo arrotondato.  
  
##  <a name="flush"></a>  CRenderTarget::Flush  
 Esegue tutti i comandi di disegnati in sospeso.  
...
### <a name="parameters"></a>Parametri  
 `tag1`  
 Contiene il tag per le operazioni che hanno generato errori o 0 se nessun errore. Questo parametro viene passato non inizializzato.  
  
 `tag2`  
 Contiene il tag per le operazioni che hanno generato errori o 0 se nessun errore. Questo parametro viene passato non inizializzato.  
  
##  <a name="getantialiasmode"></a>  CRenderTarget::GetAntialiasMode  
 Recupera la modalità di anti-aliasing corrente per operazioni di disegno non di testo.  
...
##  <a name="getmaximumbitmapsize"></a>  CRenderTarget::GetMaximumBitmapSize  
 Ottiene la dimensione massima, espressa in unità di dipendente dal dispositivo (pixel), di qualsiasi dimensione di una bitmap supportato dalla destinazione di rendering  
...
##  <a name="getpixelformat"></a>  CRenderTarget::GetPixelFormat  
 Recupera la modalità di alfa e formato di pixel della destinazione di rendering  
...
##  <a name="gettags"></a>  CRenderTarget::GetTags  
 Ottiene l'etichetta per le operazioni di disegnare successive.  
...
### <a name="parameters"></a>Parametri  
 `tag1`  
 Contiene la prima etichetta per le operazioni di disegnare successive. Questo parametro viene passato non inizializzato. Se si specifica NULL, non viene recuperato alcun valore per questo parametro.  
  
 `tag2`  
 Contiene la seconda etichetta per le operazioni di disegnare successive. Questo parametro viene passato non inizializzato. Se si specifica NULL, non viene recuperato alcun valore per questo parametro.  
  
##  <a name="gettextantialiasmode"></a>  CRenderTarget::GetTextAntialiasMode  
 Ottiene la modalità di anti-aliasing per il testo e le operazioni di disegno glifo.  
...
### <a name="return-value"></a>Valore restituito  
 Modalità di anti-aliasing corrente per il testo e le operazioni di disegno glifo.  
...
### <a name="parameters"></a>Parametri  
 `textRenderingParams`  
 Quando termina, questo metodo corrente textRenderingParams contiene l'indirizzo di un puntatore a una destinazione di rendering della opzioni di rendering del testo.  
...
### <a name="return-value"></a>Valore restituito  
 TRUE se le proprietà di destinazione di rendering specificata sono supportate da questa destinazione di rendering; in caso contrario, FALSE  
...
##  <a name="m_lstresources"></a>  CRenderTarget::m_lstResources  
 Un elenco dei puntatori agli oggetti CD2DResource.  
...
##  <a name="popaxisalignedclip"></a>  CRenderTarget::PopAxisAlignedClip  
 Rimuove l'ultimo clip allineato all'asse dalla destinazione di rendering. Dopo che questo metodo viene chiamato, il ritaglio non viene più applicata alle operazioni di disegno successive.  
...
##  <a name="poplayer"></a>  CRenderTarget::PopLayer  
 Interrompe il reindirizzamento delle operazioni di disegno al livello specificato da PushLayer l'ultima chiamata.  
...
##  <a name="restoredrawingstate"></a>  CRenderTarget::RestoreDrawingState  
 Imposta stato di disegno della destinazione di rendering a quello del ID2D1DrawingStateBlock specificato.  
...
##  <a name="setantialiasmode"></a>  CRenderTarget::SetAntialiasMode  
 Imposta la modalità di anti-aliasing della destinazione di rendering. La modalità di anti-aliasing si applica a tutte le operazioni di disegnare successive, escluso il testo e le operazioni di disegno glifo.  
...
##  <a name="settags"></a>  CRenderTarget::SetTags  
 Specifica un'etichetta per le operazioni di disegnare successive.  
...
### <a name="parameters"></a>Parametri  
 `tag1`  
 Un'etichetta per applicare a operazioni di disegno successive.  
...
### <a name="parameters"></a>Parametri  
 `textAntialiasMode`  
 La modalità di anti-aliasing da utilizzare per testo e glifo le operazioni di disegno successive.  
  
##  <a name="settextrenderingparams"></a>  CRenderTarget::SetTextRenderingParams  
 Specifica le opzioni per il rendering di testo da applicare a tutti i glifi le operazioni di disegno e testo successivo.  
...
### <a name="parameters"></a>Parametri  
 `textRenderingParams`  
 Le opzioni per il rendering di testo da applicare a tutti i glifi; operazioni di disegno e testo successivo NULL per cancellare le opzioni di rendering di testo corrente.  
...
### <a name="return-value"></a>Valore restituito  
 TRUE è l'oggetto se è valido. in caso contrario FALSE.  
