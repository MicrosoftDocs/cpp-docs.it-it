...
- **CBRS_GRIPPER** provoca un gripper, simile a quella usata sui gruppi musicali in una **CReBar** oggetto da disegnare per qualsiasi `CControlBar`-classe derivata.  
