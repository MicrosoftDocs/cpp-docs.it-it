...
### <a name="remarks"></a>Note  
 Tutti `CRecordset``AddNew`, **modifica**, **eliminare**, e **aggiornamento** chiamate eseguite dall'ultimo [BeginTrans](#begintrans) rollback allo stato in cui si trovava al momento della chiamata.  
