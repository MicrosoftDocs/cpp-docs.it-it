...
### <a name="remarks"></a>Note  
 ...
 Per altre informazioni sugli aspetti di disegno, vedere la [FORMATETC](http://msdn.microsoft.com/library/windows/desktop/ms682177) struttura dei dati in Windows SDK.  
