...
### <a name="example"></a>Esempio  
 [!code-cpp[N. 26 NVC_MFCExceptions](../../mfc/codesnippet/cpp/exception-processing_1.cpp)]  
...
### <a name="remarks"></a>Note  
 **GENERARE** interrupt l'esecuzione, passare il controllo associato del programma **CATCH** blocco nel programma. Se non è stato fornito il **CATCH** bloccare, quindi il controllo viene passato a un modulo di libreria Microsoft Foundation Class che visualizza un errore del messaggio e viene chiuso.  
...
### <a name="remarks"></a>Note  
 La versione che accetta un `HRESULT` come un argomento consente di convertire il codice di risultato nella corrispondente `SCODE`. Per ulteriori informazioni su `HRESULT` e `SCODE`, vedere [struttura dei codici di errore COM](http://msdn.microsoft.com/library/windows/desktop/ms690088) nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
