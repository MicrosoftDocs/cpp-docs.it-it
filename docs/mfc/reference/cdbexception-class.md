...
Per altre informazioni sui codici di usato per effettuare questa stringa, vedere la [SQLError](/sql/odbc/reference/syntax/sqlerror-function) funzionare nel *riferimento per programmatori ODBC*.
