...
- **AFX_SQL_ERROR_EMPTY_COLUMN_LIST** si è tentato di aprire una tabella (o che hai fornito non può essere identificata come una chiamata di routine o **selezionare** istruzione), ma non sono presenti colonne identificate con il trasferimento di campi di record (RFX) funzione chiama il `DoFieldExchange` eseguire l'override.  
