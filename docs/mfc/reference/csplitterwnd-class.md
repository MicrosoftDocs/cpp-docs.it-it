...
3.  Chiamare il `Create` funzione di membro dall'interno sottoposto a override `OnCreateClient`.  
...
3.  Chiamare il `CreateStatic` funzione di membro dall'interno sottoposto a override [CFrameWnd::OnCreateClient](../../mfc/reference/cframewnd-class.md#oncreateclient).  
