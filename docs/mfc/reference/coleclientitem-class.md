...
*ppd*<br/>
Puntatore a un [PRINTDLG](/windows/desktop/api/commdlg/ns-commdlg-tagpda) struttura dei dati, che contiene informazioni sul nuovo dispositivo di destinazione di stampa. Può essere NULL.
