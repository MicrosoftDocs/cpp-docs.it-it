...
|[CFrameWnd::RecalcLayout](#recalclayout)|Riposiziona le barre di controllo del `CFrameWnd` oggetto.|
|[CFrameWnd::SaveBarState](#savebarstate)|Chiamata a salvare le impostazioni sulla barra di controllo.|
