...
> [!NOTE]
> Se si dichiara un membro dopo DECLARE_DISPATCH_MAP, è necessario specificare un nuovo tipo di accesso ( **pubblico**, **privato**o **protetto**).
