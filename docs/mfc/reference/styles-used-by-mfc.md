...
ms.locfileid: "97218732"
---
# <a name="styles-used-by-mfc"></a>Stili utilizzati da MFC

Usare i flag di stile seguenti per specificare l'aspetto e il comportamento di una finestra o di un controllo quando si crea l'oggetto MFC corrispondente. Nella maggior parte dei casi, questi stili vengono impostati nel parametro *dwStyle* della `Create` funzione Class.

## <a name="button-styles"></a><a name="button-styles"></a> Stili pulsante
...
## <a name="edit-styles"></a><a name="edit-styles"></a> Modifica stili
...
|ES_OEMCONVERT|Il testo immesso nel controllo di modifica viene convertito dal set di caratteri ANSI al set di caratteri OEM e quindi nuovamente in ANSI. Ciò assicura la corretta conversione dei caratteri quando l'applicazione chiama la `AnsiToOem` funzione di Windows per convertire una stringa ANSI nel controllo di modifica in caratteri OEM. Questo stile è particolarmente utile per i controlli di modifica che contengono nomi di file.|
|ES_PASSWORD|Consente di visualizzare tutti i caratteri come asterisco ( __\*__ ) digitati nel controllo di modifica. Un'applicazione può utilizzare la `SetPasswordChar` funzione membro per modificare il carattere visualizzato.|
...
## <a name="list-box-styles"></a><a name="list-box-styles"></a> Stili della casella di riepilogo
...
|LBS_HASSTRINGS|Specifica una casella di riepilogo creata dal proprietario contenente elementi costituiti da stringhe. La casella di riepilogo gestisce la memoria e i puntatori per le stringhe in modo che l'applicazione possa usare la `GetText` funzione membro per recuperare il testo di un particolare elemento.|
...
## <a name="message-box-styles"></a><a name="message-box-styles"></a> Stili di finestra di messaggio
...
|SBS_HORZ|Designa una barra di scorrimento orizzontale. Se non viene specificato né lo stile SBS_BOTTOMALIGN né SBS_TOPALIGN, la barra di scorrimento avrà l'altezza, la larghezza e la posizione specificati nella `Create` funzione membro.|
...
|SBS_SIZEBOX|Designa una casella delle dimensioni. Se non viene specificato né lo stile SBS_SIZEBOXBOTTOMRIGHTALIGN né SBS_SIZEBOXTOPLEFTALIGN, la casella dimensioni ha l'altezza, la larghezza e la posizione specificati nella `Create` funzione membro.|
...
|SBS_VERT|Designa una barra di scorrimento verticale. Se non viene specificato né lo stile SBS_RIGHTALIGN né SBS_LEFTALIGN, la barra di scorrimento avrà l'altezza, la larghezza e la posizione specificati nella `Create` funzione membro.|
...
## <a name="window-styles"></a><a name="window-styles"></a> Stili finestra
