...
|[CWinAppEx::ShowPopupMenu](#showpopupmenu)|Visualizza un menu di scelta rapida.|  
...
##  <a name="showpopupmenu"></a>  CWinAppEx::ShowPopupMenu  
 Visualizza un menu di scelta rapida.  
