...
|[CDockingManager:: AdjustPaneFrames](#adjustpaneframes)|Fa in modo che il messaggio di WM_NCCALCSIZE venga inviato a tutti i riquadri e a tutte le `CPaneFrameWnd` finestre.|
