---
description: 'Altre informazioni su: classe CMonthCalCtrl'
...
Nell'implementazione di MFC di `GetCurSel` è possibile specificare un utilizzo `COleDateTime` , un utilizzo `CTime` o una `SYSTEMTIME` struttura.
