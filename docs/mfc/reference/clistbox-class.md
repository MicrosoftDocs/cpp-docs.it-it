...
##  <a name="getitemdataptr"></a>  CListBox::GetItemDataPtr  
 Recupera il valore a 32 bit fornito dall'applicazione associato all'elemento casella di riepilogo specificata come indicatore di misura ( **void\***).  
...
### <a name="remarks"></a>Note  
 Questa funzione membro emula la funzionalità dei [LB_GETLISTBOXINFO](http://msdn.microsoft.com/library/windows/desktop/bb775208) del messaggio, come descritto nel SDK di Windows.  
