...
|[CPaneContainerManager::Creare](#create)||
...
|[CPaneContainerManager::GetMinMaxOffsetCPaneContainerManager::GetMinMaxOffset](#getminmaxoffset)||
...
|[CPaneContainerManager::IsEmptyCPaneContainerManager::IsEmpty](#isempty)||
...
Il framework crea `CPaneContainerManager` automaticamente istanze di oggetti e li incorpora in [CPaneDivider Class](../../mfc/reference/cpanedivider-class.md) oggetti o [CMultiPaneFrameWnd Class](../../mfc/reference/cmultipaneframewnd-class.md) oggetti.

La `CPaneContainerManager` classe archivia un puntatore alla radice di un albero binario compilato da [CPaneContainer](../../mfc/reference/cpanecontainer-class.md) oggetti.

## <a name="example"></a>Esempio

Nell'esempio seguente viene illustrato come `CPaneContainerManager` ottenere un riferimento a un oggetto. Questo frammento di codice fa parte [dell'esempio Set Pane Size](../../overview/visual-cpp-samples.md).
...
[in] *pControlBarToAdd (Componente aggiuntivo)*<br/>
...
[in] *SrcManager (informazioni in base a srcManager*<br/>
[in] *bEdge*<br/>
[in] *pTargetControlBar (barpTargetControlBar)*<br/>
[in] *dwAllineamento*<br/>
[in] *(Impostazioni di copia)*<br/>
...
[in] *applicazioni plstControlBar*<br/>
[in] *plstSliders (informazioni in due)*<br/>
...
[in] *pBarToAdd (Componente aggiuntivo)*<br/>
...
[in] *rectOriginal*<br/>
[in] *rectInserted*<br/>
[in] *RectSlider (dispositivo rectSlider)*<br/>
[in] *dwSliderStyle (instileddddSliderStyle)*<br/>
[in] *dwAllineamento*<br/>
...
[in] *punto*<br/>
[in] *ppTargetControlBar (bardial' di controllo)*<br/>

### <a name="return-value"></a>Valore restituito

### <a name="remarks"></a>Osservazioni

## <a name="cpanecontainermanagercreate"></a><a name="create"></a>CPaneContainerManager::Creare
...
[in] *pDefaultSlider (dispositivo di impostazione inlingua com*<br/>
[in] *pContenitoreRTC*<br/>
...
## <a name="cpanecontainermanagergetminmaxoffset"></a><a name="getminmaxoffset"></a>CPaneContainerManager::GetMinMaxOffsetCPaneContainerManager::GetMinMaxOffset
...
[in] *NMinOffset (sbarramento in stato di incie*<br/>
[in] *nMaxOffset*<br/>
[in] *nPasso*<br/>
...
[in] *pControlBarToInsert (Inserimento bara)*<br/>
[in] *pTargetControlBar (barpTargetControlBar)*<br/>
[in] *dwAllineamento*<br/>
...
## <a name="cpanecontainermanagerisempty"></a><a name="isempty"></a>CPaneContainerManager::IsEmptyCPaneContainerManager::IsEmpty
...
[in] *punto*<br/>
[in] *nSensibilità*<br/>
[in] *bExactBar (informazioni in base alla proprietà del*<br/>
[in] *bIsTabArea*<br/>
[in] *bDidascalia*<br/>
...
[in] *pBarOld (Informazioni in base al tano*<br/>
[in] *pBarNuovo*<br/>
