...
|[CHotKeyCtrl::GetHotKey](#gethotkey)|Recupera i flag di codice e il modificatore chiavi virtuali di un tasto di scelta rapida da un controllo tasto di scelta.|  
...
## <a name="remarks"></a>Note  
 ...
 Per ulteriori informazioni sull'utilizzo `CHotKeyCtrl`, vedere [controlli](../../mfc/controls-mfc.md) e [CHotKeyCtrl utilizzando](../../mfc/using-chotkeyctrl.md).  
