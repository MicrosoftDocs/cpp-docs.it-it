...
## <a name="remarks"></a>Note  
 `CDocObjectServer`derivato da `CCmdTarget` e collabora a stretto contatto con `COleServerDoc` per esporre le interfacce.  
