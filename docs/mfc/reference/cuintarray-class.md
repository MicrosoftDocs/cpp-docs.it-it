---
description: 'Altre informazioni su: classe CUIntArray'
...
|Nome|Description|
|----------|-----------------|
|[Operatore \[ CUIntArray:: \]](../../mfc/reference/cobarray-class.md#operator_at)|Imposta o ottiene l'elemento in corrispondenza dell'indice specificato.|
