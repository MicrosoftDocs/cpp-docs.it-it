...
|*Rect*|[in] Riferimento a una struttura [RECT](/windows/win32/api/windef/ns-windef-rect) che contiene la posizione e le dimensioni del controllo nelle coordinate client.|
