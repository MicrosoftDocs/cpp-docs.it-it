---
title: Classe CMFCPrintPreviewToolBar | Documenti Microsoft
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
ms.locfileid: "33367464"
---
# <a name="cmfcprintpreviewtoolbar-class"></a>Classe CMFCPrintPreviewToolBar
La barra degli strumenti dell'anteprima di stampa.  
...
|-|-|  
|Nome|Descrizione|  
|`CMFCPrintPreviewToolBar::GetThisClass`|Usato dal framework per ottenere un puntatore per il [CRuntimeClass](../../mfc/reference/cruntimeclass-structure.md) oggetto associato a questo tipo di classe.|  
