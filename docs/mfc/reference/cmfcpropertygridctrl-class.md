...
|[CMFCPropertyGridCtrl::CloseColorPopup](#closecolorpopup)|Chiude la finestra di dialogo di selezione colori.|
|[CMFCPropertyGridCtrl::Create](#create)|Crea un controllo griglia delle proprietà e lo connette all'oggetto controllo della griglia delle proprietà.|
...
|[CMFCPropertyGridCtrl::EnableDescriptionArea](#enabledescriptionarea)|Abilita o Disabilita l'area della descrizione visualizzata sotto l'elenco delle proprietà.|
...
|[CMFCPropertyGridCtrl::EnsureVisible](#ensurevisible)|Scorre un controllo griglia delle proprietà ed espande gli elementi della proprietà fino a quando la proprietà specificata non è visibile.|
|[CMFCPropertyGridCtrl::ExpandAll](#expandall)|Espande o comprime tutti i nodi di controllo della griglia delle proprietà.|
...
|[CMFCPropertyGridCtrl::get_accHelp](#get_acchelp)|Chiamata eseguita dal Framework per recuperare la stringa di `Help` proprietà di un oggetto. Esegue l'override di [CWnd:: get_accHelp](../../mfc/reference/cwnd-class.md#get_acchelp).|
...
Per usare un controllo griglia delle proprietà, costruire `CMFCPropertyGridCtrl` un oggetto e quindi chiamare il metodo [CMFCPropertyGridCtrl:: create](#create) . Usare il metodo [CMFCPropertyGridCtrl:: AddProperty](#addproperty) per aggiungere proprietà all'elenco.
...
Per ulteriori informazioni sulla finestra di dialogo Selezione colori, vedere [classe CMFCPropertyGridColorProperty](../../mfc/reference/cmfcpropertygridcolorproperty-class.md).
...
Per impostazione predefinita, questo metodo usa il metodo [CString:: compare](../../atl-mfc-shared/reference/cstringt-class.md#compare) per confrontare `CMFCPropertyGridProperty::m_strName` i membri dei parametri specificati.

##  <a name="create"></a>  CMFCPropertyGridCtrl::Create

Crea un controllo griglia delle proprietà e lo connette all'oggetto controllo della griglia delle proprietà.
...
Per creare un controllo griglia delle proprietà, chiamare prima [CMFCPropertyGridCtrl:: CMFCPropertyGridCtrl](#cmfcpropertygridctrl) per costruire un oggetto griglia delle proprietà. Chiamare `CMFCPropertyGridCtrl::Create`quindi.
...
Questo metodo recupera il colore utilizzato dal Framework per creare lo sfondo del controllo della griglia delle proprietà corrente. Il metodo [CMFCPropertyGridCtrl:: GetTextColor](#gettextcolor) Recupera il colore di primo piano.
...
Puntatore all'oggetto Property che corrisponde all'indice specificato se questo metodo ha esito positivo; in caso `NULL`contrario,.
...
Puntatore a un oggetto barra di scorrimento o NULL se non è presente una barra di scorrimento o se l'orientamento della barra di scorrimento è SB_HORZ.
...
##  <a name="ondrawlist"></a>CMFCPropertyGridCtrl:: ondisegnato
...
Per impostazione predefinita, questo metodo invia il messaggio [AFX_WM_PROPERTY_CHANGED](../../mfc/reference/afx-messages.md) al proprietario del controllo griglia delle proprietà.
...
##  <a name="setcursel"></a>CMFCPropertyGridCtrl:: CurSel
...
Se si esegue l'override di questo metodo, restituire TRUE se i dati della proprietà specificati sono validi. In caso contrario, restituisce FALSE, nel qual caso il Framework non aggiorna la proprietà.
