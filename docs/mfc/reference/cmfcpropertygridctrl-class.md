---
description: 'Altre informazioni su: classe CMFCPropertyGridCtrl'
...
|[CMFCPropertyGridCtrl::D eleteProperty](#deleteproperty)|Elimina la proprietà specificata dal controllo griglia delle proprietà.|
...
|[CMFCPropertyGridCtrl:: pulsante ExpandAll](#expandall)|Espande o comprime tutti i nodi di controllo della griglia delle proprietà.|
...
|[CMFCPropertyGridCtrl:: get_accHelp](#get_acchelp)|Chiamata eseguita dal Framework per recuperare la stringa di proprietà di un oggetto `Help` . Esegue l'override di [CWnd:: get_accHelp](../../mfc/reference/cwnd-class.md#get_acchelp).|
...
## <a name="cmfcpropertygridctrlondrawlist"></a><a name="ondrawlist"></a> CMFCPropertyGridCtrl:: ondisegnato
