...
|[AfxFormatString2](#afxformatstring2)|Le stringhe di sostituzione due per il formato caratteri "%1" e "%2" in una stringa contenuta nella tabella di stringhe.|  
 ...
 *lpszFullString*  
 -   Stringa contenente il testo completo della stringa da estrarre.  
...
### <a name="remarks"></a>Note  
 ...
 Questa funzione restituisce FALSE se entrambi *lpszFullString* è impostato su NULL o funzione raggiunge la fine del *lpszFullString* senza ricerca *iSubString*+ 1 occorrenze dei caratteri di separazione specificato. Il *rString* parametro non verrà modificato rispetto al valore originale se *lpszFullString* è stato impostato su NULL; in caso contrario, il *rString* parametro è impostato su una stringa vuota se Impossibile estrarre la sottostringa per l'indice specificato.  
...
##  <a name="afxformatstring1"></a>  AfxFormatString1  
 Sostituisce la stringa a cui puntata *lpsz1* per tutte le istanze dei caratteri "%1" nella risorsa della stringa di modello identificata da *nIDS*.  
...
##  <a name="afxformatstring2"></a>  AfxFormatString2  
 Sostituisce la stringa a cui puntata *lpsz1* per tutte le istanze dei caratteri "%1" e la stringa a cui punta *lpsz2* per tutte le istanze dei caratteri "%2", la risorsa di stringa di modello identificato da *nIDS*.  
 ...
 *nIDS*  
 L'ID di tabella di stringa della stringa del modello in cui verrà eseguita la sostituzione.  
...
### <a name="remarks"></a>Note  
 La nuova stringa creata viene archiviata *rString*. Se la stringa nella tabella di stringhe è "File %1 non trovato nella directory %2", ad esempio *lpsz1* punta a "MYFILE. TXT", e *lpsz2* punta a"C:\MYDIR", quindi *rString* conterrà la stringa"File MYFILE. TXT non trovato nella directory C:\MYDIR"  
  
 Se il formato di caratteri "%1" o "%2" è presente nella stringa di più di una volta, verranno effettuate più sostituzioni. Non dispone in ordine numerico.  
 ...
 *nIDHelp*  
 L'ID del contesto della Guida per il messaggio; 0 indica che verrà utilizzato al contesto della Guida predefinito dell'applicazione.  
...
- Pulsante Interrompi il IDABORT è stato selezionato.  
  
- Pulsante Annulla il IDCANCEL è stato selezionato.  
  
- Ignorare il IDIGNORE pulsante è stato selezionato.  
  
- Pulsante IDNO di n è stato selezionato.  
  
- Pulsante OK il IDOK è stato selezionato.  
  
- Ripetere il IDRETRY pulsante è stato selezionato.  
  
- Pulsante IDYES il Sì è stato selezionato.  
  
 Se una finestra di messaggio ha un pulsante di annullamento, verrà restituito il valore IDCANCEL se viene premuto il tasto ESC o se è selezionato il pulsante Annulla. Se la finestra di messaggio non dispone di alcun pulsante Annulla, premendo il tasto ESC ha effetto.  
