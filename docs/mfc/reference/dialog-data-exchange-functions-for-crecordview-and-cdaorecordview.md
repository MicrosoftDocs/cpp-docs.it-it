---
title: Funzioni di scambio di dati di finestra di dialogo per CRecordView e CDaoRecordView | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
