 ...
 *pFontDesc*  
 Un puntatore a un [FONTDESC](http://msdn.microsoft.com/library/windows/desktop/ms692782) struttura che contiene i valori per inizializzare lo stato predefinito della proprietà del tipo di carattere quando *pFontDispAmbient* è NULL.  
