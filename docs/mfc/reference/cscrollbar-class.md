...
Questa funzione membro emula la funzionalità del messaggio [SBM_SCROLLBARINFO](/windows/win32/Controls/sbm-getscrollbarinfo) , come descritto nel Windows SDK.
