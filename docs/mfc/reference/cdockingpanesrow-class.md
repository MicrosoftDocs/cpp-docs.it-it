...
Chiamare questo metodo per disporre i riquadri nella riga in cui verranno ancorati. Dopo aver chiamato questo metodo, è necessario `CDockingPanesRow::FixupVirtualRects(FALSE, NULL)`chiamare.
