...
|[CD2DTextLayout::~CD2DTextLayout](#_dtorcd2dtextlayout)|Distruttore. Chiamato quando viene eliminata definitivamente un oggetto di layout di testo D2D.|
