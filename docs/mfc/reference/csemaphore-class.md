 ...
 *lpsaAttributes*  
 Attributi di sicurezza per l'oggetto semaforo. Per una descrizione completa della struttura, vedere [SECURITY_ATTRIBUTES](http://msdn.microsoft.com/library/windows/desktop/aa379560) nel [!INCLUDE[winSDK](../../atl/includes/winsdk_md.md)].  
