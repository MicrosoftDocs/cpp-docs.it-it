...
### <a name="return-value"></a>Valore restituito  
 **TRUE** se chiamare la classe `IsDerivedFrom` è derivata dalla base classe il cui `CRuntimeClass` struttura è specificato come parametro; in caso contrario **FALSE**.  
