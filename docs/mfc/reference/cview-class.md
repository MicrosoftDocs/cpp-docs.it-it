...
|Nome|Descrizione|
|----------|-----------------|
|[CView::D oPreparePrinting](#doprepareprinting)|Visualizza la finestra di dialogo Stampa e crea il contesto di dispositivo stampante; chiamare quando si esegue l'override della `OnPreparePrinting` funzione membro.|
...
|[CView:: OnPrepareDC](#onpreparedc)|Chiamata eseguita prima della `OnDraw` chiamata della funzione membro per la visualizzazione dello schermo o della `OnPrint` chiamata della funzione membro per la stampa o l'anteprima di stampa.|
