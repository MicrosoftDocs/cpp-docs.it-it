...
|[CD2DTextFormat::~CD2DTextFormat](#_dtorcd2dtextformat)|Distruttore. Chiamato quando viene eliminata definitivamente un oggetto formato di testo D2D.|
