...
|Name|Descrizione|
|----------|-----------------|
|[CCheckListBox:: create](#create)|Crea la casella di controllo di Windows e la collega all'oggetto `CCheckListBox`.|
...
Si costruisce un oggetto `CCheckListBox` in due passaggi. Definire prima una classe derivata da `CCheckListBox`, quindi chiamare `Create`, che inizializza la casella di controllo di Windows e la collega all'oggetto `CCheckListBox`.
...
*pParentWnd*<br/>
Specifica la finestra padre della casella di controllo, in genere un oggetto `CDialog`. Non deve essere NULL.
...
Si costruisce un oggetto `CCheckListBox` in due passaggi. Definire innanzitutto una classe derivata da `CcheckListBox`, quindi chiamare `Create`, che inizializza la casella di controllo di Windows e la collega al `CCheckListBox`. Per un esempio, vedere [CCheckListBox:: CCheckListBox](#cchecklistbox) .
