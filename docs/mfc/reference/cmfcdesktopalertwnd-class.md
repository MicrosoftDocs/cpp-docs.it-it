...
[in] [out] *pWndOwner* specifica il proprietario della finestra di avviso. Tale proprietario riceverà tutte le notifiche per la finestra di avviso. Questo valore non può essere NULL.
