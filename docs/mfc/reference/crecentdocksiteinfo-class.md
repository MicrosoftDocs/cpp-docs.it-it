---
title: Classe CRecentDockSiteInfo | Documenti di Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
Il `CRecentDockSiteInfo` classe è una classe helper che archivia informazioni sullo stato recenti per il [CPane classe](../../mfc/reference/cpane-class.md).  
