...
2.  Durante l'elaborazione di `WM_CREATE` messaggio nel frame principale, chiamata il [CMFCOutlookBar::Create](#create) i metodi per creare il controllo scheda della barra di Outlook.  
