...
|[CStatusBarCtrl::DrawItem](#drawitem)|Chiamata eseguita quando un aspetto visivo di un proprietario barra controllo di stato.|  
...
|[CStatusBarCtrl::GetIcon](#geticon)|Recupera l'icona relativa a una parte (noto anche come un riquadro) in cui il controllo barra di stato corrente.|  
...
|[CStatusBarCtrl:: Gettextlength](#gettextlength)|Recuperare la lunghezza, espressa in caratteri, del testo da parte specificata di un controllo barra di stato.|  
|[CStatusBarCtrl::GetTipText](#gettiptext)|Recupera il testo della descrizione comando per un riquadro in una barra di stato.|  
|[CStatusBarCtrl::IsSimple](#issimple)|Controlla il controllo di una finestra di stato per determinare se è in modalità semplice.|  
...
|[CStatusBarCtrl::SetMinHeight](#setminheight)|Imposta l'altezza minima di uno stato area di disegno del controllo della barra.|  
...
|[CStatusBarCtrl::SetSimple](#setsimple)|Specifica se un controllo barra di stato viene visualizzato testo semplice o Visualizza tutte le parti del controllo impostate da una chiamata precedente a `SetParts`.|  
...
## <a name="remarks"></a>Note  
 ...
 Questo controllo (e pertanto il `CStatusBarCtrl` classe) è disponibile solo per i programmi in esecuzione in Windows 95/98 e Windows NT versione 3.51 e successive.  
 ...
 *dwStyle*  
 Specifica lo stile del controllo barra di stato. Applicare qualsiasi combinazione di stili del controllo nella barra di stato [comuni degli stili del controllo](http://msdn.microsoft.com/library/windows/desktop/bb775498) in Windows SDK. Questo parametro deve includere lo stile WS_CHILD. Potrebbe includere anche lo stile WS_VISIBLE.  
  
 *Rect*  
 Specifica dimensioni e la posizione del controllo barra di stato. Può essere un [CRect](../../atl-mfc-shared/reference/crect-class.md) oggetto o una [RECT](http://msdn.microsoft.com/library/windows/desktop/dd162897) struttura.  
...
### <a name="parameters"></a>Parametri  
 *pBorders*  
 Indirizzo di una matrice di interi con tre elementi. Il primo elemento riceve lo spessore del bordo orizzontale, la seconda riceve la larghezza del bordo verticale e il terzo riceve lo spessore del bordo tra i rettangoli.  
...
##  <a name="geticon"></a>  CStatusBarCtrl::GetIcon  
 Recupera l'icona relativa a una parte (noto anche come un riquadro) in cui il controllo barra di stato corrente.  
...
|---------------|-----------------|  
|[in] *iPart*|Indice in base zero della parte che contiene l'icona da recuperare. Se questo parametro è -1, si presuppone che la barra di stato da una barra di stato di visualizzazione semplice.|  
...
### <a name="example"></a>Esempio  
 Esempio di codice seguente consente di copiare un'icona due riquadri del controllo barra di stato corrente. In una sezione dell'esempio di codice precedente abbiamo creato un controllo barra di stato con tre riquadri e quindi aggiunta un'icona per il primo riquadro. Questo esempio recupera l'icona dal riquadro primo e quindi lo aggiunge al riquadro secondo e terzo.  
...
### <a name="parameters"></a>Parametri  
 *nParts*  
 Numero di parti per il quale recuperare le coordinate. Se questo parametro è maggiore del numero di parti di un controllo, il messaggio recupera coordinate esistente solo per le parti.  
  
 *pParts*  
 Indirizzo di una matrice di interi con lo stesso numero di elementi come il numero di parti specificato da *nParts*. Ogni elemento nella matrice riceve le coordinate client del bordo destro della parte corrispondente. Se un elemento è impostato su - 1, la posizione del bordo destro di una parte estende al bordo destro della barra di stato.  
  
### <a name="return-value"></a>Valore restituito  
 Il numero di parti di un controllo se ha esito positivo oppure zero in caso contrario.  
...
- SBT_OWNERDRAW se il testo ha SBT_OWNERDRAW tipo, di disegno *PDigitare* riceve questo messaggio e restituisce il valore a 32 bit associato al testo anziché al tipo di lunghezza e l'operazione.  
...
##  <a name="gettextlength"></a>  CStatusBarCtrl:: Gettextlength  
 Recupera la lunghezza, in caratteri, del testo da parte specificata di un controllo barra di stato.  
...
### <a name="return-value"></a>Valore restituito  
 Un [CString](../../atl-mfc-shared/reference/cstringt-class.md) oggetto contenente il testo da utilizzare nella descrizione comando.  
...
##  <a name="issimple"></a>  CStatusBarCtrl::IsSimple  
 Controlla il controllo di una finestra di stato per determinare se è in modalità semplice.  
...
### <a name="return-value"></a>Valore restituito  
 Diverso da zero se il controllo di finestra di stato è in modalità semplice. zero in caso contrario.  
...
### <a name="parameters"></a>Parametri  
 *CR*  
 Valore COLORREF che specifica il nuovo colore di sfondo. Specificare il valore CLR_DEFAULT affinché la barra di stato da usare il colore di sfondo predefinito.  
...
### <a name="parameters"></a>Parametri  
 *nPane*  
 Indice in base zero del riquadro che riceverà l'icona. Se questo parametro è -1, si presuppone che la barra di stato da una barra di stato semplice.  
  
 *Icona*  
 Handle per l'icona da impostare. Se questo valore è NULL, l'icona viene rimosso dalla parte.  
...
##  <a name="setminheight"></a>  CStatusBarCtrl::SetMinHeight  
 Imposta l'altezza minima di uno stato area di disegno del controllo della barra.  
...
### <a name="remarks"></a>Note  
 L'altezza minima è la somma dei *nMin* e due volte la larghezza, in pixel, del bordo verticale del controllo barra di stato.  
...
##  <a name="setsimple"></a>  CStatusBarCtrl::SetSimple  
 Specifica se un controllo barra di stato viene visualizzato testo semplice o Visualizza tutte le parti del controllo impostate da una chiamata precedente a [SetParts](#setparts).  
...
### <a name="parameters"></a>Parametri  
 [in] *bSimple*  
 Flag di tipo di visualizzazione. Se questo parametro è TRUE, il controllo viene visualizzato testo semplice; Se è FALSE, vengono visualizzate più parti.  
