---
title: Utilizzo di finestre cornice | Documenti Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
-   [Trascinamento della selezione di file in una finestra cornice](../mfc/dragging-and-dropping-files-in-a-frame-window.md)  
...
-   [Guida sensibile al contesto di gestione](../mfc/orchestrating-other-window-actions.md)  
