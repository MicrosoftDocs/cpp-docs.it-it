...
2.  [Definire una variabile membro](../mfc/activex-control-containers-connecting-an-activex-control-to-a-member-variable.md) (o altro tipo di accesso) dello stesso tipo di ActiveX classe wrapper del controllo.  
  
3.  [Programmare il controllo ActiveX](#_core_programming_the_activex_control) usando funzioni di membro della classe wrapper predefinite.  
...
3.  Aprire il **dialogo** cartella.  
  
4.  Fare doppio clic sul modello della finestra di dialogo principale. Per questo esempio, usare **IDD_CONTAINER_DIALOG**.  
  
5.  Fare clic sull'icona del controllo Circ della casella degli strumenti.  
  
6.  Fare clic su un punto nella finestra di dialogo per inserire il controllo Circ.  
  
7.  Dal **File** menu, scegliere **Salva tutto** per salvare tutte le modifiche al modello della finestra di dialogo.  
