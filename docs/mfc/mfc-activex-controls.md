...
Sono inoltre disponibili degli esempi di controlli ActiveX MFC. Per altre informazioni su questi esempi, vedere [esempi di controlli: Controlli ActiveX, basata su MFC](../visual-cpp-samples.md)
