---
description: 'Altre informazioni su: controlli ActiveX MFC'
...
Sono inoltre disponibili degli esempi di controlli ActiveX MFC. Per ulteriori informazioni su questi esempi, vedere [controlli Samples: MFC-Based ActiveX Controls](../overview/visual-cpp-samples.md)
