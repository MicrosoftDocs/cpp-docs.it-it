...
|`CUIntArray`||`CMapWordToPtr`|  
 ...
 Le caratteristiche di classi Collection MFC tabella [suggerimenti per la scelta di una classe Collection](../mfc/recommendations-for-choosing-a-collection-class.md) descrive le classi collection MFC in termini di queste caratteristiche (ad eccezione della forma):  
