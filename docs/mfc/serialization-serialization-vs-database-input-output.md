---
title: 'Serializzazione: Visual Studio di serializzazione. Input-Output del database'
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "57293160"
---
# <a name="serialization-serialization-vs-database-inputoutput"></a>Serializzazione: Visual Studio di serializzazione. Input/Output del database
