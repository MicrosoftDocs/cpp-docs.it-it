---
title: Un esempio dei commenti | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
ms.locfileid: "46442344"
---
# <a name="an-example-of-the-comments"></a>Esempio dei commenti

Il seguente elenco parziale della classe `CChildFrame` utilizza la maggior parte dei commenti standard usato da MFC nelle relative classi per cui dividere i modi in cui vengono usati i membri della classe:

[!code-cpp[NVC_MFCListView#5](../atl/reference/codesnippet/cpp/an-example-of-the-comments_1.h)]

Questi commenti contrassegnano in modo coerente le sezioni della dichiarazione di classe contenenti tipi di membri di classi simili. Tenere presente che queste sono le convenzioni di MFC, non impostare le regole.
