...
-   [Tramite l'aggiunta guidata proprietà per aggiungere una proprietà predefinita](#_core_using_classwizard_to_add_a_stock_property)  
...
##  <a name="_core_classwizard_changes_for_stock_properties"></a>Aggiungere una modifica di proprietà per proprietà predefinite  
