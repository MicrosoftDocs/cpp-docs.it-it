...
> [!NOTE]
>  `CRect`, `CSize`, e `CPoint` possono essere usati nelle applicazioni ATL o MFC. Inoltre, `CStringT` fornisce un indipendente da MFC `CString`-Analogamente alla classe. Per ulteriori informazioni sulle classi di utilità condivisi, vedere [classi condivise](../atl-mfc-shared/atl-mfc-shared-classes.md).  
