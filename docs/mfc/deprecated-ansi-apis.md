---
description: 'Altre informazioni su: API ANSI deprecate'
title: API ANSI deprecate
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "97290986"
---
# <a name="deprecated-ansi-apis"></a>API ANSI deprecate

La libreria MFC (Microsoft Foundation Class) esegue la migrazione verso le classi e i metodi basati sul set di caratteri Unicode. Di conseguenza, le versioni ANSI di diversi metodi MFC sono deprecate. Usare le versioni Unicode di questi metodi nelle applicazioni future.

A partire da controlli comuni di Windows versione 6,1, fornita in Windows Vista, i metodi ANSI seguenti sono deprecati.
