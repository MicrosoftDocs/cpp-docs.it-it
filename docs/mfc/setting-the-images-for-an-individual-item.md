---
description: 'Altre informazioni su: impostazione delle immagini per un singolo elemento'
...
Nell'esempio seguente viene inserito un nuovo elemento della casella combinata estesa ( `cbi` ) nel controllo casella combinata estesa ( `m_comboEx` ), fornendo gli indici per tutti e tre gli Stati dell'immagine:
