...
### Per copiare pulsanti da una barra degli strumenti  
  
1.  Tenere premuto **CTRL**.  
  
2.  Nel riquadro **Visualizzazione della barra degli strumenti**, trascinare il pulsante nella nuova posizione all'interno della barra degli strumenti oppure all'interno di un'altra barra degli strumenti.  
