...
#### Parametri  
 `mode`  
 Modalità di esecuzione di un processo chiamante.  
...
## Note  
 Ognuna di queste funzioni crea ed esegue un nuovo processo, passando un array di puntatori agli argomenti della riga di comando e un array di puntatori alle impostazioni di ambiente.  
