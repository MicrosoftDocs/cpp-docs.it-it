---
description: 'Altre informazioni su: fesetenv'
title: fesetenv
ms.date: 04/05/2018
api_name:
- fesetenv
...
La funzione **fesetenv** imposta l'ambiente a virgola mobile corrente dal valore archiviato nell'oggetto **fenv_t** a cui fa riferimento *penv*. L'ambiente a virgola mobile è il set di flag dello stato e le modalità di controllo che influiscono sui calcoli a virgola mobile. Ciò include la modalità di arrotondamento e i flag di stato delle eccezioni a virgola mobile.  Se *penv* non è **FE_DFL_ENV** o non punta a un oggetto **fenv_t** valido, il comportamento successivo non è definito.
