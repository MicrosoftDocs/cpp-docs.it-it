...
**_wrename** è una versione a caratteri wide di **_rename**; gli argomenti di **_wrename** sono stringhe a caratteri wide. **_wrename** e **_rename** si comportano in modo identico.
