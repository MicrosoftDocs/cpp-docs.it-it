...
**wrename** è una versione a caratteri wide **ridenominazione**; gli argomenti da **wrename** sono stringhe a caratteri "wide". **wrename** e **ridenominazione** si comportano in modo identico in caso contrario.
