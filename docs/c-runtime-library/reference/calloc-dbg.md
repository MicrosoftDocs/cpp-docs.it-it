---
description: 'Altre informazioni su: _calloc_dbg'
title: _calloc_dbg
ms.date: 11/04/2016
api_name:
- _calloc_dbg
...
**_calloc_dbg** è una versione di debug della funzione [calloc](calloc.md) . Quando [_DEBUG](../../c-runtime-library/debug.md) non è definito, ogni chiamata a **_calloc_dbg** viene ridotta a una chiamata a **calloc**. Sia **calloc** che **_calloc_dbg** allocano blocchi di memoria *numerici* nell'heap di base, ma **_calloc_dbg** offre diverse funzionalità di debug:
...
**_calloc_dbg** imposta **errno** su **ENOMEM** se un'allocazione di memoria ha esito negativo. **EINVAL** viene restituito se la quantità di memoria necessaria (incluso l'overhead indicato in precedenza) supera **_HEAP_MAXREQ**. Per informazioni su questo e altri codici di errore, vedere [errno, _doserrno, _sys_errlist e _sys_nerr](../../c-runtime-library/errno-doserrno-sys-errlist-and-sys-nerr.md).
