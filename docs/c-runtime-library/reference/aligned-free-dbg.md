...
*memblock* un puntatore al blocco di memoria che è stato restituito per il [aligned_malloc](aligned-malloc.md) oppure [aligned_offset_malloc](aligned-offset-malloc.md) (funzione).
