...
Per altre informazioni, vedere [campi di specifica di formato: funzioni scanf e funzioni wscanf](../../c-runtime-library/format-specification-fields-scanf-and-wscanf-functions.md).
