...
|*buffer*|*size*|Return|Contenuto del *buffer*|
|--------------|------------------------|------------|--------------------------|
...
[Ora, _time32, _time64](time-time32-time64.md)\
[_tzset](tzset.md)
