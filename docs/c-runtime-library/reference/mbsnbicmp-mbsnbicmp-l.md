...
helpviewer_keywords: 
  - "_mbsnbicmp (funzione)"
  - "_mbsnbicmp_l (funzione)"
  - "_strnicmp (funzione)"
  - "_strnicmp_l (funzione)"
  - "_tcsnicmp (funzione)"
  - "_tcsnicmp_l (funzione)"
  - "_wcsnicmp (funzione)"
  - "_wcsnicmp_l (funzione)"
  - "mbsnbicmp (funzione)"
  - "mbsnbicmp_l (funzione)"
...
## Esempio  
 Vedere l'esempio per [\_mbsnbcmp, \_mbsnbcmp\_l](../../c-runtime-library/reference/mbsnbcmp-mbsnbcmp-l.md).  
