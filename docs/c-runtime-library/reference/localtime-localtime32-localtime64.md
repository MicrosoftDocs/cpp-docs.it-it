...
**_localtime64**, che usa la **__time64_t** struttura, consente date relativamente a 23:59:59, 31 dicembre 3000, ora UTC (coordinated universal time), mentre **_localtime32** rappresenta le date a 23:59:59 18 gennaio 2038, ore UTC.

**LocalTime** è una funzione inline che restituisce **_localtime64**, e **time_t** equivale a **__time64_t**. Se è necessario forzare il compilatore a interpretare **time_t** come precedente 32 bit **time_t**, è possibile definire **_USE_32BIT_TIME_T**. Questo determinerebbe **localtime** restituisca **_localtime32**. Questa operazione non è consigliabile perché potrebbero verificarsi errori per l'applicazione dopo il 18 gennaio 2038 e l'uso non è consentito in piattaforme a 64 bit.
