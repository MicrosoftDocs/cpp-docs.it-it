...
Per ulteriori informazioni su questi codici di errore, vedere [ \_doserrno, errno, \_sys\_errlist e \_sys\_Nerr](../../c-runtime-library/errno-doserrno-sys-errlist-and-sys-nerr.md) .
