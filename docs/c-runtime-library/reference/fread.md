...
Per ulteriori informazioni su questi codici di errore, vedere [ \_doserrno, errno, \_sys\_errlist \_e\_sys Nerr](../../c-runtime-library/errno-doserrno-sys-errlist-and-sys-nerr.md) .
