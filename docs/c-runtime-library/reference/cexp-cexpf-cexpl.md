...
Dato che C++ consente l'overload, è possibile chiamare overload di **cexp** che accettano e restituiscono **fcomplex** e **_Lcomplex** valori. In un programma C **cexp** accetta e restituisce sempre un **_Dcomplex** valore.
