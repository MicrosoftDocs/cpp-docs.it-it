...
Il **chgsign** le funzioni restituiscono un valore che è uguale all'argomento a virgola mobile *x*, ma con segno invertita. Non vi è restituzione di errori.
