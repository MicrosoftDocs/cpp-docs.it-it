...
Queste funzioni POSIX sono deprecate. In alternativa, usare [_strdup, _wcsdup, _mbsdup](../../c-runtime-library/reference/strdup-wcsdup-mbsdup.md) conforme a ISO C++.