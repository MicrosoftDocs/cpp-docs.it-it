...
Poiché C++ consente l'overload, è possibile chiamare overload di **cacosh** che accettino e restituiscano **fcomplex** e **_Lcomplex** valori. In un programma C **cacosh** accetta e restituisce sempre un **_Dcomplex** valore.
