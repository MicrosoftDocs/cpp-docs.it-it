...
La struttura **_utimbuf** archivia le ore di accesso e modifica dei file usate da **_utime** per modificare le date di modifica dei file. La struttura presenta i campi seguenti, entrambi di tipo **time_t**:
...
Le versioni specifiche della struttura **_utimbuf** ( **_utimebuf32** e **__utimbuf64**) vengono definite usando le versioni a 32 bit e 64 bit del tipo time. Queste strutture vengono usate nelle versioni a 32 bit e 64 bit specifiche di questa funzione. per impostazione predefinita, **_utimbuf** usa un tipo di ora a 64 bit a meno che non sia stato definito **_USE_32BIT_TIME_T** .
