...
Le versioni di queste funzioni che hanno il suffisso **suffisso** sono identiche, ad eccezione del fatto che usano il parametro delle *impostazioni locali* anziché le impostazioni locali del thread corrente.
