...
dev_langs: 
  ...
  - "C"
helpviewer_keywords: 
  - "_tfreopen_s (funzione)"
  - "_wfreopen_s (funzione)"
...
Riassegna un puntatore del file.  Queste versioni di [freopen, \_wfreopen](../../c-runtime-library/reference/freopen-wfreopen.md) dispongono di miglioramenti della sicurezza, come descritto in [Funzionalità di sicurezza in CRT](../../c-runtime-library/security-features-in-the-crt.md).  
...
|`_tfreopen_s`|`freopen_s`|`freopen_s`|`_wfreopen_s`|  
 ...
 `freopen_s` è in genere usato per reindirizzare i file già aperti `stdin`, `stdout` e `stderr` ai file specificati dall'utente.  Il nuovo file associato a `stream` viene aperto con `mode`*,* che è una stringa di caratteri che specifica il tipo di accesso richiesto per il file, come indicato di seguito:  
