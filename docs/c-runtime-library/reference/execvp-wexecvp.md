...
Ognuna di queste funzioni carica ed esegue un nuovo processo, passando una matrice di puntatori agli argomenti della riga di comando e utilizzando la variabile di ambiente **PATH** per trovare il file da eseguire.
