---
description: 'Altre informazioni su: _strtoi64, _wcstoi64, _strtoi64_l, _wcstoi64_l'
...
L'impostazione della categoria **LC_NUMERIC** delle impostazioni locali determina il riconoscimento del carattere radice in *strSource*; Per ulteriori informazioni, vedere [setlocale](setlocale-wsetlocale.md). Le funzioni senza il suffisso _l usano le impostazioni locali correnti; **_strtoi64_l** e **_wcstoi64_l** sono identici alla funzione corrispondente senza il suffisso **_L** ad eccezione del fatto che usano le impostazioni locali passate. Per altre informazioni, vedere [Locale](../../c-runtime-library/locale.md).
