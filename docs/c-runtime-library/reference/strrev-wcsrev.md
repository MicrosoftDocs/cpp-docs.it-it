...
Queste funzioni POSIX sono deprecate. Usare invece le funzioni conformi ISO C++ [_strrev, _wcsrev, _mbsrev, _mbsrev_l](../../c-runtime-library/reference/strrev-wcsrev-mbsrev-mbsrev-l.md).