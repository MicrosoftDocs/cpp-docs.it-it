...
## <a name="return-value"></a>Valore restituito  
 Il coseno di `z`, espresso in radianti.  
  
## <a name="remarks"></a>Note  
 Dato che C++ consente l'overload, è possibile chiamare degli overload di `ccos` che accettino e restituiscano valori `_Fcomplex` e `_Lcomplex`. In un programma C `ccos` accetta e restituisce sempre un valore `_Dcomplex` .  
