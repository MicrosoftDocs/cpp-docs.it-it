...
Dato che C++ consente l'overload, è possibile chiamare overload di **ccos** che accettano e restituiscono **fcomplex** e **_Lcomplex** valori. In un programma C **ccos** accetta e restituisce sempre un **_Dcomplex** valore.
