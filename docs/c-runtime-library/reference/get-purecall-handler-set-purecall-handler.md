...
## <a name="remarks"></a>Note  
 ...
 Dato che esiste un solo `_purecall_handler` per ogni processo, la chiamata di `_set_purecall_handler` ha effetto immediato su tutti i thread. L'ultimo chiamante in qualsiasi thread imposta il gestore.  
