---
description: 'Altre informazioni su: _getchar_nolock, _getwchar_nolock'
...
**_getchar_nolock** e **_getwchar_nolock** sono identici a **GetChar** e **getwchar** , ad eccezione del fatto che non sono protette da interferenze da parte di altri thread. Potrebbero essere più veloci perché non comportano un sovraccarico che blocca altri thread. Utilizzare queste funzioni solo in contesti thread-safe come applicazioni a thread singolo o dove l'ambito chiamante già gestisce l'isolamento del thread.
