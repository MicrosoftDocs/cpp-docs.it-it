...
Poiché C++ consente l'overload, è possibile chiamare overload di **csin** che accettino e restituiscano **fcomplex** e **_Lcomplex** valori. In un programma C **csin** accetta e restituisce sempre un **_Dcomplex** valore.
