...
**difftime** restituisce il tempo trascorso in secondi, da *timeStart* a *inizioOra di fine*. Il valore restituito è un numero a virgola mobile e precisione doppia. Il valore restituito può essere 0 e indica un errore.

## <a name="remarks"></a>Note

Il **difftime** funzione calcola la differenza tra i due valori temporali forniti *timeStart* e *inizioOra di fine*.

Il valore di ora fornito deve adattarsi all'interno dell'intervallo di **time_t**. **time_t** è un valore a 64 bit. Pertanto, la fine dell'intervallo è stata estesa da 23:59:59 18 gennaio, 2038, ora UTC a 23:59:59, 31 dicembre, 3000. L'intervallo inferiore di **time_t** è ancora mezzanotte del 1 ° gennaio 1970.

**difftime** è una funzione inline che restituisce uno **_difftime32** o **_difftime64** a seconda che **_USE_32BIT_TIME_T** è definito. _difftime32 e _difftime64 possono essere utilizzati direttamente per imporre l'utilizzo di una determinata dimensione del tipo di tempo.
