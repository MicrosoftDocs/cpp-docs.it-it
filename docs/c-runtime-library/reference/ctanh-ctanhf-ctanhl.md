...
Poiché C++ consente l'overload, è possibile chiamare overload di **ctanh** che accettino e restituiscano **fcomplex** e **_Lcomplex** valori. In un programma C **ctanh** accetta e restituisce sempre un **_Dcomplex** valore.
