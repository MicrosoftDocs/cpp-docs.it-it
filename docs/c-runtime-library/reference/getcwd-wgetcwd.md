...
description: Le funzioni della libreria di runtime C _getcwd _wgetcwd ottenere la directory di lavoro corrente.
ms.date: 4/2/2020
api_name:
- _wgetcwd
- _getcwd
...
Quando vengono definiti **_DEBUG** e **_CRTDBG_MAP_ALLOC** , le chiamate a **_getcwd** e **_wgetcwd** vengono sostituite dalle chiamate a **_getcwd_dbg** e **_wgetcwd_dbg** per consentire il debug delle allocazioni di memoria. Per altre informazioni, vedere [_getcwd_dbg, _wgetcwd_dbg](getcwd-dbg-wgetcwd-dbg.md).
