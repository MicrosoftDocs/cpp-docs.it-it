...
Poiché C++ consente l'overload, è possibile chiamare overload di **cacos** che accettino e restituiscano **fcomplex** e **_Lcomplex** valori. In un programma C **cacos** accetta e restituisce sempre un **_Dcomplex** valore.
