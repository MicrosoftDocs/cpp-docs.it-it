...
dev_langs: 
  - "C++"
helpviewer_keywords: 
  - "_fclose_nolock (funzione)"
  - "fclose_nolock (funzione)"
  - "flussi, chiusura"
...
Chiude un flusso senza blocco sulle thread.  
