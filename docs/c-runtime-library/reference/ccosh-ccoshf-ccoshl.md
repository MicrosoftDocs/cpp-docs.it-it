...
## <a name="remarks"></a>Note  
 Dato che C++ consente l'overload, è possibile chiamare degli overload di `ccosh` che accettino e restituiscano valori `_Fcomplex` e `_Lcomplex`. In un programma C `ccosh` accetta e restituisce sempre un valore `_Dcomplex` .  
