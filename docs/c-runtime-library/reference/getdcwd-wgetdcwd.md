...
Quando _ **debug** e **_CRTDBG_MAP_ALLOC** sono definiti, le chiamate a **_getdcwd** e **_wgetdcwd** vengono sostituite dalle chiamate a **_getdcwd_dbg** e **_wgetdcwd_dbg** , in modo che sia possibile eseguire il debug delle allocazioni di memoria. Per altre informazioni, vedere[_getdcwd_dbg, _wgetdcwd_dbg](getdcwd-dbg-wgetdcwd-dbg.md).
