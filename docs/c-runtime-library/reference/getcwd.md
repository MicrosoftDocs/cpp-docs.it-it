...
ms.workload:
- cplusplus
ms.openlocfilehash: 605e80bd6e9a3b946f0043108d50f78d1e5d19ad
...
Questa funzione POSIX è deprecata. In alternativa, usare [_getcwd](../../c-runtime-library/reference/getcwd-wgetcwd.md) conforme a ISO C++.  
