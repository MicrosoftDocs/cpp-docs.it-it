...
||Quando viene usato con **e**, **e**, **f**, **f**, **a**o **un** formato, il **#** flag impone al valore di output di contenere una virgola decimale.|Il separatore decimale viene visualizzato solo se è seguito da cifre.|
