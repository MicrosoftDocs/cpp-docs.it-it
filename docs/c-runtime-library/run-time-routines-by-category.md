...
---
# <a name="run-time-routines-by-category"></a>Routine di runtime per categoria
In questa sezione vengono elencate e descritte le routine di libreria di runtime Microsoft per categoria. Per praticità di riferimento, alcune routine sono elencate in più categorie. Le routine di caratteri multibyte e le routine di caratteri wide vengono raggruppate con le controparti di caratteri a un byte, se presenti.  
  
 Le categorie principali di routine di libreria di runtime Microsoft sono:  
