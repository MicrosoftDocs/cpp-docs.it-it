...
|`e`, `E`, `f`, `F`, `g`, `G`|Valore a virgola mobile composto da segno (+ o -) facoltativo, serie di uno o più cifre decimali che contiene il separatore decimale e l'esponente facoltativo ("e" o "E") seguito da un valore integer con segno facoltativo.|Puntatore a `float`.|No.|  
