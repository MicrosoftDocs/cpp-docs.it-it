...
ms.locfileid: "32411484"
---
# <a name="text-and-binary-mode-file-io"></a>I/O file modalità testo e binaria

Le operazioni di I/O dei file vengono eseguite in una delle due modalità di conversione disponibili, *testo* o *binaria*, in base alla modalità in cui il file è aperto. I file di dati in genere vengono elaborati in modalità testo. Per controllare la modalità di conversione del file, è possibile:
