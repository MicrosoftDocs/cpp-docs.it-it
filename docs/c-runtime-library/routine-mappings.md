...
|`_istleadbyte`|Restituisce sempre false|`isleadbyte`|Restituisce sempre false|
|`_istlegal`|Restituisce sempre true.|`_ismbclegal`|Restituisce sempre true.|
