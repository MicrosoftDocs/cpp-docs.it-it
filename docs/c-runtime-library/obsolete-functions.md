...
description: Elenca le funzioni obsolete che sono state deprecate e rimosse dalla libreria di runtime di Microsoft C (CRT).
ms.date: 4/2/2020
api_name:
- _beep
- _sleep
...
ms.locfileid: "81351003"
---
# <a name="obsolete-functions"></a>Funzioni obsolete

Alcune funzioni di libreria sono obsolete e hanno equivalenti più recenti. Si consiglia di modificare queste funzioni per le versioni aggiornate. Altre funzioni obsolete sono state rimosse da CRT. In questo articolo vengono elencate le funzioni deprecate come obsolete e le funzioni rimosse in una particolare versione di Visual Studio.
...
|`_seterrormode`|[SetErrorMode (Modalità di errore)](/windows/win32/api/errhandlingapi/nf-errhandlingapi-seterrormode)|
