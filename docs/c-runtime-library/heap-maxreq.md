---
description: 'Altre informazioni su: _HEAP_MAXREQ'
title: _HEAP_MAXREQ
ms.date: 11/04/2016
f1_keywords:
- HEAP_MAXREQ
...
La dimensione massima di una richiesta dell'utente per la memoria che può essere concessa.
